...
// extrait automatiquement de http://trad.spip.net/tradlang_module/ieconfig?lang_cible=sk
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'explication_ieconfig_import_local' => 'Zoznam nastavení, ktorý sa našiel v podpriečinku répertoire <i>ieconfig/</i> v priečinku <i>tmp/ieconfig/.</i>',
	...
	// L
	'label_configurations_a_exporter' => 'Nastavenia na exportovanie',
	...
	'texte_importer_configuration' => 'Táto možnosť vám umožňuje obnoviť databázu vytvorenú pred vykonaním zmien v nastaveniach alebo nahrať nastavenia, ktoré poskytuje zásuvný modul. Túto funkciu používajte opatrne: <strong>zmeny, potenciálne straty sa nedajú vrátiť späť.</strong>', # MODIF
	'texte_nom' => 'Názov:',
