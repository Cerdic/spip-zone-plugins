...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'boite_info_exemple_docs' => '<code>&lt;sjcycleN<strong>|docs=AA,BB,CC</strong>&gt;</code>',
	...
	'boite_info_exemple_largeur' => '<code>&lt;sjcycleN<strong>|largeurmax=200</strong>&gt;</code>',
	'boite_info_explication_float' =>'Vous pouvez choisir de placer le diaporama à gauche ou à droite, comme une vignette :',
	'boite_info_exemple_float' => '<code>&lt;sjcycleN<strong>|left</strong>&gt;</code> ou <code>&lt;sjcycleN<strong>|right</strong>&gt;</code>',
	...
	'explication_caption' => 'Afficher une légende pour chaque image. Cibler un bloc html par sa classe ou son identifiant css, ou bien par défaut "<strong>.cycle-caption</strong>".<br /><code>&lt;sjcycleN<strong>|caption=.cycle-caption</strong>&gt;</code>',
	...
	'explication_largeurmax' => 'Toutes les images seront retaillées en largeur à cette valeur, en pixels. Les diaporamas étant en taille proportionnelle, ils s\'adapteront à la largeur définie par l\'interface du site, mais dans la limite définie ici.<br /><code>&lt;sjcycleN<strong>|largeurmax=150</strong>&gt;</code>',
	...
	'explication_timeout' => 'Temps d\'affichage pour chaque image (en millisecondes). Choisir "0" pour faire un diaporama manuel (cf les boutons "précédent" et "suivant" pour activer le défilement manuel).<br /><code>&lt;sjcycleN<strong>|timeout=4000</strong>&gt;</code>',
	'explication_speed' => 'Temps de transition entre chaque image (en millisecondes).<br /><code>&lt;sjcycleN<strong>|speed=1000</strong>&gt;</code>',
	...
	'explication_palette' => 'Avec le plugin Palette, commencez par taper le "#" avant de choisir la couleur.<br /><code>&lt;sjcycleN<strong>|backgroundcolor=#C5E41C</strong>&gt;</code>',
	'explication_fx' => 'Consultez les exemples en ligne : <a href="http://jquery.malsup.com/cycle2/" target="_blank">Cycle2 Plugin</a>. <br /><code>&lt;sjcycleN<strong>|fx=scrollHorz</strong>&gt;</code>',
	'explication_tilevertical' => 'Jouer les effets de Glissement par bandes (tileSlide et tileBlind) horizontalement.<br /><code>&lt;sjcycleN<strong>|tilevertical=false</strong>&gt;</code> ou <code>&lt;sjcycleN<strong>|tilevertical=true</strong>&gt;</code>',
	'explication_next' => 'Cibler un bloc html par sa classe ou son identifiant. Par défaut "<strong>.cycle-next</strong>" place une flèche à droite au survol de l\'image.<br /><code>&lt;sjcycleN<strong>|next=.cycle-next</strong>&gt;</code>',
	'explication_prev' => 'Cibler un bloc html par sa classe ou son identifiant. Par défaut "<strong>.cycle-prev</strong>" place une flèche gauche au survol de l\'image.<br /><code>&lt;sjcycleN<strong>|prev=.cycle-prev</strong>&gt;</code>',
	'explication_pauseonhover' => '<code>&lt;sjcycleN<strong>|pauseonhover=true</strong>&gt;</code> ou <code>&lt;sjcycleN<strong>|pauseonhover=false</strong>&gt;</code>',
	'explication_pauseonhovercontent' => 'Laisser vide pour ne rien afficher.<br /> <code>&lt;sjcycleN<strong>|pauseonhovercontent=pause</strong>&gt;</code>',
	...
	'explication_reverse' => 'Joue le diaporama à l\'envers.<br /><code>&lt;sjcycleN<strong>|reverse=true</strong>&gt;</code> ou <code>&lt;sjcycleN<strong>|reverse=false</strong>&gt;</code>',
	'explication_random' => '<code>&lt;sjcycleN<strong>|random=true</strong>&gt;</code> ou <code>&lt;sjcycleN<strong>|random=false</strong>&gt;</code>',
	'explication_paused' => '<code>&lt;sjcycleN<strong>|paused=true</strong>&gt;</code> ou <code>&lt;sjcycleN<strong>|paused=false</strong>&gt;</code>',
	'explication_pager' => 'Cibler un bloc html qui contiendra la pagination en nommant sa classe ou son identifiant css. Par défaut : "<strong>.cycle-pager</strong>". <code>&lt;sjcycleN<strong>|pager=.cycle-pager</strong>&gt;</code>',
	...
	'explication_overlay' => 'Un calque noir/transparent sur le bas de l\'image pour afficher une légende avec Titre et Description de l\'image.<br /><code>&lt;sjcycleN<strong>|overlay=.cycle-overlay</strong>&gt;</code>',
	...
	'explication_sync' => 'L\'arrivée d\'une image est simultanée avec le départ de la précédente.<br /><code>&lt;sjcycleN<strong>|sync=true</strong>&gt;</code> ou <code>&lt;sjcycleN<strong>|sync=false</strong>&gt;</code>',
	...
	// P
	'parametres_diaporama' => 'Paramétrage général des diaporamas du site.<br />Chaque paramètre peut être corrigé à la rédaction lors de l\'inclusion d\'un diaporama : <small><code>&lt;sjcycleN<strong>|right|largeurmax=250</strong>&gt;</code></small>',
	'pre' => 'précédent',
