...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'explication_timeout' => 'Temps d\'affichage pour chaque image (en millisecondes). Choisir "0" pour faire un diaporama manuel (cf les boutons "précédent" et "suivant" pour activer le défilement manuel).<br />&lt;sjcycleXX<strong>|timeout=4000</strong>&gt;',
	...
	'explication_tilevertical' => 'Jouer les effets de Glissement par bandes (tileSlide et tileBlind) horizontalement.<br />&lt;sjcycleXX<strong>|tilevertical=false</strong>&gt; ou &lt;sjcycleXX<strong>|tilevertical=true</strong>&gt;',
	...
	'explication_allowwrap' => 'À propos des boutons "précédent" et "suivant" : à la fin du diaporama, ne pas revenir au début, ou bien au début, ne pas suivre à la fin. N\'empêche pas le diaporama automatique de tourner en continu.<br />&lt;sjcycleXX<strong>|allowwrap=true</strong>&gt; ou &lt;sjcycleXX<strong>|allowwrap=false</strong>&gt;',
	'explication_reverse' => 'Joue le diaporama à l\'envers.<br />&lt;sjcycleXX<strong>|reverse=true</strong>&gt; ou &lt;sjcycleXX<strong>|reverse=false</strong>&gt;',
