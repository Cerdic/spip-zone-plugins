...
function formulaires_cfg_rubrique_a_linscription_charger(){
	...
	return array(
	    'id_parent'=>$id_parent,
	    'mail_prive'=>$meta["mail_prive"],
	    'mail_public'=>$meta["mail_public"],
	    'espace_prive_voir'=>$meta["espace_prive_voir"],
	    'espace_prive_creer'=>$meta["espace_prive_creer"],
	    'groupe_mots'=>$meta["groupe_mots"],
	    'statut'=>$meta['statut'],
	    'formulaire_explicite'=>$meta['formulaire_explicite']);	
}
...
function formulaires_cfg_rubrique_a_linscription_traiter(){
	$meta 		= array(
		...
		'formulaire_explicite'			=> _request('formulaire_explicite')
		);
