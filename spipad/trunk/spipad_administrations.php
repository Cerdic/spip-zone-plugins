...
**/
function spipad_upgrade($nom_meta_base_version, $version_cible) {
	$maj = array();
	# quelques exemples
	...
	$maj['create'] = array(array('maj_tables', array('spip_ads', 'spip_ads_liens')));
...
**/
function spipad_vider_tables($nom_meta_base_version) {
	# quelques exemples
	# (que vous pouvez supprimer !)
	# sql_drop_table("spip_xx");
	# sql_drop_table("spip_xx_liens");

	sql_drop_table("spip_ads");
	sql_drop_table("spip_ads_liens");

	# Nettoyer les versionnages et forums
	sql_delete("spip_versions",              sql_in("objet", array('ad')));
	sql_delete("spip_versions_fragments",    sql_in("objet", array('ad')));
	sql_delete("spip_forum",                 sql_in("objet", array('ad')));
