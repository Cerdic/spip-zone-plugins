 ...
 * @pipeline autoriser */
function reservations_credits_autoriser(){}


/* Exemple
function autoriser_configurer_reservations_credits_dist($faire, $type, $id, $qui, $opt) {
	// type est un objet (la plupart du temps) ou une chose.
	// autoriser('configurer', '_reservations_credits') => $type = 'reservations_credits'
	// au choix
...
/**
 * Autorisation de voir le bouton d'accès rapide de création (reservationcredit)
 *
 * @param  string $faire Action demandée
 * @param  string $type  Type d'objet sur lequel appliquer l'action
 * @param  int    $id    Identifiant de l'objet
...
/**
 * Autorisation de voir (reservationcredit)
 *
 * @param  string $faire Action demandée
 * @param  string $type  Type d'objet sur lequel appliquer l'action
 * @param  int    $id    Identifiant de l'objet
 ...
 * @return bool          true s'il a le droit, false sinon
**/
function autoriser_reservationcredit_voir_dist($faire, $type, $id, $qui, $opt) {
	return true;
}

/**
 * Autorisation de modifier (reservationcredit)
 *
 * @param  string $faire Action demandée
 * @param  string $type  Type d'objet sur lequel appliquer l'action
 * @param  int    $id    Identifiant de l'objet
 ...
 * @return bool          true s'il a le droit, false sinon
**/
function autoriser_reservationcredit_modifier_dist($faire, $type, $id, $qui, $opt) {
	return in_array($qui['statut'], array('0minirezo', '1comite'));
}

/**
 * Autorisation de supprimer (reservationcredit)
 *
 * @param  string $faire Action demandée
 * @param  string $type  Type d'objet sur lequel appliquer l'action
 * @param  int    $id    Identifiant de l'objet
 ...
 * @return bool          true s'il a le droit, false sinon
**/
function autoriser_reservationcredit_supprimer_dist($faire, $type, $id, $qui, $opt) {
	return $qui['statut'] == '0minirezo' AND !$qui['restreint'];
}
