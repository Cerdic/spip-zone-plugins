...
/**
 * Override du fichier éponyme du plugin openPublishing pour éviter
 * sa gestion catastrophique de l'agenda
 */
...
function op_liste_config() {
	...
	echo "- "._T('opconfig:info_agenda')."<b>"._T('item_'.$GLOBALS['meta']['acsMingagendaUse'])."</b><br />";
	echo "- "._T('opconfig:info_document')."<b>"._T('item_'.op_get_document())."</b><br />";
