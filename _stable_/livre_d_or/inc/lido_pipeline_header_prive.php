<?php 
	...
	// inc/lido_pipeline_header_prive.php
...
function lido_header_prive ($flux) {
	...
	if(
		...
		$flux .= "\n"
			. "<!-- lido -->\n"
			. "<link rel='stylesheet' type='text/css' href='"._DIR_PLUGIN_LIDO."lido_header_prive.css' />\n"
			. "<script type='text/javascript' src='"._DIR_PLUGIN_LIDO."lido_header_prive.js'></script>\n"
			. "\n"
			;
	}
