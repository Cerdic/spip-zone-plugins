...
function exec_auteurs_dist()
{
	...
	$groupe = preg_replace('/\W/', '', _request('id_groupe'));

	$result = requete_auteurs($tri, $statut, $groupe);
...
function requete_auteurs($tri, $statut, $groupe)
{
...
if ($groupe)
	$sql_visible = "($sql_visible) AND g.id_groupe="._q($groupe);
