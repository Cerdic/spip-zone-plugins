<?php
	...
	function lettres_afficher_statistiques_archive($titre, $id_archive) {
		...
		list($nb_email_envoyes, $nb_emails_non_envoyes, $nb_emails_echec) = @spip_fetch_array(spip_query($requete_total_emails),SPIP_NUM);
	...
	function lettres_recuperer_dernier_id_archive($id_lettre) {
		...
		list($id_archive) = spip_fetch_array($resultat_id_archive,SPIP_NUM);
		return $id_archive;
	}
	...
	function lettres_recuperer_id_lettre_depuis_id_archive($id_archive) {
		...
		list($id_lettre) = spip_fetch_array($resultat_id_lettre,SPIP_NUM);
		return $id_lettre;
	}
