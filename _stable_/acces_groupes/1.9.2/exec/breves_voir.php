...
$flag_editable = (($connect_statut == '0minirezo' AND accesgroupes_acces_rubrique($id_rubrique)) OR $statut == 'prop');
...
//
 ...
 if (($spip_display != 4) AND $id_breve>0 AND ($connect_statut == '0minirezo' AND accesgroupes_acces_rubrique($id_rubrique))) {
...
if ($connect_statut=="0minirezo" AND accesgroupes_acces_rubrique($id_rubrique) AND ($statut=="prop" OR $statut=="prepa")){
