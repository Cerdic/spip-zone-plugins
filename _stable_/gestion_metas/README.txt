...
Une fois le plugin installé, il vous suffit d'insérer dans l'en-tête de vos pages le code [(#INCLURE{fond=includes/gestion_metas}{id_article}{lang})] pour les articles et [(#INCLURE{fond=includes/gestion_metas}{id_rubrique}{lang})] pour les rubriques. Ce code insérera automatiquement le squelette du plugin contenu dans includes/gestion_metas.html.
