...
/** Verifie si la valeur est dans le referentiel
 * 
 * @param string $valeurOuId : ce qu'on cherche (que ce soit une valeur ou un identifiant / une cle)
 * @param string $referentiel : nom du referentiel
 * @param boolean $chercherValeurEtPasId : vrai si on doit chercher la valeur, faux si on doit chercher l'id
 * @return array tableau de sortie :<ul><li>["isFound"] : odb_referentiel.[id|valeur] si trouve (depend de $chercherValeurEtPasId), false sinon</li>
                 <li>["valeursPossibles"] : valeurs possibles pour ce referentiel</li></ul>
 */
...
/** cree une ligne (2 colonnes) avec liste provenant du referentiel */
