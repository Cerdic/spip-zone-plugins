<?php
	...
	function balise_FORMULAIRE_AUTOMATIQUE_stat($args, $filtres) {
		...
		if ($GLOBALS['auteur_session']['statut'] == '0minirezo' OR $GLOBALS['auteur_session']['statut'] == '1comite') {
			...
			// On ne peut pas "voir les résultats"/"donner son avis" si le formulaire n'est pas en ligne et publié/terminé
			if ($formulaire->statut == 'en_attente' OR $formulaire->en_ligne == 'non')
				return '';
		}
