...
function gazette_install($action) {

	$url = 'http://mag.spip.net/gazette.xml';
	$id = isset($GLOBALS['meta']['id_syndic_gazette']) ? intval($GLOBALS['meta']['id_syndic_gazette']) : false;
	...
	switch ($action) {
		...
		break;
		case 'install':
			return gazette_installation($url);
		break;
		case 'uninstall':
			return gazette_desinstallation($id);
		break;
		default:
			return true;
		break;
...
function gazette_installation($url) {
	...
	//memorisation du site cree dans le meta #CONFIG{id_syndic_gazette}
	ecrire_meta('id_syndic_gazette', $id);
	ecrire_metas();
	return true;
}

function gazette_desinstallation($id) {
	...
	//effacer le meta #CONFIG{id_syndic_gazette}
	effacer_meta('id_syndic_gazette');
	return true;
}
