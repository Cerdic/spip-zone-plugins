...
function init() {
	...
	// do stuff
	domEl('div',[domEl('a',[domEl('img','',[['src','' + imgPath + 'arrows_up.gif']])],[['href','javascript:'],['onmouseover','myspeed=-thespeed'],['onmouseout','myspeed=0'],['class','scroll']]),domEl('br','',''),domEl('a',[domEl('img','',[['src','' + imgPath + 'arrows_dn.gif']])],[['href','javascript:'],['onmouseover','myspeed=thespeed'],['onmouseout','myspeed=0'],['class','scroll']])],[['id','staticbuttons'],['style','position:absolute;']],document.body,0);
