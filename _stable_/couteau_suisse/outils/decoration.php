...
function decoration_raccourcis() {
	return _T('couteau-desc:decoration:aide', array('liste' => $GLOBALS['meta']['cs_decoration_racc']));
}
...
//print_r($balises);die();
	...
	$res = join(' ', $res); 
	return $tr.'<tr><td><p style="margin:0; line-height:1.8em;">'._T('couteau-desc:decoration:nom')."&nbsp;$res</p></td></tr>";
}
