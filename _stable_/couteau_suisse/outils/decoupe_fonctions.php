...
*/
	...
	$pagination1 = "<a name='navig_haut' id='decoupe_haut'></a><div class='pagination decoupe_haut'>$pagination</div>";
	$pagination2 = "<a name='navig_bas' id='decoupe_bas'></a><div class='pagination decoupe_bas'>$pagination</div>";
