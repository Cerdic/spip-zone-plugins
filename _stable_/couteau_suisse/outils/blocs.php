...
function blocs_raccourcis() {
	return _T('couteau-desc:blocs:aide');
}
...
function blocs_callback($matches) {
	...
	return "<div class='cs_blocs$b'><h4 class='blocs_titre$h'><a href='#'>$t[0]</a></h4><div$div>\n$t[1]\n</div></div>";
}
...
function blocs_BarreTypo($tr) {
	return $tr.'<tr><td>'._T('couteau-desc:blocs:nom').' (en projet)</td></tr>';
}
