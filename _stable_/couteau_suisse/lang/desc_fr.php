...
// ----------------------------------------------------------------------------------
	...
	'spip_cache:description' => "@puce@ Par d&eacute;faut, SPIP calcule toutes les pages publiques et les place dans le cache afin d'en acc&eacute;l&eacute;rer la consultation. D&eacute;sactiver temporairement le cache peut aider au d&eacute;veloppement du site.[[%radio_desactive_cache3%]]"
		...
		. "@puce@ Si vous avez plusieurs sites en mutualisation, vous pouvez sp&eacute;cifier ici la valeur par d&eacute;faut prise en compte par tous les sites locaux (SPIP 1.93).[[%duree_cache_mutu% heures]]"
...
// TODO : a partir de 1.93 il faut changer (ul ol pour style_h et simplement li pour style_p)
	...
	// attention : ici, la description est morcelee pour cause de compatibilite avec differentes versions de SPIP
