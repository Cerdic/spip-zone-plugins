...
@puce@ &iquest;Que estad&iacute;sticas de autores se pueden listar en esta p&aacute;gina?
...
',
	...
	'boites_privees:description' => 'Todas las cajas descritas a continuaci&oacute;n aparecen en la parte privada.[[%cs_rss%]][[->%format_spip%]][[->%stat_auteurs%]]
...
@puce@ {{Los estilos de SPIP}}. Hasta la versi&oacute;n 1.92 de SPIP, los atajos tipogr&aacute;ficos produc&iacute;an balizas con el estilo "spip" asignado siempre. Por ejemplo: <code><p class="spip"></code>. Aqu&iacute; puedes definir el estilo de estas balizas en funci&oacute;n de tus hojas de estilo. Un cuadro vac&iacute;o significa que no se aplica ning&uacute;n estilo en particular.<blockquote style=\'margin:0 2em;\'>
_ {{1.}} Balizas &lt;p&gt;, &lt;i&gt;, &lt;strong&gt; y las listas (&lt;ol&gt;, &lt;ul&gt;, etc.) :[[%style_p%]]
_ {{2.}} Balizas &lt;tables&gt;, &lt;hr&gt;, &lt;h3&gt; y &lt;blockquote&gt; :[[%style_h%]]

Nota: al modificar este segundo par&aacute;metro, tambi&eacute;n pierdes los estilos est&aacute;ndar asociados con estas balizas.</blockquote>',
...
_ • Por sistema para cada art&iacute;culo (una baliza <code>[!sommaire]</code> situada en cualquier lugar del texto del art&iacute;culo crear&aacute; una excepci&oacute;n).
_ • &Uacute;nicamente para los art&iacute;culos que contengan la baliza <code>[sommaire]</code>.
