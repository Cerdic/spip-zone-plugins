...
La syntaxe <html>#TITRE_XXX{yy}</html> est &eacute;galement support&eacute;e. Exemple : <html>#TITRE_ARTICLE{10}</html> renverra le titre du message #10.[[%titres_etendus%]]',
	'titre_parent:nom' => 'Balise #TITRE_PARENT &amp; Cie',
