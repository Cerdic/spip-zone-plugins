...
cs_log("D&eacute;but : exec_test_couteau_suisse()");
	...
	if(defined('_SPIP19100'))
  		debut_page(_T('couteau-desc:titre_tests'), 'configuration', 'couteau_suisse');
  	else {
		$commencer_page = charger_fonction('commencer_page', 'inc');
		echo $commencer_page(_T('couteau-desc:titre_tests'), "configuration", 'couteau_suisse');
	}

	echo '<br /><br /><br />', gros_titre(_T('couteau-desc:titre_tests'), '', false), 
