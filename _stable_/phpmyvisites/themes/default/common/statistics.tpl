<h3 {if $mod=="rss"}style="padding-left:20px;font-size: 110%;color: #00008B;"{/if}>{'visites_statistiques'|translate}</h3>
...
<table {if $mod=="rss"}{else} class="resultats"{/if} cellpadding="5">
<tbody>
<tr>
	<th colspan="2" 
		{if $mod=="rss"}
