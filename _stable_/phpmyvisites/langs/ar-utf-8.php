...
//
$lang['auteur_nom'] = "من تعريب دليل عز www.3z.cc "; // Translator's name
...
$lang['install_problemedroitrepertoire'] = "لا يَستطيعُ الكِتابَة في المجلد %s : رجاءً تحقّقْ بأنّك عِنْدَكَ الحقوقُ لإنْشاء الملفاتِ على الخادمِ (محاولة إلى CHMOD 777 المجلد ببرنامجِ إف تي بي (إنقر يمين الفأرة على دليل المجلد الصحيح -> ومن ثمه رُخص (أَو CHMOD))."; // Cannot access the file config.php...
