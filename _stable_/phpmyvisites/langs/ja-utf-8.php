...
$lang['generique_aucune_site_bdd'] = "データベースにサイトが登録されていません ! Try to Try to login as phpMyVisites Super User to add a new site.";
...
$lang['configurations_navigateursbytype'] = "ブラウザー (by type)";
...
$lang['admin_purge_autres'] = "テーブル「%s」への共通項目を字削除する";
...
$lang['admin_name'] = "名前:";
$lang['admin_error_ip'] = "IP アドレスは、正確なフォーマットになければなりません。";
...
// Setup
//
$lang['admin_intro'] = "ようこそ phpMyVisites の設定へ。インストールに関係のあるすべての情報を修正することができます。If you have any problems then do not hesitate to consult %s the official documentation of phpMyVisites %s."; // link to the doc
...
$lang['install_utilisateursavances'] = "高度なユーザー (oオプション)";
$lang['install_oui'] = "はい";
$lang['install_non'] = "いいえ";
$lang['install_ok'] = "OK";
$lang['install_probleme'] = "問題: ";
$lang['install_problemedroitrepertoire'] = "リポジトリ「%s」を書き込みできません : サーバー上でファイル作成する十分な権限を持っていることを確認してください (try to CHMOD 777 the repertory with your FTP software (ディレクトリ上で右クリックし、パーミッション (または CHMOD))."; // Cannot access the file config.php...
...
$lang['install_txt2'] = "At the end of installation, a request will be made to the official site to help us keep track of the number of people using phpMyVisites. 理解をありがとうございます。";
...
$lang['tdate3'] = "%yearlong% %monthlong% %daynumeric% から %monthlong2% %daynumeric2% の週";
