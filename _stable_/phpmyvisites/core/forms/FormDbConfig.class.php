...
// $Id: FormDbConfig.class.php,v 1.5 2005/10/26 19:57:42 matthieu_ Exp $
...
class FormDbConfig extends Form
{
	...
	{	
		...
		$formElements = array(
			...
			array('password', 'form_dbpassword', $GLOBALS['lang']['install_mdpmysql'], 'value='.$values['DB_PASSWORD']),
