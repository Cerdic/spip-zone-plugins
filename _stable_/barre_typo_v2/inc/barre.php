...
<tr><td> 
'._T('bartypenr:barre_adresse').'&nbsp;: <input type="text" name="lien_nom" id="lien_nom'.$num_barre.'" value="http://" size="21" maxlength="255" /><a href="" onclick="javascript:barre_liens_spip('.$champ.', \'\'); return false;" title="'._T('icone_doc_rubrique').'" ><img src="' . chemin_image('rubrique-12.gif') . '" style="position: relative; top: 4px; left: 2px;" alt="Chercher un objet SPIP" /></a><br />
