...
function evenements_edit($id_evenement, $id_article, $new, $config_fonc, $row)
{
	...
	echo $commencer_page(_T('titre_cadre_modifier_evenement', array('titre' => $titre)), "naviguer", "evenements", $id_rubrique);
	...
	$oups = ($id_article ?
	     ...
	     : 
	     (_request('retour') ? _request('retour') : generer_url_ecrire())
		);

	$contexte = array(
	'icone_retour'=>icone_inline(_T('icone_retour'), $oups, "agenda-24.gif", "rien.gif",$GLOBALS['spip_lang_left']),
