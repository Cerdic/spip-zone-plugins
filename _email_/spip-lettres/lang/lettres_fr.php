...
'installation_texte' => 'Les tables nécessaires au fonctionnement du plugin lettre d\'information n\'ont pas été détectées. Cette étape permet d\'ajouter ces tables dans votre base de données MySQL. Si ce message persiste, veuillez insérer manuellement <a href="../plugins/lettres/base/lettres.sql" target="_blank">le fichier SQL</a> dans votre base de données MySQL.',
