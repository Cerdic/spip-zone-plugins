...
function breve2art($id_breve, $id_rubrique, $id_auteur) {
	...
	$secteur = sql_getfetsel('id_secteur', 'rubrique', 'id_rubrique='.intval($id_rubrique));
	...
	$message.="<br>Bréve n°".$id_breve." vers l'article ".$id_article."<br>";
	...
	else $message.= '<br>impossible de trouver le logo pour la breve :'.$id_breve.'<br>';

	if($ext!="") if(!rename($logobr.$ext, $logoart.$ext)) $message.="<br>impossible de renommer:".$logobr.$ext."<br>";
