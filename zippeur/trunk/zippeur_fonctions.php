...
function zippeur($array,$date='',$cmd='',$nom='',$plat='oui',$delai='0'){
	...
	if (count(preg_files($chemin))==0 or!$enbase['id_zip'] or $enbase['date_modif']!=$date or count($array)!=$enbase['fichiers'] or (_NO_CACHE!=0 and !defined('_NO_CACHE_SAUF_ZIPPEUR'))){
