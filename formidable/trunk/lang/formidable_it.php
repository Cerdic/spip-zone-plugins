...
'editer_identifiant_explication' => 'Fornisci un identificativo testuale unico che ti permetter&agrave; di richiamare pi&ugrave; facilmente il modulo.',
...
'editer_message_ok_explication' => 'Puoi personalizzare il messaggio che sar&agrave; mostrato all\'utente dopo l\'invio di un modulo valido.',
...
'erreur_base' => 'Un problema tecnico si &egrave; verificato rurante il salvataggio.',
'erreur_generique' => 'Ci sono degli errori nei campi di seguito, si prega di verificare i dati.',
'erreur_identifiant' => 'Questo identificativo &egrave; gi&agrave; utilizzato.',
...
'formulaires_aucun' => 'Al momento non &egrave; presente alcun modulo.',
...
'reponse_statut' => 'Questa risposta &egrave;:',
...
'retour_aucun_traitement' => 'La risposta &egrave; stata correttamente inviata. Grazie :)',
...
'traiter_email_message_erreur' => 'Si &egrave; verificato un errore all\'atto dell\'invio dell\'email.',
'traiter_email_message_ok' => 'Il tuo messaggio &egrave; stato inviato per posta elettronica.',
...
'traiter_email_option_envoyeur_nom_explication' => 'Costruisci questo nome grazie all\'aiuto dei @segnaposto@ (vedi il promemoria). Se non inserisci nulla, verr&agrave; inserito il nome del sito.',
...
'traiter_email_option_sujet_explication' => 'Costruisci l\'oggetto grazie all\'aiuto dei @segnaposto@. Se non inserisci nulla, l\'oggetto verr&agrave; generato automaticamente.',
...
'traiter_enregistrement_erreur_base' => 'Si &egrave; verificato un errore tecnico durante il salvataggio in database',
'traiter_enregistrement_erreur_deja_repondu' => 'Hai gi&agrave; risposto a questo modulo.',
...
'traiter_enregistrement_option_multiple_explication' => 'Un utente pu&ograve; risposndere pi&ugrave; al modulo?',
...
'traiter_enregistrement_option_identification_explication' => "Se le risposte sono modificabili, quale procedura si dovr&agrave; utilizzare in priorit&agrave; per individuare la risposta da modificare?",
