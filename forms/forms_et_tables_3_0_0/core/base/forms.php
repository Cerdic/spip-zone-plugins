...
function forms_declarer_tables_interfaces(&$interface){
	//-- Relations ----------------------------------------------------
	$interface['tables_jointures']['spip_articles'][] = 'forms_articles';
	$interface['tables_jointures']['spip_forms'][] = 'forms_articles';
	$interface['tables_jointures']['spip_articles'][] = 'forms_donnees_articles';
	$interface['tables_jointures']['spip_auteurs'][] = 'forms_donnees_auteurs';
	$interface['tables_jointures']['spip_rubriques'][] = 'forms_donnees_rubriques';
	$interface['tables_jointures']['spip_forms_donnees'][] = 'forms_donnees_articles';
	$interface['tables_jointures']['spip_forms_donnees'][] = 'forms_donnees_rubriques';
	$interface['tables_jointures']['spip_forms_donnees'][] = 'forms_donnees_auteurs';
	$interface['tables_jointures']['spip_forms_donnees'][] = 'documents_donnees';
	$interface['tables_jointures']['spip_forms_donnees'][] = 'forms';
	$interface['tables_jointures']['spip_documents'][] = 'documents_donnees';

	$interface['table_des_tables']['forms']='forms';
	$interface['table_des_tables']['forms_champs'] = 'forms_champs';
	$interface['table_des_tables']['forms_champs_choix'] = 'forms_champs_choix';
	$interface['table_des_tables']['forms_donnees']='forms_donnees';

	$interface['exceptions_des_jointures']['type_form'] = array('spip_forms', 'type_form');

	$interface['table_date']['forms_donnees']='date';
	return $interface;
}

function forms_declarer_tables_principales(&$tables_principales){
...
function forms_declarer_tables_auxiliaires(&$tables_auxiliaires){
