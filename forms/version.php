...
// la matrice des fonctions interface
$GLOBALS['spip_matrice']['forms_tous'] = dirname(__FILE__).'/forms_tous';
$GLOBALS['spip_matrice']['forms_edit'] = dirname(__FILE__).'/forms_edit';
$GLOBALS['spip_matrice']['forms_reponses'] = dirname(__FILE__).'/forms_reponses';
$GLOBALS['spip_matrice']['forms_telecharger'] = dirname(__FILE__).'/forms_telecharger';
$GLOBALS['spip_matrice']['spip_sondage'] = dirname(__FILE__).'/spip_sondage';
$GLOBALS['spip_matrice']['sondage'] = dirname(__FILE__).'/sondage';


$GLOBALS['dossier_squelettes'].=":" . _DIR_PLUGINS . basename(dirname(__FILE__))."/";
echo $GLOBALS['dossier_squelettes']."::";

include_once('forms_base.php');
