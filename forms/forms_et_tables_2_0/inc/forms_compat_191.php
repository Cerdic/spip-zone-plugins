 ...
 */
	...
	if (!function_exists('ajax_retour')) {
		// https://code.spip.net/@ajax_retour
	...
	if (!function_exists('balise_GET')){
		...
		//
		// https://code.spip.net/@balise_GET_dist
	...
	if (!function_exists('interprete_argument_balise')){
		// https://code.spip.net/@interprete_argument_balise
	...
	// https://code.spip.net/@balise_RANG_dist
	...
	//
	// https://code.spip.net/@balise_EDIT_dist
