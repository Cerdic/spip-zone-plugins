...
function formulaires_login_header_charger_dist($cible="",$login="",$prive=null)
{
...
function formulaires_login_header_verifier_dist($cible="",$login="",$prive=null){
...
function formulaires_login_header_traiter_dist($cible="",$login="",$prive=null){
	$res = array();
