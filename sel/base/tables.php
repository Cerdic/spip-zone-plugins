...
// -------------------
	...
	// Ce champ accès permettra de ne pas s'appuyer sur les statuts Spip pour la gestion
	// Usage : Qd le form de création / modif d'auteur est rempli depuis l'espace public, on envoit tojours :
	// statut = rédacteur (envoi caché) et acces = 0nouveau pour la création. En modif, on donne accès au menu déroulant uniquement aux admins locaux et généraux
...
// TABLES PRINCIPALES - OBJETS POUR SPIP 3
	...
	// Ce champ accès permettra de ne pas s'appuyer sur les statuts Spip pour la gestion
	// Usage : Qd le form de création / modif d'auteur est rempli depuis l'espace public, on envoit tojours :
	// statut = rédacteur (envoi caché) et acces = 0attente pour la création. En modif, on donne accès au menu déroulant uniquement aux admins locaux et généraux
	// liste des acces : 0nouveau, 1utilisateur_ok, 2utilisateur_ko, 3admin_local, 4admin_general
	...
	$tables['spip_auteurs']['field']['inscription'] = "DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00'"; // date première inscription
