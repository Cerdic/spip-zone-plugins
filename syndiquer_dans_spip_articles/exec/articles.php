...
if ($surtitre) {
	...
	if(strlen($surtitre)>65) $lien_affiche = substr($surtitre,0,55).'...';
	else $lien_affiche = $surtitre;
	echo "<a href=\"".$surtitre."\">".$lien_affiche."</a>";
	echo "</b></font></span>\n";
}
/*
	if ($surtitre) {
...
// BEGIN HACK
//
			. majuscules(_T('syndicarticle:texte_date_publication_anterieure'))
