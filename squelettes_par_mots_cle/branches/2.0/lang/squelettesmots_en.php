...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	'titre_config' => 'Configure SPMC V2.0',
	'titre_page' => 'Configure the selection of templates',
	'gros_titre' => 'Create rules to choose templates based on keywords',
	'aide' => 'This page is only accessible to administrators. You can create here some rules to choose templates by keywords associated to an element in SPIP.
