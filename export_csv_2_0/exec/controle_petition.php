...
// https://code.spip.net/@exec_controle_petition_dist
...
// https://code.spip.net/@exec_controle_petition_args
...
// https://code.spip.net/@controle_petition_page
function controle_petition_page($id_article, $titre,  $ong, $corps)
{
	...
	echo $rac;
	echo pipeline('affiche_gauche', array('args'=>array('exec'=>'controle_petition','id_article'=>$id_article),'data'=>''));
...
// https://code.spip.net/@controle_petition_onglet
