...
'config_extraction' => 'Configuration de l\'extraction',
...
<ol class="exportcsv_ol"><li>Pour t&eacute;l&eacute;charger le fichier C.S.V :
		...
		<ul>
			<li>Avec OpenOffice, choisir comme <strong>jeu de caract&egrave;res Unicode (UTF-8)</strong> ; s&eacute;paration par <strong>point-virgule</strong> et le <strong>texte par des guillemets</strong></li>
...
'info_nb_lignes_a' => 'Lignes 0 &agrave; ',
'sur_total' => ' sur un total de ',
