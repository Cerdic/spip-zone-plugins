...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'action_descendre' => 'sposta gi&ugrave;',
	...
	'champ_deja_existant' => 'Un campo con lo stesso nome gi&agrave; esiste per questa tabella.',
	//E
	...
	'info_description_champ_extra' => "Questa pagina consente di gestire i campi extra, 
						e cio&egrave; dei campi supplementari all'interno delle tabelle di SPIP,
	...
	'info_description_champ_extra_presents' => "Infine, se dei campi gi&agrave; esistono nel database,
	...
	'precisions_pour_enum' => 'Alcuni tipi di campi richiedono una lista di valori accettati: indicane una per riga, seguito da una virgola e da una descrizione. Una riga vuota per il valore predefinito. La descrizione pu&ograve; essere un stringa di traduzione.',
	'precisions_pour_label' => 'Pu&ograve; essere una stringa di traduzione &laquo;plugin:stringa&raquo;.',
	'precisions_pour_explication' => 'Puoi fornire pi&ugrave; informazioni riguardanti l\'inserimento. 
		Pu&ograve; essere una stringa di traduzione &laquo;plugin:stringa&raquo;.',
	...
	//S
	'saisies_champs_extras' => 'Dei &laquo;Campi Extra&raquo;',
