...
// Module: paquet-etiquettes
// Langue: fr
// Date: 15-12-2011 15:44:43
// Items: 2
...
// E
	'etiquettes_description' => 'Le plugin Étiquettes permet de créer facilement des formulaires pour ajouter des mots-clés "à la volée" sur n\'importe quel élément les acceptant (articles, forums, etc, et plus encore si vous avez le plugin Mots Partout ou si vous savez programmer).
