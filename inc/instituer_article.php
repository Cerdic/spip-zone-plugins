...
function inc_instituer_article_dist($id_article, $statut=-1, $id_individu)
{
    ...
    return redirige_action_auteur('instituer_article',$id_article,'articles', "id_article=".$id_article."&id_individu=".$id_individu, $res, " method='post'");
}
