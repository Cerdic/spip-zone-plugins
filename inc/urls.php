...
// http://doc.spip.org/@generer_url_ecrire_individu
function generer_url_ecrire_individu($id_individu, $statut='') {
    $args = "id_individu=" . intval($id_individu);
    if (!$statut)
        return generer_url_action('redirect', $args);
    else
        return generer_url_ecrire('fiche_detail',$args);
}
...
// http://doc.spip.org/@generer_url_document
  ...
  if (!function_exists('generer_url_individu')) {
// http://doc.spip.org/@generer_url_article
    function generer_url_individu($id, $stat='')
        { return generer_url_ecrire_individu($id, $stat);}
  }
 }
?>