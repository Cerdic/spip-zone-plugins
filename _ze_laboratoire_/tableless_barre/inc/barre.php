...
function afficher_barre($champ, $forum=false, $lang='') {
	...
	$ret .= "<div class='spip_barre'>";
	$ret .= "\n<div class='spip_barre_row'>";
	$ret .= "\n<span style='text-align: $spip_lang_left;'>";
	$col = 1;
	...
	if (!_DIR_RESTREINT) {
		$ret .= "\n<span style='text-align:$spip_lang_right;'>";
		$col++;
	//	$ret .= "&nbsp;&nbsp;&nbsp;";
		$ret .= aide("raccourcis");
		$ret .= "&nbsp;";
	...
	if (_DIR_RESTREINT)
		$ret .= "\n<div class='spip_barre_row'>\n<span><input disabled='disabled' type='text' class='barre' id='barre_$num_barre' size='45' maxlength='100'\nvalue=\"".attribut_html(_T('barre_aide'))."\" /></span></div>";
