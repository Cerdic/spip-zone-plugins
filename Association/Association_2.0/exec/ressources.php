...
function exec_ressources(){
	...
	if (!autoriser('configurer')) {
		...
		while ($data = sql_fetch($query)) {
			...
			echo '<td class="arial11 border1"><a href="'.$url_prets.'&id='.$data['id_ressource'].'"><img src="'._DIR_PLUGIN_ASSOCIATION_ICONES.'voir-12.png" title="'._T('asso:prets_nav_gerer').'"></a></td>';

			echo '<td class="arial11 border1" style="text-align:center;"><a href="'. generer_url_ecrire('action_ressources', 'id='.$data['id_ressource']) . '"><img src="'._DIR_PLUGIN_ASSOCIATION_ICONES.'poubelle-12.gif" title="'._T('asso:ressources_nav_supprimer').'"></a></td>';
			echo '<td class="arial11 border1" style="text-align:center;"><a href="'.generer_url_ecrire('edit_ressource', 'id='.$data['id_ressource']).'"><img src="'._DIR_PLUGIN_ASSOCIATION_ICONES.'edit-12.gif" title="'._T('asso:ressources_nav_editer').'"></a></td>';
			echo'  </tr>';
		}     
		echo'</table>';
