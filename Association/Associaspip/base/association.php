...
$spip_asso_ressources = array(
	...
	"statut" => "TINYINT NULL", // utiliser un entier permet de pouvoir gerer parallelement une quantite disponible ...assez reduite (d'ou du TinyInt et non autre : il ne s'agit pas non plus de gerer un entrepot de grossiste... mais 2-3 unites sans devoir forcement creer des codes distincts --ce qui est recommande meme si on reste flexible)
	"commentaire" => "TEXT NOT NULL",
	"maj" => "TIMESTAMP NOT NULL"
);
...
$spip_asso_prets = array(
	...
	"date_sortie" => "DATETIME NOT NULL DEFAULT '0000-00-00T00:00:00'",
	"duree" => "INT UNSIGNED NOT NULL DEFAULT '0'",
	"date_retour" => "DATETIME NOT NULL DEFAULT '0000-00-00T00:00:00'",
