...
function exec_destination(){
	...
	if (!autoriser('associer', 'comptes')) {
		...
		while ($data = sql_fetch($query)) {
			...
			echo '<td class="arial11 border1" style="text-align:center;"><a href="'.$url_action_destination.'&id='.$id_destination.'"><img src="'._DIR_PLUGIN_ASSOCIATION_ICONES.'poubelle-12.gif" title="Supprimer"></a></td>';
			echo '<td class="arial11 border1" style="text-align:center;"><a href="'.$url_edit_destination.'&id='.$id_destination.'"><img src="'._DIR_PLUGIN_ASSOCIATION_ICONES.'edit-12.gif" title="Modifier"></a></td>';
			echo'  </tr>';
		}     
		echo'</table>';
