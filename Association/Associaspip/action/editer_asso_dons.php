...
function action_editer_asso_dons() {
	...
	if ($id_don) { /* c'est une modification */
		...
		association_modifier_operation_comptable($date_don, $argent, 0, "[don$id_don->don$id_don] - ". ($id_adherent?"[$bienfaiteur->membre$id_adherent]":$bienfaiteur), $GLOBALS['association_metas']['pc_dons'], $journal, '', $id_compte);
