...
function association_plan_comptable_complet($code='', $returnCode=false) {
	 ...
	 *
	 * Le second parametre permet de retourner le code le plus voisin existant dans le plan
	 * Si le code fourni en parametre est present c'est lui qui est retourne, sinon le
	...
	$pcc = array(
			...
			13 => "Subventions d’investissement (affectés à des biens renouvelables)",
			...
			#7585 => "Contributions volontaires1", !!! Ces contibutions sont reportées en classe 8
	...
	if (!preg_match("/^[1-8]\w*$/", $code)) return;
