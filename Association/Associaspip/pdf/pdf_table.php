...
// PDF_Table
//
// Classe afin d'�diter des tableaux au format PDF 
//
// Bas� sur les fonctions d'Olivier : oliver@fpdf.org
//
////////////////////////////////////////////////////
...
class PDF_Table extends FPDF{
	...
	function Header(){ 	//Imprime l'en-t�te du tableau si n�cessaire
	...
	function Footer(){
		...
		$this->Cell(0,10,'Page '.$this->PageNo(),0,0,'R');	//Num�ro de page � droite
	}
