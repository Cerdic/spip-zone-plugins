...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'erreur_nb_versions_atteint' => 'Le nombre de versions différentes de l\'image a été atteint (@nb@). Vous ne pouvez que tester et non appliquer les modifications.', # NEW
	...
	'explication_image_recadre' => 'Recadre l\'image en fonction de la sélection de l\'utilisateur.', # NEW
	...
	'explication_resultats_defaut' => 'Valeur par défaut sélectionnée lors du chargement du formulaire.', # NEW
	...
	'label_image_aplatir' => 'Aplatir l\'image', # NEW
	...
	'label_image_recadre' => 'Recadrer l\'image', # NEW
	...
	'label_largeur_previsu' => 'Largeur maximale de la prévisualisation en px (450 par défaut) : ', # NEW
	...
	'label_niveau_saturation_desaturation' => 'Niveau de saturation :', # NEW
	'label_ratio' => 'Ratio de la sélection :', # NEW
	'label_ratio_libre' => 'Libre', # NEW
	'label_recadre_height' => 'Hauteur de la sélection (en px) :', # NEW
	...
	'label_resultats_defaut' => 'Valeur par défaut présélectionnée', # NEW
	...
	'label_type_modification' => 'Quel sera le résultat?', # NEW
	'label_type_retour' => 'Que faire après l\'application du filtre ?', # NEW
	'label_type_retour_continuer' => 'Pokračovať v úprave obrázka',
	'label_type_retour_retour' => 'Fermer la modification', # NEW
	'legend_configuration' => 'Nastavenia zásuvného modulu',
	'legend_configuration_publique' => 'Configuration de la partie publique', # NEW
	'legend_configuration_resultats' => 'Configuration des résultats', # NEW
	'legend_filtres_a_disposition' => 'Filtre k dispozícii',
	'legende_filtres_de_couleur' => 'Filtres de coloration', # NEW
	...
	'message_pas_de_versions' => 'Ce document n\'est pas versionné.', # NEW
