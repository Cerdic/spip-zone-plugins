...
/**
 * Gestion des puces d'action rapide des définitions
 *
 * @package SPIP\Dictionnaire\Puce_statut
**/

/**
 * Gestion des puces statuts des définitions
 * 
...
**/
function puce_statut_definition_dist($id, $statut, $id_parent, $type='article', $ajax = false, $menu_rapide=_ACTIVER_PUCE_RAPIDE) {
