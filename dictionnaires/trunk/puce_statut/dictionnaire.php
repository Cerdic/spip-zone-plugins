...
/**
 * Gestion des puces statuts des dictionnaires
 * 
...
**/
function puce_statut_dictionnaire_dist($id, $statut, $id_parent, $type='article', $ajax = false, $menu_rapide=_ACTIVER_PUCE_RAPIDE) {
	...
	if ($ajax){
		...
		$nom = "puce_statut_";
		$action = generer_url_ecrire('puce_statut_dictionnaires',"",true);
