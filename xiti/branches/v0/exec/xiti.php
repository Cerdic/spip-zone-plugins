...
function exec_xiti_dist() {
	...
	if (($connect_statut != '0minirezo' && $connect_statut != '1comite')) {
		debut_cadre_relief ("../"._DIR_PLUGIN_PHPASSO."images/info.gif", '', '', _T('phpasso:message'),'','message');
	...
	debut_cadre_trait_couleur("../"._DIR_PLUGIN_XITI."images/logo_xiti.gif", '', '', _T('xiti:intro_xiti'));
	...
	debut_cadre_trait_couleur("../"._DIR_PLUGIN_XITI."images/logo_xiti.gif", '', '', _T('xiti:form_xiti'));
