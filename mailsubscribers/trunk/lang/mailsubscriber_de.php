...
@url_confirmsubscribe@',
	...
	'unsubscribe_texte_email_3' => 'Falls ein Irtum vorliegt, oder Sie Ihre Meinung ändern, können Sie sich jederzeit unter der folgenden Adresse wieder anmelden:
@url_subscribe@',

	// T
	'texte_ajouter_mailsubscriber' => 'Newsletter-Abonnent hinzufügen',
	'texte_avertissement_import' => 'Die Spalte <tt>Status</tt> wird zur bereitgestellt: Daten werden unverändert importiert, vorhandene Mailadressen werden gelöscht.',
