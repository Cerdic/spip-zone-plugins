<?php
  ...
  'cfg_lbl_files_quota' => 'Quota de fichiers', 
  'cfg_lbl_manage_title' => 'Titre des fichiers',
	'cfg_inf_files_accepted' => 'Mettre les extensions s&eacute;par&eacute;es par des pipes ex: pdf|txt|odt ou gif|jpg|png',
	'cfg_inf_insert_code' => 'Afficher le code d\'insertion des documents uploadés <em>&lt;img12&gt;,&lt;doc12&gt;</em> ...',
	'cfg_inf_files_number' => 'L\'utilisateur ne pourra uploader que ce nombre de fichiers au maximum',
  'cfg_inf_files_quota' => 'Nombre de fichiers maximum pour un utilisateur donné.<br />Vide = Quota infini',
  'cfg_manage_title' => 'Gérer les titres des documents uploadés',
  ...
  'erreur_copie_impossible' => 'Erreur: copie impossible',
	...
	'msg_doc_added' => '@compteur@ document(s) ajout&eacute;(s)',
  'msg_doc_added_max' => 'Vous avez atteint la limite des @max@ documents à télécharger',
	'msg_doc_deleted' => '@compteur@ document(s) supprim&eacute;(s)',
