...
if (!defined('_ISOCODE_GEONAMES_INFORMATIONS_PAYS')) {
	 ...
	 */
	define('_ISOCODE_GEONAMES_INFORMATIONS_PAYS', 'services/nomenclature/iso/iso3166countries-geonames-info.txt');
}
if (!defined('_ISOCODE_M49_REGION_PAYS')) {
	 ...
	 * Complément à la table iso639countries.
	 */
	define('_ISOCODE_M49_REGION_PAYS', 'services/nomenclature/m49/m49regions_countries.txt');
}
...
$GLOBALS['isocode']['iso'] = array(
	...
	'iso4217currencies' => array(
		...
		'populating'   => 'file_xml',
		'extension'    => '.xml',
		'node'         => 'CcyTbl/CcyNtry',      // clé à laquelle débute la liste des éléments
	),
);
