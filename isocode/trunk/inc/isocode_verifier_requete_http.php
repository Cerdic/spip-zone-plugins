 ...
 */
function requete_isocode_verifier_collection($collection, $collections, &$erreur) {
 ...
 *        `true` si la valeur est valide, `false` sinon.
 */
function requete_isocode_verifier_filtres($filtres, $collection, $configuration, &$erreur) {
