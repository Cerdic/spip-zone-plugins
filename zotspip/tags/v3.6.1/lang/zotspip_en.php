...
// extrait automatiquement de https://trad.spip.net/tradlang_module/zotspip?lang_cible=en
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'explication_maj_zotspip' => 'ZotSpip is synced every 4 hours with the Zotero server. Only the last changes are taken into account. You can force a full sync of all references. If your library is large, this sync will be performed in several steps, only 50 references being synchronized in a row.', # MODIF
