...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'amapiens_explication' => 'Sur cette page vous trouverez la liste des amapiens de votre association. En cliquant sur le nom, vous retournerez sur la page de l\'auteur. Tenir à jour les informations de chaqu\'un est obligatoire au moment du changement de saison.',
	'attention' => 'ATTENTION !',
	'attention_modifications' => '<p>Vous venez d\'activer le plugin AMAP, ce dernier vient de créer une nouvelle rubrique "Agenda de la saison" avec deux sous-rubriques "Distribution" et "Évènements", ainsi que la rubrique "Archives".</p>
									...
									4. Mettre à jour les <b>types d\'adhérent</b>, <b>adhésion</b> et <b>types de panier</b> sur la page de chaque auteur sinon aucun panier ne pourra lui être attribué.<br />
	...
	'autorise_envoie_email_explication' => 'L\'envoi d\'email est utilisé pour la mise à disposition des paniers et la reprise. Non conseillé pour de grosses AMAP. À la place, on vous propose une interface de gestion.',
	'autorise_envoie_email_label' => 'Voulez-vous envoyer des mails ?',
	'avant_le' => 'avant le',

	// C
	'configurer_amap' => 'Configuration du plugin AMAP',
	'confirmation_envoi' => 'Votre mise à disposition du panier du @date_distribution@ est confirmée, nous vous remercions.',
	...
	'envoyer' => 'Envoyer',
	'envoyez_email_non' => 'Non, ne pas envoyer de mails aux adhérents.',
	'envoyez_email_oui' => 'Oui, envoyer des mails aux adhérents.',
	...
	'livraison' => 'Livraison',
	'livraison_explication' => 'Sur cette page, vous trouverez la liste des livraisons que vous avez déjà effectuées. Le contenu de ce tableau est visible sur la page <a href="@url@"><b>suivante</b></a>.',
	...
	'mettre_disposition_explication' => 'Via cette page, vous retrouvez vos paniers mais vous pouvez aussi les mettre à disposition, c\'est à dire que si vous ne pouvez pas venir, vous pouvez l\'échanger ou le donner. Cliquer sur le lien "mettre à disposition" et suivez la procédure.',
	'mettre_disposition_interface' => 'Un tableau est accessible pour les récupérés ensuite. Le contenu de ce tableau est visible sur la page <a href="@url@"><b>à cette adresse</b></a>.',
	'mettre_disposition_mail' => 'Un mail sera envoyé à tous les adhérents.',
...
@panier_dispo_plus@
@nom_adherent@',
	'panier_dispo_plus' => 'Des infos à donner en plus (elles seront ajoutées dans le courriel envoyé avant votre nom)',
	'panier_disposition' => 'Vous avez mis 1 panier à disposition',
	'panier_distribuer' => 'panier à distribuer',
	'panier_explication' => 'Sur cette page, vous trouverez la liste des paniers que vous devez distribuer. Ils sont modifiables et supprimables. Toutes modifications entraînent un envoie de mail en masse à tous les adhérents et les producteurs de l\'association.',
...
@nom_adherent@',
	...
	'pas_responsable_pour_nom' => '@nom@ n\'est pas responsable de distribution.',
	'pas_statuts_nom' => '@nom@ n\'a pas de statut actuellemment. Éditer son profil pour renseigner son statut.',
	'petit' => 'Petit',
	...
	'responsables_explication' => 'Sur cette page, vous trouverez la liste des responsables avec la date de distribution à laquelle ils ont été associé. Ce tableau est affichable sur le site via un article en mettant le code <liste|distributions>',
