...
// $Id: fckplugin.js,v 1.3 2007/03/06 19:38:17 thierrybo Exp $
// ================================================
...
// ================================================
	...
	oImageManagerItem.IconPath = FCKPlugins.Items['ImageManager'].Path + 'icon.gif' ; 
...
ImageManager.prototype.insert = function(outparam)
{
	...
	if (IM_directEdit)
	{
		...
		if (sElm != null && sElm.nodeName.toLowerCase() == 'img')
		{
			...
			var url = FCKPlugins.Items['ImageManager'].Path + 'editor.php?img=' + "/" + imgFileName;
	...
	{
		var manager = FCKPlugins.Items['ImageManager'].Path+'manager.php';
