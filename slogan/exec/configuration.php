...
//
    ...
    $slogan_site = entites_html($GLOBALS['meta']["slogan_site"]);
    ...
    debut_cadre_relief("", false, "", _T('info_slogan_site'));
	echo "<input type='text' name='slogan_site' value=\"$slogan_site\" size='40' class='forml' />";
	fin_cadre_relief();
