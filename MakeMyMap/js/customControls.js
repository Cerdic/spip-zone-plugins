...
mapTypeControl.prototype.initialize = function(map) {
	...
	typeMapImg.src = URLbase + URLabsolute+"/img_pack/" + images_folder + "/ctlMap." + images_extension;
	...
	typeSatImg.src = URLbase + URLabsolute+"/img_pack/" + images_folder + "/ctlSat." + images_extension;
	...
	typeHybImg.src = URLbase + URLabsolute+"/img_pack/" + images_folder + "/ctlHyb." + images_extension;
...
mapZoomControl.prototype.initialize = function(map) {
	...
	GEvent.addDomListener(zoomIn, "click", function() {
		this.parentNode.childNodes[18 - map.getZoom()].firstChild.src = URLbase + URLabsolute+"/img_pack/" + images_folder + "/ctlZoomNotch." + images_extension;
		map.zoomIn();
		this.parentNode.childNodes[18 - map.getZoom()].firstChild.src = URLbase + URLabsolute+"/img_pack/" + images_folder + "/ctlZoomSel." + images_extension;
	});
	var zoomInImg = document.createElement("img");
	zoomInImg.src = URLbase + URLabsolute+"/img_pack/" + images_folder + "/ctlZoomIn." + images_extension;
	...
	for(var i=0; i < 18; i++){
		...
		GEvent.addDomListener(notchDiv[i], "click", function() {
			...
			this.firstChild.src = URLbase + URLabsolute+"/img_pack/" + images_folder + "/ctlZoomSel." + images_extension;
		});
		notchDiv[i].zoom = i;
		notchDiv[i].style.position = "absolute";
		notchDiv[i].style.top= 9 + (i*9) + "px";
		notchImg[i] = document.createElement("img");
		notchImg[i].src = URLbase + URLabsolute+"/img_pack/" + images_folder + "/ctlZoomNotch." + images_extension;
	...
	zoomOutImg.src = URLbase + URLabsolute+"/img_pack/" + images_folder + "/ctlZoomOut." + images_extension;
...
mapMoveControl.prototype.initialize = function(map) {
	...
	mapMoveImgUL.src = URLbase + URLabsolute+"/img_pack/" + images_folder + "/ctlTopLeft." + images_extension;
	...
	butomUpImg.src = URLbase + URLabsolute+"/img_pack/" + images_folder + "/ctlTop." + images_extension;
	...
	mapMoveImgUR.src = URLbase + URLabsolute+"/img_pack/" + images_folder + "/ctlTopRight." + images_extension;
	...
	butomRightImg.src = URLbase + URLabsolute+"/img_pack/" + images_folder + "/ctlRight." + images_extension;
	...
	butomCenterImg.src = URLbase + URLabsolute+"/img_pack/" + images_folder + "/ctlCenter." + images_extension;
	...
	butomLeftImg.src = URLbase + URLabsolute+"/img_pack/" + images_folder + "/ctlLeft." + images_extension;
	...
	mapMoveImgDL.src = URLbase + URLabsolute+"/img_pack/" + images_folder + "/ctlBotLeft." + images_extension;
	...
	butomDownImg.src = URLbase + URLabsolute+"/img_pack/" + images_folder + "/ctlBot." + images_extension;
	...
	mapMoveImgDR.src = URLbase + URLabsolute+"/img_pack/" + images_folder + "/ctlBotRight." + images_extension;
