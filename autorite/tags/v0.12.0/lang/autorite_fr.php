...
// Fichier source, a modifier dans https://git.spip.net/spip-contrib-extensions/autorite.git
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'attention_crayons' => '<small><strong>Attention.</strong> Les réglages ci-dessous ne peuvent fonctionner que si vous utilisez un plugin proposant une interface d’édition (comme par exemple <a href="https://contrib.spip.net/Les-Crayons">les Crayons</a>).</small>',
