...
// extrait automatiquement de http://trad.spip.net/tradlang_module/autorite?lang_cible=nl
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'attention_crayons' => '<small><strong>Let op.</strong> Onderstaande instellingen werken slechts wanneer je een plugin gebruikt die aanpassing vanaf de publieke site mogelijk maakt (zoals bijvoorbeeld <a href="http://contrib.spip.net/Les-Crayons">Crayons</a>).</small>',
...
<p>Lees voor meer informatie <a href="http://contrib.spip.net/Autorite">de documentatie</a>.</p>',
