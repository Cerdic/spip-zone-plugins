...
// extrait automatiquement de https://trad.spip.net/tradlang_module/autorite?lang_cible=ar
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'auteur_modifie_article' => '<strong>المؤلف يعدّل المقال</strong>: كل محرر يمكنه تعديل مقالاته المنشورة.
<br />
ملاحظة: ينطبق هذا الخيار أيضاً على الزوار المسجلين، اذا كانوا مؤلفين وإذا توافرت لهم واجهة مناسبة.',
...
<br />لحل هذه المشكلة، يجب التأكد من ان ملف <tt>mes_options.php</tt> (أو ملحق آخر نشط) قد حدد هذه الوظائف.',
	...
	'descriptif_2' => '<p>إذا كنت تريد تغيير هذه القائمة، الرجاء تحرير الملف <tt>config/mes_options.php</tt> (أنشاؤه إذا لم يكن موجوداً) وتحديد قائمة معرفات المشرفين، على النحو التالي:</p>
<pre>&lt;?php
  define(
    \'_ID_WEBMESTRES\',
    \'1:5:8\');
