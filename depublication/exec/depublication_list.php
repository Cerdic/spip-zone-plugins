...
function exec_depublication_list_dist() {
	...
	$out .= barre_onglets("list_depublication", "depublication");
	...
	$out .=  recuperer_fond("prive/navigation/depublication",$contexte);
	$out .=  recuperer_fond("prive/contenu/depublication",$contexte);
