...
@puce@ There is a choice of two options for generating the small window which appears on the mouseover. [[%glossaire_js%]]',
	...
	'help3' => '<p>Documentation links:<br/>• [Le&nbsp;Couteau&nbsp;Suisse->https://contrib.spip.net/?article2166]@contribs@</p><p>Resets :
...
[[%liens_orphelins%]]',
	...
	'outil_intro_old' => 'This is the old interface.<br /><br />If you have difficulties in using <a href=\\\'./?exec=admin_couteau_suisse\\\'>the new interface</a>, please let us know in the forum of <a href=\\\'https://contrib.spip.net/?article2166\\\'>Spip-Contrib</a>.',
...
As a webmaster yourself, you can change this list od IDs. Use a colon as a separator if there are more than one. e.g. "1:5:6".[[%webmestres%]]',
	...
	// X
	'xml:description' => 'Activates the XML validator for the public site, as described in the [documentation->https://www.spip.net/en_article3582.html]. An &laquo;&nbsp;Analyse XML&nbsp;&raquo; button is added to the other admin buttons.',
