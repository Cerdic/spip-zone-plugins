...
Esta herramienta puede acoplarse con &laquo;&nbsp;[.->sommaire]&nbsp;&raquo;.',
	...
	'detail_jquery3' => '{{Atenci&oacute;n}}: esta herramienta necesita el plugin [jQuery para SPIP 1.92->https://files.spip.net/spip-zone/jquery_192.zip] para funcionar correctamente con esta versi&oacute;n de SPIP.',
...
[[%message_travaux%]][[%titre_travaux%]][[%admin_travaux%]][[%prive_travaux%]]',
	...
	'erreur:jquery' => '{{Nota}}: la biblioteca {jQuery} parece estar inactiva para esta p&aacute;gina. Consulta [aqu&iacute;->https://contrib.spip.net//La-navaja-suiza] el p&aacute;rrafo sobre las dependencias del plugin, o recarga esta p&aacute;gina.',
...
@puce@ Se ofrecer&aacute;n dos soluciones para generar la peque&ntilde;a ventana autom&aacute;tica que aparece al pasar el rat&oacute;n por encima. [[%glossaire_js%]]',
	...
	'help3' => '<p>Enlaces a documentaci&oacute;n:<br/>• [La&nbsp;Navaja&nbsp;Suisza->https://contrib.spip.net/La-navaja-suiza]@contribs@</p><p>Reinicializaciones:
