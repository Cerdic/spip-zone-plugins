...
[[%message_travaux%]][[%titre_travaux%]][[%admin_travaux%]][[%prive_travaux%]]',
	...
	'erreur:jquery' => '{{Note}} : la librairie {jQuery} semble inactive sur cette page. Veuillez consulter [ici->https://contrib.spip.net/Le-Couteau-Suisse] le paragraphe sur les d&eacute;pendances du plugin ou recharger cette page.',
...
@puce@ Deux solutions vous sont offertes pour g&#233;n&#233;rer la petite fen&ecirc;tre automatique qui appara&icirc;t lors du survol de la souris. [[%glossaire_js%]]',
	...
	'help3' => '<p>Liens de documentation :<br/>&bull; [Le&nbsp;Couteau&nbsp;Suisse->https://contrib.spip.net/Le-Couteau-Suisse]@contribs@</p><p>R&eacute;initialisations :
...
[[%liens_orphelins%]]',
	...
	'outil_intro_old' => 'Cette interface est ancienne.<br /><br />Si vous rencontrez des probl&egrave;mes dans l\'utilisation de la <a href=\'./?exec=admin_couteau_suisse\'>nouvelle interface</a>, n\'h&eacute;sitez pas &agrave; nous en faire part sur le forum de <a href=\'https://contrib.spip.net/Le-Couteau-Suisse\'>Spip-Contrib</a>.',
