...
Cet outil peut &ecirc;tre coupl&eacute; avec &laquo;&nbsp;[.->sommaire]&nbsp;&raquo;.',
	...
	'detail_jquery3' => '<MODIF>{{Attention}} : deze tool heeft een andere plugin nodig[jQuery pour SPIP 1.92->https://files.spip.net/spip-zone/jquery_192.zip]om efficient te functioneren met deze spip versie.',
...
[[%message_travaux%]][[%titre_travaux%]][[%admin_travaux%]]',
	...
	'erreur:jquery' => '<MODIF>{{Note}} : de bibliotheek {jQuery} schijnt inactief op deze pagina. Consulteer:[ici->https://contrib.spip.net/?article2166] de paragraaf op de \'d&eacute;pendances\' van de plugin of  herlaad deze pagina.',
...
_ • [Van hele plugin|Aan de eerste stand van plugin terugkomen->@reset@]@install@
	...
	'help3' => '<NEW><p>Liens de documentation :<br/>&bull; [Le&nbsp;Couteau&nbsp;Suisse->https://contrib.spip.net/?article2166]@contribs@</p><p>R&eacute;initialisations :
...
[[%liens_orphelins%]]',
	...
	'outil_intro_old' => 'Deze interface is oud.<br /><br />Als u problemen in het gebruik van <a href=\' ./? exec=admin_couteau_suisse\'> nieuwe interface ondervindt</a>, aarzelt niet aandeel ervan doen over het forum van <a href=\'https://contrib.spip.net/?article2166\'>Spip-Contrib</a>.',
