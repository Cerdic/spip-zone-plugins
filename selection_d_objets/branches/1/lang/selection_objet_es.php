...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'explication_selection_cible' => 'Si no se ha seleccionada a ningún objetos, todos serán disponibles',
	'explication_selection_objets_cible' => 'Los Objetos Diana que pueden ser vinculados con "Objetos de Selección"',
	'explication_selection_type_liens' => 'Puedes definir tipos de relación: pon uno por línea, seguido de una coma et de una descripción. La descripción puede ser una cadena de idioma', # MODIF

	// I
	'icone_creer_selection_objet' => 'Seleccionar un objet',
	'icone_modifier_selection_objet' => 'Modificar este objeto seleccionado', # MODIF
	'info_1_selection_objet' => 'Un objeto seleccionado', # MODIF
	'info_aucun_selection_objet' => 'Ningún objeto seleccionado', # MODIF
	'info_nb_selection_objets' => '@nb@ objetos seleccionados', # MODIF
	...
	'selection_type_lien' => 'Tipo de vínculo',
	'selection_type_liens' => 'Definición de tipos de enlace', # MODIF
	'selectione' => 'Seleccionado:',

	// T
	'texte_ajouter_objet' => 'Seleccionar un objeto',
	'texte_changer_statut_objet' => 'Este objeto seleccionado está:', # MODIF
	'texte_creer_asselection_objetcier_objet' => 'Crear y vincular un objet',
	'titre_langue_objet' => 'Idioma de este objeto seccionado', # MODIF
	'titre_logo_selection_objet' => 'Logo de este objeto seleccionado', # MODIF
	'titre_selection_objet' => 'Objet Sélectionné', # NEW
	'titre_selection_objets' => 'Objeto seleccionado', # MODIF
	'titre_selection_objets_rubrique' => 'Objetos seleccionados de la sección', # MODIF
	'type_liens_defaut' => 'tipos de enlace por defecto, pueden ser sobrescritos más abajo',
	'type_liens_surcharge' => 'sobrescribir los tipos de vínculos por defecto' # MODIF
);
