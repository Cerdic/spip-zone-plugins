...
if (!defined("K_TCPDF_EXTERNAL_CONFIG")) {
	 ...
	 * In the context of spip2pdf it could be a relatif path.
	 */	
	define ("K_PATH_MAIN", "plugins/spip2pdf/tcpdf/");
	
	/**
	 * url path (http://localhost/tcpdf/)	 
	 * We use the meta that use #URL_SPIP_SITE 
	 */
	define ("K_PATH_URL", $GLOBALS['meta']['adresse_site']."/plugins/spip2pdf/tcpdf/");
	...
	/**
	 * images directory
	 * From the SPIP context it's simply the IMG directory 
	 * in a standard installation
	 */	
	define ("K_PATH_IMAGES", "./IMG/");
	//define ("K_PATH_IMAGES", "/home/dev/projets/spip/IMG/");
	 ...
	 * image logo
	 */
	define ("PDF_HEADER_LOGO", "siteon0.jpg");
