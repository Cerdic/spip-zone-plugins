...
// extrait automatiquement de https://trad.spip.net/tradlang_module/seo?lang_cible=ru
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	// E
	'explication_description' => 'Длинна ссылки не должна превышать 160 символов.',
	'explication_title' => 'Рекомендуемая  длинна от 5 до 70 символов.',
	...
	'google_analytics_activate' => 'Добавить Google Analytics',
	...
	// I
	'info_count_max' => 'Минимальное количество символов: ',
	...
	'meta_tags_default' => 'Генерация  мета-тегов по умолчанию (для статей и разделов)',
	'meta_tags_edit_activate' => 'Разрешить изменять мета-теги в разделах и статьях',
