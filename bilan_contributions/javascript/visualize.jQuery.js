 ...
 *
 * Modif pour spip : 
 * - Augmentation du nombre de couleur (colors)
 * - modulo lors de l'attribution d'une couleur pour ne pas taper hors du tableau
 * --------------------------------------------------------------------
*/
(function($) { 
$.fn.visualize = function(options, container){
	return $(this).each(function(){
		...
		var o = $.extend({
			...
			rowFilter: ' ',
			colFilter: ' ',
			colors: ['#be1e2d','#666699','#92d5ea','#ee8310','#8d10ee','#5a3b16','#26a4ed','#f45a90','#e9e744','#ff0000','#00ff00','#0000ff','#ffff00','#00ffff','#000000'],
				...
				dataGroups: function(){
					...
					if(o.parseDirection == 'x'){
						self.find('tr:gt(0)').filter(o.rowFilter).each(function(i){
							dataGroups[i] = {};
							dataGroups[i].points = [];
							dataGroups[i].color = colors[i%15];
