<?php
// modificato per poter configurare tutti i forum
/***************************************************************************\
...
// https://code.spip.net/@exec_config_contenu_dist
...
echo "\n<tr><td  style='text-align: $spip_lang_left;' class='verdana2'>";
   ...
   echo "<br />\n";
   if ($forums_publics == "abp") $block = "'none', 'block'"; 
   else $block= "'block', 'none'";
   echo bouton_radio("forums_publics", "abp", _T('abp:bouton_radio_abp'), $forums_publics == "abp", "changeVisible(this.checked, 'config-options', $block);");
