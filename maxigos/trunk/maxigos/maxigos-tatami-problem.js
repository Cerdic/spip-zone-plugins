...
(function(){var a="",e=document.createElement("style");
a+=".mxTatamiGlobalBoxDiv.mxProblemGlobalBoxDiv div.mxSolveDiv{margin:0 auto;text-align:center;line-height:1.8em;}"
a+=".mxTatamiGlobalBoxDiv.mxProblemGlobalBoxDiv div.mxCommentDiv {text-align:center;margin:0 auto;min-height:1.75em;}"
...
a+=".mxTatamiGlobalBoxDiv.mxProblemGlobalBoxDiv div.mxSolveDiv button[disabled] {color:#999;}";
e.type='text/css';
if (e.styleSheet) e.styleSheet.cssText=a;
else e.appendChild(document.createTextNode(a));
document.getElementsByTagName('head')[0].appendChild(e);
