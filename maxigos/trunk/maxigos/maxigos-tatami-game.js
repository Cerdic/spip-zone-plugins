...
a+=".mxTatamiGlobalBoxDiv button{cursor:pointer;margin:2px;padding:0.2em 0.3em;border:0;border-radius:0;box-shadow:none;color:#000;background:#fff;height:2em;min-height:0;font-size:1em;vertical-align:middle;}"
...
a+=".mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv h1.mxTitleH1{font-size:1.4em;padding:0 0.25em;}"
...
a+="/* buttons */.mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv div.mxButtonsDiv{margin:0.5em 0;text-align:center;line-height:1.8em;}"
a+=".mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv div.mxShowOptionDiv input[type=text]{text-align:center;width:2em;min-height:0;}"
...
a+="/* others */.mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv .mxSpeedDiv {text-align:center;margin:0.5em auto;}"
...
a+=".mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv div.mxGotoDiv {margin:0.5em auto;height:0.75em;width:60%;background:#fff;outline:1px solid #999;cursor:pointer;}"
...
a+="@media (max-height:42em){.mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv div.mxPlayerDiv{display:none;}"
a+="}";
e.type='text/css';
if (e.styleSheet) e.styleSheet.cssText=a;
else e.appendChild(document.createTextNode(a));
...
mxG.D[mxG.K].b[2]={n:"BottomBox",c:["Navigation","Loop","Speed","Goto","Option","Cut","Pass","Header","Sgf","Buttons"]};
...
mxG.D[mxG.K].adjustTopBoxWidth="GobanBox";
...
mxG.D[mxG.K].buttons="Option,Cut,Pass,Header,Sgf";
