...
(function(){var a="",e=document.createElement("style");
a+="div.mxNeoClassicGlobalBoxDiv.mxProblemGlobalBoxDiv div.mxCommentDiv{margin:0 auto;text-align:center;padding-top:0.5rem;padding-bottom:0.5rem;}"
a+="div.mxNeoClassicGlobalBoxDiv.mxProblemGlobalBoxDiv div.mxCommentContentDiv{display:inline-block;text-align:justify;}"
a+="div.mxNeoClassicGlobalBoxDiv.mxProblemGlobalBoxDiv div.mxSolveDiv{margin:0 auto;text-align:center;padding-top:0.5rem;padding-bottom:0.5rem;}"
a+="div.mxNeoClassicGlobalBoxDiv.mxProblemGlobalBoxDiv div.mxSolveDiv button{font-family:Arial,sans-serif;font-size:0.875em;height:auto;min-height:0;border:1px solid rgba(0,0,0,0.3);margin:1px;padding:0.125em 0.375em;color:#000;background:transparent;box-shadow:none;border-radius:0;}"
a+="div.mxNeoClassicGlobalBoxDiv.mxProblemGlobalBoxDiv div.mxSolveDiv button[disabled]{border:1px solid rgba(0,0,0,0.2);color:rgba(0,0,0,0.3);}";
e.type='text/css';
if (e.styleSheet) e.styleSheet.cssText=a;
else e.appendChild(document.createTextNode(a));
document.getElementsByTagName('head')[0].appendChild(e);
