...
(function(){var a="",e=document.createElement("style");
a+="div.mxNeoClassicGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxCommentDiv{height:7em;overflow:auto;border:1px solid #ccc;border-bottom:0;background:transparent;margin:0 auto;}"
...
a+="div.mxNeoClassicGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxTreeDiv{padding:0.25em;height:7em;overflow:auto;border:1px solid #ccc;background:transparent;margin:0 auto;}"
a+="div.mxNeoClassicGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxTreeDiv[data-maxigos-disabled]{opacity:0.3;}"
a+="div.mxNeoClassicGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxButtonsDiv{text-align:center;margin:0 auto;padding-top:0.5rem;padding-bottom:0.5rem;}"
a+="div.mxNeoClassicGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxButtonsDiv button,div.mxNeoClassicGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxOKDiv button{font-family:Arial,sans-serif;font-size:0.875em;height:auto;min-width:6em;min-height:0;border:1px solid rgba(0,0,0,0.3);margin:1px;padding:0.125em 0.375em;color:#000;box-shadow:none;border-radius:0;}"
a+="div.mxNeoClassicGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxButtonsDiv button{background:transparent;}"
a+="div.mxNeoClassicGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxButtonsDiv button.mxActivatedScoreBtn{color:#c33;}"
...
a+="div.mxNeoClassicGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxShowOptionDiv,div.mxNeoClassicGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxShowSgfDiv{position:relative;border:1px solid rgba(0,0,0,0.3);background:#fff;text-align:left;}"
...
a+="div.mxNeoClassicGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxOKDiv{position:absolute;bottom:0;left:0;right:0;padding:0.5em;text-align:center;background: rgba(0,0,0,0.1);}"
a+="div.mxNeoClassicGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxShowContentDiv input[type=text]{font-size:0.875em;width:3em;height:1em;min-height:0;padding:0.125em;text-align:center;border:1px solid #ccc;background:transparent;border-radius:0;}"
a+="div.mxNeoClassicGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxShowContentDiv input[type=text]:disabled{border:1px solid #eee;}";
e.type='text/css';
if (e.styleSheet) e.styleSheet.cssText=a;
else e.appendChild(document.createTextNode(a));
document.getElementsByTagName('head')[0].appendChild(e);
...
mxG.D[mxG.K].b[0]={n:"MainBox",c:["Option","Sgf","Score","Buttons","Diagram","Goban","Navigation","Goto","Variations"]};
mxG.D[mxG.K].b[1]={n:"BesideBox",c:["Title","Header","Comment","Tree"]};
