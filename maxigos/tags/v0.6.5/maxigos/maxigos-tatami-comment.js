...
(function(){var a="",e=document.createElement("style");
a+=".mxTatamiGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxButtonBoxDiv{padding:0.5em;text-align:center;line-height:1.8em;}"
...
a+="/* buttons */.mxTatamiGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxShowOptionDiv input[type=text]{text-align:center;width:2em;min-height:0;}"
...
a+="/* others */.mxTatamiGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxCommentDiv{height:6.75em;position:relative;margin:0.5em 12px;overflow-x:auto;overflow-y:scroll;background:#fff;}"
...
a+="@media (max-height:42em){.mxTatamiGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxPlayerDiv{display:none;}"
a+="}";
e.type='text/css';
if (e.styleSheet) e.styleSheet.cssText=a;
else e.appendChild(document.createTextNode(a));
...
mxG.D[mxG.K].b[1]={n:"BottomBox",c:["Navigation","Comment","Option","Cut","Pass","Header","Sgf","Buttons"]};
