...
a+=".mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxButtonBoxDiv{padding:0.5em 0;text-align:center;line-height:1.8em;}"
...
a+="/* buttons */.mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxShowOptionDiv input[type=text]{text-align:center;width:2em;min-height:0;}"
...
a+="/* others */.mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxCommentDiv,.mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxTreeDiv{position:relative;margin:0.5em 12px;overflow-x:auto;overflow-y:scroll;background:#fff;}"
...
a+="@media (max-height:42em){.mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxPlayerDiv{display:none;}"
a+="}";
e.type='text/css';
if (e.styleSheet) e.styleSheet.cssText=a;
else e.appendChild(document.createTextNode(a));
...
mxG.D[mxG.K].b[1]={n:"BottomBox",c:["Navigation","Comment","Tree","Option","Cut","Pass","Header","Sgf","Buttons"]};
