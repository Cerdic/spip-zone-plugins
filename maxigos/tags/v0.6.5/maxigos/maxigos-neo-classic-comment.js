...
(function(){var a="",e=document.createElement("style");
a+="div.mxNeoClassicGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxCommentDiv{height:7em;overflow:auto;background:#transparent;border:1px solid rgba(0,0,0,0.3);margin:0 auto;}"
...
a+="div.mxNeoClassicGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxButtonsDiv{text-align:center;padding-top:0.5rem;padding-bottom:0.5rem;}"
a+="div.mxNeoClassicGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxButtonsDiv button,div.mxNeoClassicGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxOKDiv button{font-family:Arial,sans-serif;font-size:0.875em;height:auto;min-width:6em;min-height:0;border:1px solid rgba(0,0,0,0.3);margin:1px;padding:0.125em 0.375em;color:#000;box-shadow:none;border-radius:0;}"
a+="div.mxNeoClassicGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxButtonsDiv button{background:transparent;}"
a+="div.mxNeoClassicGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxButtonsDiv button.mxActivatedScoreBtn{color:#c33;}"
...
a+="div.mxNeoClassicGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxShowOptionDiv,div.mxNeoClassicGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxShowSgfDiv{background:#fff;border:1px solid rgba(0,0,0,0.3);}"
...
a+="div.mxNeoClassicGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxOKDiv{position:absolute;bottom:0;left:0;right:0;padding:0.5em;text-align:center;background:rgba(0,0,0,0.1);}"
a+="div.mxNeoClassicGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxShowContentDiv input[type=text]{font-size:0.875em;width:3em;height:1em;min-height:0;padding:0.125em;text-align:center;border:1px solid #ccc;background:transparent;border-radius:0;}"
a+="div.mxNeoClassicGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxShowContentDiv input[type=text]:disabled{border:1px solid #eee;}";
e.type='text/css';
if (e.styleSheet) e.styleSheet.cssText=a;
else e.appendChild(document.createTextNode(a));
document.getElementsByTagName('head')[0].appendChild(e);
...
mxG.D[mxG.K].b[1]={n:"BesideBox",c:["Title","Header","Comment"]};
