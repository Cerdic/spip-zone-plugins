...
(function(){var a="",e=document.createElement("style");
a+="div.mxChameleonGlobalBoxDiv.mxDiagramGlobalBoxDiv div.mxNotSeenDiv{text-align:left;margin:0 auto;padding-top:0.5rem;padding-bottom:0.5rem;}"
a+="div.mxChameleonGlobalBoxDiv.mxDiagramGlobalBoxDiv div.mxInNotSeenDiv{white-space:nowrap;display:inline-block;padding:0.1em;}"
a+="div.mxChameleonGlobalBoxDiv.mxDiagramGlobalBoxDiv div.mxInNotSeenDiv * {vertical-align:middle;}";
e.type='text/css';
if (e.styleSheet) e.styleSheet.cssText=a;
else e.appendChild(document.createTextNode(a));
document.getElementsByTagName('head')[0].appendChild(e);
...
mxG.D[mxG.K].b[0]={n:"GobanBox",c:["Diagram","Goban"]};
