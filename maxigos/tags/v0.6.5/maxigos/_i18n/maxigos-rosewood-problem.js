...
a+="div.mxRosewoodGlobalBoxDiv.mxProblemGlobalBoxDiv div.mxSolveDiv button{font-family:Arial,sans-serif;font-size:0.875em;height:auto;min-height:0;border:1px solid rgba(0,0,0,0.4);margin:1px;padding:0.25em;color:rgba(0,0,0,0.8);background:transparent;box-shadow:none;}"
