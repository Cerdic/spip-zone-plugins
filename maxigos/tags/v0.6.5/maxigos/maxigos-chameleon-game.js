...
(function(){var a="",e=document.createElement("style");
a+="div.mxChameleonGlobalBoxDiv.mxGameGlobalBoxDiv div.mxMainBoxDiv,div.mxChameleonGlobalBoxDiv.mxGameGlobalBoxDiv div.mxHeaderDiv{margin:0 auto;}"
a+="div.mxChameleonGlobalBoxDiv.mxGameGlobalBoxDiv div.mxHeaderDiv{padding:0.5rem;text-align:left;background:rgba(0,0,0,0.05);}"
a+="div.mxChameleonGlobalBoxDiv.mxGameGlobalBoxDiv div.mxHeaderDiv h1{text-align:left;font-size:1em;margin:0;padding:0;}";
e.type='text/css';
if (e.styleSheet) e.styleSheet.cssText=a;
else e.appendChild(document.createTextNode(a));
document.getElementsByTagName('head')[0].appendChild(e);
