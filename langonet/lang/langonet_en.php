...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'info_generer' => 'This option allows you to generate, from a source language, the language file for a module in a target language. If the target file already exists, its content will be reused when creating the new file.', # NEW
	'info_langue' => 'Language code (for example: <em>fr</em>, <em>en</em>, <em>es</em>...)', # NEW
	'info_lister' => 'This option allows you to see the items in a language file listed in alphabetical order.', # NEW
	'info_mode' => 'Corresponds to the string which will be inserted at creation of a new target language item.', # NEW
	'info_module' => 'Corresponds to the language file prefix without the language code (eg. <em>rainette</em> for the plugin by that name, or <em>ecrire</em> for SPIP)', # NEW
	'info_pattern_item_cherche' => 'Enter a string corresponding entirely or partially to a language item shortcut. The search is still case insensitive.', # NEW
	'info_pattern_texte_cherche' => 'Enter a string corresponding entirely or partially to a French translation of a language item. The search is still case insensitive.', # NEW
	'info_rechercher_item' => 'This option allows you to search for language items in all the language files available on the site. For performance reasons, only French language files will be scanned.', # NEW
	'info_rechercher_texte' => 'This option allows you to search for language items by their French translation in the SPIP language files <em>ecrire_fr</em>, <em>public_fr</em> and <em>spip_fr</em>. This is so as to check whether a piece of text already exists in SPIP before creating it yourself.', # NEW
