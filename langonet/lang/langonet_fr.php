...
// M
	...
	'message_nok_fichier_langue' => 'Le fichier de langue &laquo;<em>@langue@</em>&raquo; du module &laquo;<em>@module@</em>&raquo; est introuvable sous &laquo;<em>@dossier@</em>&raquo; !',
	...
	'message_ok_n_non_utilises' => 'Les @nberr@ items de langue ci-dessous sont bien d&eacute;finis dans le fichier de langue choisi, mais ne sont pas utilis&eacute;s dans l\'arborescence &agrave; v&eacute;rifier :',
	...
	'message_nok_plugin_inactif' => 'Le plugin &laquo;<em>@arbo_verif@</em>&raquo; n\'est pas activ&eacute;. Activez-le avant de continuer les v&eacute;rifications.',
