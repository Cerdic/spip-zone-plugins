...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'message_ok_non_utilises_0' => 'Todos los ítems de idioma definidos en el archivo de idioma «<em>@langue@</em>» son utilizados en los archivos de la carpeta «<em>@ou_fichier@</em>».',
	'message_ok_non_utilises_0s' => 'Todos los ítems de idioma definidos en el archivo de idioma «<em>@langue@</em>» son utilizados en los archivos de las carpetas «<em>@ou_fichier@</em>».',
	'message_ok_non_utilises_1' => 'El ítem de idioma siguiente esta definido en el archivo de idioma «<em>@langue@</em>», pero no esta utilizado en los archivos de la carpeta «<em>@ou_fichier@</em>»:',
	'message_ok_non_utilises_1s' => 'El ítem de idioma siguiente esta definido en el archivo de idioma «<em>@langue@</em>», pero no esta utilizado en los archivos de las carpetas «<em>@ou_fichier@</em>»:',
	'message_ok_non_utilises_n' => 'Los @nberr@ ítems de idioma siguientes están definidos en el archivo de idioma  «<em>@langue@</em>», pero no están utilizados en los archivos de la carpeta «<em>@ou_fichier@</em>»:',
	'message_ok_non_utilises_ns' => 'Los @nberr@ ítems de idioma siguientes están definidos en el archivo de idioma «<em>@langue@</em>», pero no están utilizados en los archivos de las carpetas «<em>@ou_fichier@</em>»:',
