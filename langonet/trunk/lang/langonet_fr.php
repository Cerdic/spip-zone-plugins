...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'info_rechercher_item' => 'Cette option vous permet de chercher des items de langue dans tous les fichiers de langue présents sur le site. Par souci de performance, seuls les fichiers de langue française sont scannés et les fichiers de langue <em>paquet-xxxx_fr.php</em> sont exclus.',
	'info_rechercher_texte' => 'Cette option vous permet de chercher des items de langue via leur traduction française dans les fichiers de langue de SPIP et des plugins disponibles. Par souci de performance, seuls les fichiers de langue française sont scannés, les fichiers de langue <em>paquet-xxxx_fr.php</em> sont exclus et vous pouvez choisir de limiter votre recherche à une liste de modules.',
