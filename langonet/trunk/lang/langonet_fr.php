...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'info_rechercher_item' => 'Cette option vous permet de chercher des items de langue dans les fichiers de langue présents sur le site. Par souci de performance, seuls les fichiers de langue française sont utilisés et les fichiers de langue <em>paquet-xxxx_fr.php</em> sont exclus.',
