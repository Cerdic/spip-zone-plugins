...
function inc_afficher_articles($titre, $requete, $formater='') {
	...
	if (!isset($requete['SELECT'])) {
		$requete['SELECT'] = "articles.id_article, articles.surtitre, articles.titre, articles.soustitre, articles.visites, articles.popularite, articles.id_rubrique, articles.statut, articles.date, articles.lang, articles.id_trad, articles.descriptif";
	}
...
function inc_formater_article($row, $own='')
{
	...
	$surtitre = typo(supprime_img($row['surtitre']));
