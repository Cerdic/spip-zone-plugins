...
function formulaires_abosympa_single_verifier_dist($nomliste = ""){
...
function formulaires_abosympa_single_traiter_dist($nomliste = ""){
...
$Sympa = new SympaTrustedApp($conf['serveur_distant'], $conf['identifiant'], $conf['mot_de_passe']);
		...
		try {
		    $soapResult = $Sympa->subscribe($nomliste, $nom);
