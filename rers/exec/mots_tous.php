...
{ 
	$result = sql_select("*, ".sql_multi ("titre", "$spip_lang"), "spip_groupes_mots", "titre <> '_config_'", "", "multi"); // rers critère    titre différent de _config_ pour les rédacteurs
}
...
// https://code.spip.net/@confirmer_mot
