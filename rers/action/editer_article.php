...
//RERS    LORS de la rédaction d'un nouvel article :
//RERS    - pour les rubriques offre et demande :    statut publié par défaut
//RERS    - pour la rubrique VIE du RERS : statut proposé à la publication par défaut
	...
	if ($id_rubrique == $rers_rub_offres OR  $id_rubrique == $rers_rub_demandes) {
		$rers_statut_new= 'publie';
	}
	else if ($id_rubrique == $rers_rub_vie) {
		$rers_statut_new= 'prop';
	}
	else {
		$rers_statut_new= 'prepa';
	}
