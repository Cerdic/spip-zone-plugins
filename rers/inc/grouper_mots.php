...
//RERS   compter également les articles avec statut prepa (car c'est le cas des offres et demandes)
//RERS	$aff_articles = sql_in('O.statut',  ($GLOBALS['connect_statut'] =="0minirezo")  ? array('prepa','prop','publie') : array('prop','publie'));
	$aff_articles = sql_in('O.statut',   array('prepa','prop','publie') );
