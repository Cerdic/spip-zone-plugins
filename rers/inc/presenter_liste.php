...
//RERS    Pagination : passer le nombre 10 par défaut à 20  (par exemple utile pour afficher tous les mots
//RERS      clé dans la page mots_tous)
//RERS define('_TRANCHES', 10);
define('_TRANCHES', 20);
