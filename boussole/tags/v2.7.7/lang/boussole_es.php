...
// extrait automatiquement de https://trad.spip.net/tradlang_module/boussole?lang_cible=es
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'info_nom_serveur' => 'Introduzca el nombre que desee dar a su servidor de brújulas. El nombre «spip» está reservado al servidor de la URL «http://boussole.spip.net» y no puede ser utilizado.', # MODIF
	'info_rubrique_parent' => 'Para crear los sitios de la brújula debe crear una sección de inicio.',
	...
	'label_langue_site' => 'Para los datos traducidos, importar sólo la traducción en el idioma del sitio.',
	...
	'label_publier_import' => 'Publicar automáticamente los sitios web automáticamente creados. El estatus de los sitios web anteriormente a la importación existentes no se modificará.',
	...
	'label_titre_actualite' => '¿Mostrar el título del bloque de actualidad?', # MODIF
	...
	// M
	'message_nok_0_site_importe' => 'Ningún sitio web ha sido importado desde la brújula @boussole@.',
	...
	'message_ok_1_site_importe' => 'Se ha importado un solo sitio web desde la brújula @boussole@.',
	...
	'message_ok_n_sites_importes' => '@nb@ sitios web se han importado desde la brújula @boussole@.',
