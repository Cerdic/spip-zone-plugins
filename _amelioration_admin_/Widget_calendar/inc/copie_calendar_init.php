...
function WCalendar_ajoute($suffixe){
	global $WCalendar_independants;	
	$WCalendar_independants[] = $suffixe;
}
function WCalendar_ajoute_lies($suffixe_debut,$suffixe_fin){
	global $WCalendar_lies;	
	$WCalendar_lies[] = array($suffixe_debut,$suffixe_fin);
}
