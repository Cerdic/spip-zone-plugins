...
$lang['configurations_navigateursbytype'] = "Броузери (по типове)"; // TODO : translate
$lang['configurations_navigateursbytypeimg'] = "Графика на типовете броузери"; // TODO : translate
...
$lang['install_problemedroitrepertoire'] = "Невъзможно да се пише във фолдера %s : моля проверете дали имате нужните права да създавате файлове в сървъра (опитайте CHMOD 777 с вашия FTP софтуер (десен клик на директорията -> Permissions (or CHMOD))."; // Cannot access the file config.php...
