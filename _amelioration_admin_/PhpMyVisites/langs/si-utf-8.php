...
$lang['auteur_email'] = "sstonchy@gmail.com"; // Translator's email
...
$lang['install_problemedroitrepertoire'] = "Ne morem pisati v direktorij %s : prosim preglejte ali imate potrebna dovoljenja za kreireanje datotek na strežniku (poskusite CHMOD 777 direktorij v vašem ftp klient (desni klik na direktorij -> Privilegij(Dovoljenja, chmod))."; // Cannot access the file config.php...
