...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	// M
	'mode_info' => '<p>Pour choisir le mode de chargement direct depuis votre serveur, il vous faudra télécharger la libraire à l\'adresse suivante <a href="https://github.com/mathjax/MathJax/zipball/v1.1a" title="Télécharger la librairie">https://github.com/mathjax/MathJax/zipball/v1.1a</a>, en extraire son contenu, puis le déplacer dans le dossier <em>lib/mathjax/</em> (à créer si besoin) à la racine du site.</p>',
