...
// https://code.spip.net/@insere_1_init
...
// https://code.spip.net/@insere_1bis_init
...
// https://code.spip.net/@insere_2_init
...
// https://code.spip.net/@translate_init
...
// https://code.spip.net/@import_insere
...
// https://code.spip.net/@import_translate
...
// https://code.spip.net/@import_inserer_translate
...
// https://code.spip.net/@import_translate_std
...
// https://code.spip.net/@import_translate_spip_articles
...
// https://code.spip.net/@import_translate_spip_breves
...
// https://code.spip.net/@import_translate_spip_documents
...
// https://code.spip.net/@importe_translate_maj
...
// https://code.spip.net/@importe_raccourci
...
// https://code.spip.net/@import_identifie_id_document
...
// https://code.spip.net/@import_identifie_id_type
...
// https://code.spip.net/@import_identifie_id_groupe
...
// https://code.spip.net/@import_identifie_id_mot
...
// https://code.spip.net/@import_identifie_parent_id_mot
...
// https://code.spip.net/@import_identifie_id_article
...
// https://code.spip.net/@import_identifie_parent_id_article
...
// https://code.spip.net/@import_identifie_id_breve
...
// https://code.spip.net/@import_identifie_parent_id_breve
...
// Memoriser ces 2 infos et le signaler a import_translate grace a 1 negatif
// https://code.spip.net/@import_identifie_id_rubrique
...
// https://code.spip.net/@import_identifie_parent_id_rubrique
...
// https://code.spip.net/@import_alloue_id_rubrique
