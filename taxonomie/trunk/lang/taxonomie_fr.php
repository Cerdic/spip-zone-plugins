...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'import_taxons_edites_ajouter' => 'Importer les taxons du fichier d’import en préservant les modifications déjà effectuées sur les taxons de la base',
	'import_taxons_edites_explication' => 'Il existe, dans la base du site, des taxons du règne au genre dont certains champs ont déjà été modifiés manuellement.',
	'import_taxons_edites_avertissement' => 'La base du site ne contient aucun taxon du règne au genre modifié manuellement.',
	'import_taxons_edites_fusionner' => 'Importer les taxons du fichier d\'import sans préserver les modifications des taxons de la base',
	'import_taxons_edites_label' => 'Les taxons du règne au genre modifiés manuellement',
	'import_especes_ajouter' => 'Importer uniquement les espèces du fichier d’import qui n\'existent pas encore dans la base',
	'import_especes_explication' => 'Il existe déjà des espèces dans la base du site.',
	'import_especes_avertissement' => 'La base du site ne contient aucune espèce.',
	'import_especes_fusionner' => 'Importer toutes les espèces du fichier d’import sans préserver les données des espèces déjà créées dans la base',
	'import_especes_label' => 'Les espèces et descendants',
	'import_regne_avertissement' => 'Aucun règne n\'est encore chargé dans le site. Il n\'est donc pas possible d\'importer des données. Veuillez charger au moins un règne avant de faire une importation de taxons.',
	'info_aucun_descendant' => 'Aucun taxon enfant',
