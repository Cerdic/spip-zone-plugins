...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'import_taxons_edites_ajouter' => 'Intégrer les modifications de taxons du fichier d’import dans les taxons du site sans écraser les éventuelles modifications existantes.',
	'import_taxons_edites_explication' => 'Il existe dans le site des taxons du règne au genre dont certains champs ont été modifiés.',
	'import_taxons_edites_avertissement1' => 'Il n\'existe  pas dans le site de taxons du règne au genre modifiés.',
	'import_taxons_edites_fusionner' => 'Intégrer les modifications de taxons du fichier d’import dans les taxons du site sans tenir compte de l\'existant.',
	'import_taxons_edites_label' => 'Les taxons du règne au genre édités',
	'import_especes_ajouter' => 'Ajouter les espèces du fichier d’import. Les espèces disponibles sur le site ne seront pas modifiées.',
	'import_especes_explication' => 'Il existe déjà des espèces dans le site.',
	'import_especes_fusionner' => 'Ajouter les espèces du fichier d’import et remplacer les espèces du site aussi disponibles dans le fichier d’import.',
