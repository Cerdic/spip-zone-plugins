...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'article_propose_titre' => 'Article propos&eacute;
	---------------',
	'article_propose_detail' => 'L\'article "@titre@" est propos&eacute; &agrave; la publication
	depuis',
	'article_propose_url' => 'Vous &ecirc;tes invit&eacute; &agrave; venir le consulter et &agrave; donner votre opinion
	dans le forum qui lui est attach&eacute;. Il est disponible &agrave; l\'adresse :',
	
	'article_valide_sujet' => '[@nom_site_spip@] VALIDE : @titre@',
	'article_valide_titre' => 'Article valid&eacute;
	--------------',
	'article_valide_detail' => 'L\'article "@titre@" a &eacute;t&eacute; valid&eacute; par @connect_nom@.',
	'article_valide_date' => 'Sous r&eacute;serve de changement, cet article sera publi&eacute;',
	'article_valide_url' => 'En attendant, il est visible &agrave; cette adresse temporaire&nbsp;:',
	
	'article_publie_sujet' => '[@nom_site_spip@] PUBLIE : @titre@',
	'article_publie_titre' => 'Article publi&eacute;
	--------------',
