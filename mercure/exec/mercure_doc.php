...
echo $commencer_page(_T('mercure:mercure_titre'), "suivi", "mercure_doc");
...
\*---------------------------------------------------------------------------*/
	...
	debut_boite_info();
  echo _T('mercure:documentation');
	fin_boite_info();
  echo "<p class='space_20'></p>";
	debut_boite_info();
  echo _T('mercure:minidoc').
       '<br />'.
       _T('mercure:conf_notify_avertissement');
	fin_boite_info();
