...
function coordonnees_upgrade($nom_meta_base_version, $version_cible){
	...
	$maj['1.4'] = array(
			array('sql_alter', array('TABLE spip_adresses_liens ADD type varchar(25) not null default ""')),
			array('sql_alter', array('TABLE spip_adresses_liens DROP PRIMARY KEY')),
			array('sql_alter', array('TABLE spip_adresses_liens ADD PRIMARY KEY (id_adresse, id_objet, objet, type)')),
			array('sql_alter', array('TABLE spip_numeros_liens ADD type varchar(25) not null default ""')),
			array('sql_alter', array('TABLE spip_numeros_liens DROP PRIMARY KEY')),
			array('sql_alter', array('TABLE spip_numeros_liens ADD PRIMARY KEY (id_numero, id_objet, objet, type)')),
