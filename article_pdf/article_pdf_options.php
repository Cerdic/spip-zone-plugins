...
function balise_ARTICLE_PDF_RESTREINT_dist($p) {
	if (!is_array($p->param))
		$p->param=array();

	// Produire le premier argument {article_pdf_restreint}
	$texte = new Texte;
	$texte->type='texte';
	$texte->texte='article_pdf_restreint';
	...
	// Appeler la balise #MODELE{article_pdf_restreint}{arguments}
