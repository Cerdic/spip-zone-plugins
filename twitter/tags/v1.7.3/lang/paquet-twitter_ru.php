...
// extrait automatiquement de https://trad.spip.net/tradlang_module/paquet-twidget?lang_cible=ru
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	// T
	'twitter_description' => 'Виджет Twitter легко установить
...
Плагин работает по принципу прокси, таким образом, посетители не делают никаких запросов, и проследить их активность становится невозможным.', # MODIF
	'twitter_slogan' => 'Виджет Twitter легко установить '
);
