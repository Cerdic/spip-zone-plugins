...
// extrait automatiquement de https://trad.spip.net/tradlang_module/paquet-twidget?lang_cible=en
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	// T
	'twitter_description' => 'Easy send micromessages with Twitter and it\'s oAuth API.
...
The plugin acts as a proxy so that no request is made by your visitors to Twitter and avoid the possibility to trace their activities (preservation of personal life).',
	'twitter_slogan' => 'Twitter easy : display and send messages'
);
