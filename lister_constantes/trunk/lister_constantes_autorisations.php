 ...
 * @return bool          true s'il a le droit, false sinon
**/
function autoriser_configurer_lister_constantes_bouton_dist($faire, $type, $id, $qui, $opt)
{
    return $qui['statut'] == '0minirezo' and $qui['webmestre'] == 'oui';
}
 ...
 * @return bool          true s'il a le droit, false sinon
**/
function autoriser_lister_constantes_bouton_dist($faire, $type, $id, $qui, $opt)
{
    return $qui['statut'] == '0minirezo' and $qui['webmestre'] == 'oui';
}
 ...
 * @return bool          true s'il a le droit, false sinon
**/
function autoriser_configurer_lister_constantes_bando_bouton_dist($faire, $type, $id, $qui, $opt)
{
    return $qui['statut'] == '0minirezo' and $qui['webmestre'] == 'oui';
}
 ...
 * @return bool          true s'il a le droit, false sinon
**/
function autoriser_lister_constantes_bando_bouton_dist($faire, $type, $id, $qui, $opt)
{
    return $qui['statut'] == '0minirezo' and $qui['webmestre'] == 'oui';
}
