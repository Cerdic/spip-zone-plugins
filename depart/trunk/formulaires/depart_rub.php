 ...
 * @author     Teddy Payet
 * @licence    GNU/GPL
 * @package    SPIP/Formulaires/DepartRub
 */
...
function formulaires_depart_rub_charger_dist($id_rubrique) {
...
*/
function formulaires_depart_rub_verifier_dist($id_rubrique) {
	...
	if ($rubrique_dest == $id_rubrique) {
		$erreurs['rubrique_dest'] = _T('depart:rubrique_source_identique_destination');
	}

	return $erreurs;
}

function formulaires_depart_rub_traiter_dist($id_rubrique) {
	include_spip('inc/utils');
