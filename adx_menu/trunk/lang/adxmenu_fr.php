...
Le plugin peut s\'utiliser de deux fa&ccedil;ons d&eacute;taill&eacute;es ci-dessous. Il est pr&eacute;vu pour proposer une page de configuration gr&acirc;ce au plugin {{[CFG : moteur de configuration->https://contrib.spip.net/Config-CFG]}} mais celui-ci n\'est pas obligatoire[[Cela ne concerne que les versions de SPIP inférieures à 3.0 ; au-delà, la configuration est proposée en interne.]].
...
Pour plus d\'informations, reportez-vous &agrave; la page d&eacute;di&eacute;e par l\'auteur : [->http://aplus.rs/adxmenu/buy/].',
	...
	'licence_actuelle' => 'Plugin pour SPIP 2.0+ : {{"ADX Menu" - copyright &#169; 2009 [Piero Wbmstr->https://contrib.spip.net/PieroWbmstr] sous la licence originale ({[Creative Commons BY 3.0 Attribution->http://creativecommons.org/licenses/by/3.0/]}) }}.',
