...
// extrait automatiquement de http://trad.spip.org/tradlang_module/noizetier?lang_cible=de
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'formulaire_composition_explication' => 'Geben sie ein einziges Schlagwort an (in Kleinschreibung, ohne Leerzeichen, ohne Minuszeichen (-) und ohne Akzente oder Umlaute) um diese Komposition zu identifizieren.<br />z.B.: <i>meinekomposition</i>.',
	...
	'formulaire_icon_explication' => 'Sie können den relativen Pfad zu einem Icon angeben (z.B.: <i>images/objekt-liste-inhalte.png</i>). Eine Liste der Icons in Standardverzeichnissen finden sie<a href="../spip.php?page=icones_preview">auf dieser Seite</a>.',
	...
	'formulaire_modifier_composition_heritages' => 'Vererbungen dieser Komposition ändern:',
	...
	'formulaire_supprimer_composition' => 'Diese Komposition löschen',
	'formulaire_supprimer_noisette' => 'Diese Code-Nuss löschen',
	'formulaire_supprimer_noisettes_page' => 'Code-Nüsse dieser Seite löschen',
	'formulaire_type' => 'Kompositionstyp',
	'formulaire_type_explication' => 'Geben sie an, für welches Objekt bzw. welchen Seitentyp diese Komposition gestaltet ist.',
