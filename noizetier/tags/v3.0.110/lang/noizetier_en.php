...
',
	...
	'bulle_configurer_composition_noisettes' => 'Configure the nuts of the composition',
	...
	'configurer_dynamique_noisette_label' => 'Dynamic inclusion',
	...
	'configurer_types_noisettes_masques_explication' => 'Check the types of nuts <strong>do not want</strong> to offer  when adding a nut .',
	'configurer_types_noisettes_masques_label' => 'Types of nuts available',
	...
	'erreur_deplacement_noisette' => 'The nut @noisette@ has not been moved.',
	...
	'erreur_saisie_css_invalide' => 'The syntax for entering CSS is incorrect (word, hyphen and space allowed).',
	...
	'explication_copie_noisette_conteneur' => 'The configuration parameters will apply to the container nut and also to all included nuts that will also be duplicated.',
...
<i>@composition@<strong>_suffixe</strong></i>',
	...
	'explication_noizetier_cfg_constant' => 'This value is currently defined via a constant, it cannot be changed here.',
	...
	'formulaire_import_contenu' => 'Choose the elements to import',
	...
	'import_compositions_virtuelles_ajouter' => 'Add the virtual compositions of the import file. The virtual compositions available on the site will not be modified.',
	'import_compositions_virtuelles_avertissement1' => 'There are no virtual compositions on the site. It is just possible to import those from the import file. ',
	'import_compositions_virtuelles_avertissement2' => 'No virtual composition is available in the import file. No import is therefore possible.',
	'import_compositions_virtuelles_explication' => 'There are virtual compositions in the site and in the import file.',
	'import_compositions_virtuelles_fusionner' => 'Add virtual compositions from the import file and replace the virtual compositions from the site also available in the import file.',
	'import_compositions_virtuelles_label' => 'Virtual compositions',
	'import_compositions_virtuelles_remplacer' => 'Replace the virtual compositions available on the site by those of the import file',
	'import_configuration_avertissement' => 'The @version@ version of the noiZetier plugin active on this site has a different @schema@ schema than the import file. <b>Check the compatibility of the configurations before importing the file</b>.',
	'import_configuration_explication' => 'The @version@ version of the noiZetier plugin active on this site has the same @schema@ schema as the import file.',
	'import_configuration_label' => 'Plugin configuration',
	'import_configuration_labelcase' => 'Replace the current configuration of the noiZetier by that of the import file',
	'import_noisettes_ajouter' => 'Add the nuts from the import file to the pages or objects concerned. The nuts currently configured on the site will not be modified',
	'import_noisettes_avertissement1' => 'There are no common pages or objects in the site and in the import file. No import is therefore possible.',
	'import_noisettes_avertissement2' => 'No nuts are available in the import file. Therefore, no import is possible.',
	'import_noisettes_explication' => 'There are common pages or objects in the site and in the import file.',
	'import_noisettes_label' => 'Nuts',
	'import_noisettes_remplacer' => 'Replace, for the pages or objects concerned, the nuts currently configured for the site by the nuts in the import file',
	'import_pages_explicites_avertissement1' => 'There are no common explicit pages or compositions between the site and the import file. All imports are therefore unnecessary.',
	'import_pages_explicites_avertissement2' => 'No explicit pages or compositions available on the site. All imports are therefore unnecessary.',
	'import_pages_explicites_explication' => 'There are explicit pages and compositions common between the site and the import file.',
	'import_pages_explicites_label' => 'Blocks excluded from explicit pages',
	'import_pages_explicites_labelcase' => 'Replace the blocks excluded from the explicit pages of the site by those of the import file',
	'import_resume' => 'The file to import was built with the noiZetier in version@version@, data schema @schema@.',
	'info_0_noisette' => 'No nut configured',
	'info_0_noisette_composition' => 'No nuts for this composition',
	'info_0_noisette_objet' => 'No nuts for this content',
	'info_0_noisette_objets' => 'No nuts for @objets@',
	'info_1_noisette' => 'A nut configured',
	'info_1_noisette_ajoutee' => '1 nut has been added',
	'info_1_noisette_composition' => '1 nut for this composition',
	'info_1_noisette_objet' => '1 nut for this content',
	'info_1_noisette_objets' => '1 nut for @objets@',
	'info_composition' => 'COMPOSITION:',
	'info_etendre_noisette' => 'Copy the nut @noisette@ in the block@bloc@ of other pages',
	'info_nb_noisettes' => '@nb@ nuts configured',
	'info_nb_noisettes_ajoutees' => '@nb@ nuts have been added',
	'info_nb_noisettes_composition' => '@nb@ nuts for this composition',
	'info_nb_noisettes_objet' => '@nb@ nuts for this content',
	'info_nb_noisettes_objets' => '@nb@ nuts for @objets@',
	'info_page' => 'PAGE:',
...
',
	...
	'label_noizetier_dynamique' => 'By default, include each nut dynamically',
	'label_source_noisettes' => 'Nuts source',
	'label_texte' => 'Text:',
	...
	'option_noisette_encapsulation_defaut' => 'Use the default mode configured for the noiZetier <em>(@defaut@)</em>',
	'option_noisette_encapsulation_non' => 'Never encapsulate the nut.',
