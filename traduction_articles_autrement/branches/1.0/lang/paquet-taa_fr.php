<?php
	 ...
	 // T
	 'taa_description' => 'Modification de l\'interface privé de;de spip afin de permettre à l\'utilisateur une autre approche pour la traductions des articles; tout en maintenant le syst&egrave;me de traduction original de spip. Pour pouvoir utiliser l\'affichage compacte des listes d\'article (option disponible via cfg), il faut installer le plugin [afficher_objets->http://files.spip.org/spip-zone/afficher_objets.zip].
	...
	'taa_slogan' => 'Rendre la traduction des articles plus aisé.',
);
?>