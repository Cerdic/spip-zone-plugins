...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	// T
	'taa_description' => 'Modificación del interface privado de spip a fin de dar al utilizador otro enfoque    de la traducción de los artículos pero manteniendo el sistema de traducción original de spip. Para poder utilizar la apariencia compacta de las listas de  artículos (opción disponible via cfg), hay que instalar  el plugin [afficher_objets->http://files.spip.org/spip-zone/afficher_objets.zip].
