...
// extrait automatiquement de https://trad.spip.net/tradlang_module/paquet-taa?lang_cible=en
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	// T
	'taa_description' => 'Changing the private interface spip to give the user a different approach to translations of articles while maintaining the original translation spip system. To use the compact display lists of articles (available via cfg), you must install the plugin [display_objects->https://files.spip.net/spip-zone/afficher_objets.zip].

Compact lists now also work on a site with multilingualism by areas. This requires installing the plugin [Translation between articles->https://files.spip.net/spip-zone/tradrub.zip]
