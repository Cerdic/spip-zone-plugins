...
// articles_edit pour Jaxe, basé sur la révision 7048 de articles_edit.
...
// https://code.spip.net/@articles_edit_recolle
...
// https://code.spip.net/@chapo_articles_edit
...
// https://code.spip.net/@formulaire_articles_edit
// Modifs Jaxe
...
"function editer() {editwin = window.open('../plugins/jaxespip/JaxeSPIPApplet/edition.html', '', " .
"'scrollbars=yes,scrolling=auto,toolbar=no,directories=no,menubar=no,status=no, width=720,height=640');}" .
"</script>" .
"<input type='button' value='Editer avec Jaxe' onclick='editer()'><br>" .
...
//	echo formulaire_articles_edit($row, $lier_trad, $new, $GLOBALS['meta']);
	echo exec_formulaire_articles_edit($row, $lier_trad, $new, $GLOBALS['meta']);
//
