...
// I
	...
	'info_aucune_version_spip' => 'Non communiquée',
	'info_boite_charger_plugin' => '<strong>Cette page est uniquement accessible aux responsables du site.</strong><p>Elle vous permet de rechercher des plugins mis à disposition par les dépôts enregistrés dans votre configuration et de les installer physiquement sur votre serveur. Les plugins déjà installés ne sont pas proposés.</p>',
	'info_boite_depot_gerer' => '<strong>Cette page est uniquement accessible aux responsables du site.</strong><p>Elle permet l\'ajout et l\'actualisation des dépôts de plugins. Il est aussi possible de se rendre sur la page d’édition de chaque dépôt.</p>',
	'info_charger_plugin' => 'Ce formulaire vous permet de rechercher des plugins suivant plusieurs critères parmi lesquels la catégorie ou l\'état. Les plugins trouvés sont tous compatibles avec la version installée de SPIP, à savoir @version@, et ne font pas partie des plugins actifs.',
	'info_contributions_hebergees' => '@total_autres@ autre(s) contribution(s) hébergée(s)',
	'info_critere_phrase' => 'Saisissez les mots-clés à chercher dans le nom, le slogan, la description et les auteurs des plugins',
	...
	'info_liste_depots' => 'Vous trouverez ci-dessous la liste des dépôts ajoutés à votre base. Tous les plugins hébergés par ces dépôts ont eux aussi été chargés.',
	...
	'info_statistiques' => 'Les statistiques d\'utilisation des plugins peuvent être collectées et tenues à jour régulièrement. Néanmoins, vous pouvez lancer une msie à jour manuelle.',
...
// M
	...
	'message_ok_plugins_trouves' => '@nb_plugins@ plugin(s) correspondent aux critères choisis (@tri@). Sélectionnez ci-dessous les plugins que SPIP téléchargera et installera sur votre serveur.',
// O
...
// T
	...
	'titre_navigation_plugin' => 'Dans la même catégorie',
