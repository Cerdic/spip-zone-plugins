...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	// C
	'confirmation_depublication' => 'Be careful, a published content contains at least one link to this one and will be affected if you change its status!nnDo you still want to change the status?',
	'confirmation_publication' => 'Be careful, this content links to at least one other content that is not published!nnDo you still want to change the status?',
	'confirmation_suppression' => 'Be careful, a published content contains at least one link to this one and will be affected if you delete it!nnDo you still want to delete it?',
