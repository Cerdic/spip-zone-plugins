...
$choses=array_values($tables_installees); //YOANN
...
//include_spip("public/interfaces"); //évite des warning dans l'espace public
if(isset($tables_jointures['spip_'.$chose])){ //si on a pas défini le type evenement ( défini avec le plugin agenda )
