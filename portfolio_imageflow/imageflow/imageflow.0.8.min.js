...
var new_img_top=(images_width*0.34-new_img_h)+images_top+((new_img_h/(conf_reflection_p+1))*conf_reflection_p);image.style.left=xs-(image.pc/2)/z*size+images_left+'px';image.style.top=new_img_top+'px';image.style.visibility='visible';switch(x<0)
...
break;default:zIndex=zIndex+1;document.getElementById("affichage").src=image.getAttribute('name');document.getElementById("affichage").longdesc=image.getAttribute('longdesc');document.getElementById("affichage").title=image.getAttribute('title');break;}
...
document.getElementById("affichage").src=image.getAttribute('name');document.getElementById("affichage").longdesc=image.getAttribute('longdesc');document.getElementById("affichage").title=image.getAttribute('title');image.ondblclick=function(){document.getElementById("affichage").src=this.src;document.getElementById("affichage").type="image/jpeg";}
...
{hide(conf_loading);refresh(true);show(conf_images);show(conf_scrollbar);initMouseWheel();initMouseDrag();}}
