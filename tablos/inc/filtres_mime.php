...
function filtre_text_csv_dist($t)
{
	...
	// Modifs à la noix pour accepter les exports CVS
	...
	// Fin modifs à la noix pour accepter les exports CVS
	...
	/* Merveilleux code commenté qui nous casse nos noissettes
	...
	if ($mil <> $max)
	  foreach($nbcols as $k=>$v) {
	   ...
	   Fin merveilleux code commenté qui nous casse nos noissettes
	    */
