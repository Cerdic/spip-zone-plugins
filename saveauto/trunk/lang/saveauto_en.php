...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	// A
	'ajouter_webmestre' => 'Include the webmaster to the addressees',
	...
	'erreur_repertoire_perso_inaccessible' => 'The configured folder @rep@ is not accessible: the SPIP backup folder will be used instead',
	...
	'help_liste_tables' => 'By default, all SPIP tables are exported with the exception of @noexport@ tables. If you want to choose the tables to be saved precisely, open the list by unchecking the box below.',
	...
	'help_nbr_garder' => 'Indicate the minimum number of backups that should always be saved', # MODIF
	...
	'help_notif_mail' => 'Enter addresses separated by commas ",".',
	...
	'help_repertoire' => 'In order to use a backup folder different from the SPIP default, specify its path from the site root (ending with / )',
...
<em>@prefixe@_yyyymmdd_hhmmss.</em>. The table prefix is retained.',
	...
	'label_nbr_garder' => 'How many backups to save',
	...
	'label_repertoire_sauvegardes' => 'Folder',
	'label_sauvegarde_reguliere' => 'Enable regular backup',
	'label_structure' => 'Structure of the tables',
	'label_tables_non_spip' => 'Non-SPIP tables',
	'label_toutes_tables' => 'Backup all SPIP tables',
	...
	// T
	'titre_boite_historique' => 'MySQL backups available for download in folder @dossier@',
