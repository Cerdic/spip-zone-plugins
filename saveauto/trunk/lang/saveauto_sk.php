...
// extrait automatiquement de https://trad.spip.net/tradlang_module/saveauto?lang_cible=sk
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'erreur_repertoire_perso_inaccessible' => 'Zadaný priečinok @rep@ je neprístup­ný. Namies­to neho sa preto použije bežný zálo­ho­va­cí prieči­nok SPIPu',
	...
	'help_liste_tables' => 'Podľa predvolených nastavení sa exportujú všetky tabuľky okrem tabuliek @noexport@. Ak chcete presne určiť, ktoré tabuľky sa majú zálohovať (ako aj tabuľky, ktoré nevytvoril SPIP), odznačte toto políčko, čím otvoríte ich zoznam.',
	...
	'help_notif_mail' => 'Zadajte adresy oddelené čiarkami ",". Budú pridané k adrese webmastera stránky.', # MODIF
	...
	'help_repertoire' => 'Ak chcete použiť iný odkladací priečinok na zálohy SPIPu, uveďte celú adresu stránky (na konci s /)',
