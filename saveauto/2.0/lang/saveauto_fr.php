	...
	$GLOBALS['i18n_saveauto_fr'] = array(
			    // saveauto_pipeline.php
					...
					// saveauto_fonctions.php
						 'message_MIME' => 'Ceci est un message est au format MIME.',
						 ...
						 'verifier_ecriture' => ', vérifiez les droits d\'&eacute;criture du r&eacute;pertoire ',
						 'fichier_genere' => 'Ce fichier est g&eacute;n&eacute;r&eacute; par le plugin saveauto',
						 'base' => 'Base : ',
						 'serveur' => 'Serveur : ',
						 'date' => 'Date : ',
						 'os' => 'OS Serveur : ',
						 ...
						 'donnees_table' => 'Donn&eacute;es de ',
						 'probleme_donnees' => 'probl&egrave;me avec les donn&eacute;es de ',
