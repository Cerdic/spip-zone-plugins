 ...
 */
	...
	function creer_archives($archives, $archives_lier_vimeo) {
	...
	function creer_video($videos) {
		...
		if ($compte["archives"] === "on") {
			creer_archives($archives, $archives_lier_vimeo);
		}

	}

	function creer_albums($albums,$album_lier_vimeo) {
	...
	function action_vimeo_dist() {
		...
		if ($compte["albums"] === "on") {
			creer_albums($albums_infos,$album_lier_vimeo);
		}
