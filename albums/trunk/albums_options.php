...
// Les suffixes `_VIGNETTES` et `_LISTE` pour restreindre à une variante

// Dimension maximale des vignettes : nombre
if (!defined('_ALBUMS_TAILLE_PREVIEW'))                define('_ALBUMS_TAILLE_PREVIEW',120);

// Recadrer ou non les vignettes
if (!defined('_ALBUMS_RECADRER'))                      define('_ALBUMS_RECADRER',false);

// Pas de pagination (nombre de documents affichés en même temps) : nombre
...
// Balise dans laquelle est placé le titre : balise HTML *sans les chevrons*, ex.: `span`, `h3`, `strong`...
...
// position de la légende (titre et descriptif) : `top` ou `bottom`
