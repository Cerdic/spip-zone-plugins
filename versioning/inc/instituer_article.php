...
function inc_instituer_article_dist($id_article, $statut=-1)
{
	...
	if( (isACopy($id_article)) && (isArticleOrigPublished($id_article)) ) // Si l'article est une copie d'un autre et que l'article original est publié en ligne
	{
		if($statut == 'archi') // Statut archivé
		{
			$res = 
