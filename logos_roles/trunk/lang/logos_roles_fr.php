...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'explications_formulaire_configurer_logos_roles' => "Vous pouvez convertir les logos enregistrés au format SPIP original en documents (déplacement des logos de la racine de IMG vers des documents).<br>
Sélectionnez les types d'objets éditoriaux dont vous voulez migrer les logos puis cliquez sur « Convertir les logos ».",
	...
	'titre_formulaire_configurer_logos_roles' => 'Migration des logos',
