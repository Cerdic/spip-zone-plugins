...
function formulaires_clevermail_list_edit_charger_dist($lst_id = -1) {
    ...
    $cm_mail_admin = sql_getfetsel('set_value', 'spip_cm_settings', 'set_name="CM_MAIL_ADMIN"');
		...
		$valeurs = array(
			...
			'lst_subscribe_subject_multiple' => _T('clevermail:confirmation_votre_inscription_multiple'),
			'lst_subscribe_text_multiple' => _T('clevermail:confirmation_votre_inscription_text_multiple'),
			'lst_subject' => '',
...
function formulaires_clevermail_list_edit_traiter_dist($lst_id = -1) {
  $champs = array(
    ...
    'lst_subscribe_subject_multiple' => _request('lst_subscribe_subject_multiple'),
    'lst_subscribe_text_multiple' => _request('lst_subscribe_text_multiple'),
