...
function clevermail_upgrade($nom_meta_base_version, $version_cible) {
  ...
  if ((!isset($GLOBALS['meta'][$nom_meta_base_version]))
    ...
    if (version_compare($current_version,'0.1','<')) {
      ...
      creer_base();
      sql_insertq('spip_cm_settings',  array('set_name' => 'CM_MAIL_FROM', 'set_value' => sql_quote($GLOBALS['meta']['email_webmaster'])));
      sql_insertq('spip_cm_settings',  array('set_name' => 'CM_MAIL_ADMIN', 'set_value' => sql_quote($GLOBALS['meta']['email_webmaster'])));
      sql_insertq('spip_cm_settings',  array('set_name' => 'CM_MAIL_RETURN', 'set_value' => sql_quote($GLOBALS['meta']['email_webmaster'])));
