...
<p>Pour en savoir plus sur ce plugin, consultez sa <a href="https://contrib.spip.net/Metas">documentation en&nbsp;ligne</a>.</p>',

	// Metadonnees par defaut
	'config_metas_defaut' => 'M&eacute;tadonn&eacute;es par defaut',
	'title_defaut_explication' => 'Si vous ne souhaitez pas utiliser le <a href="?exec=configurer_identite">nom de votre site</a>, indiquez un autre titre&nbsp;:',
	'meta_description_defaut_explication' => 'Si vous ne souhaitez pas utiliser la <a href="?exec=configurer_identite">description du site</a>, r&eacute;digez ici une autre description (en moins de 250 caract&egrave;res)&nbsp;:',
