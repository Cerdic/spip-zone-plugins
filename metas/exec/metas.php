...
function exec_metas() {
	...
	echo '<form method="post" action="'.generer_url_ecrire('metas').'" >';
		echo debut_cadre_trait_couleur("", true, "", _T('metas:configuration_metadonnees'));
			echo '<p>';
				echo '<label for="spip_metas_title"><b>'._T('metas:title_label').'</b></label>';
				echo "<input type=\"text\" name=\"spip_metas_title\" value=\"$spip_metas_title\" class=\"forml\"/>";
			echo '</p>';
			echo '<p>';
				echo '<label for="spip_metas_description"><b>'._T('metas:meta_description_label').'</b></label>';
				echo "<textarea name=\"spip_metas_description\" cols=\"40\" rows=\"4\" class=\"forml\">$spip_metas_description</textarea>";
			echo '</p>';
			echo '<p>';
				echo '<label for="spip_metas_keywords"><b>'._T('metas:meta_keywords_label').'</b></label>';
		...
		echo debut_cadre_trait_couleur("", true, "", _T('metas:configuration_mots_importants'));
			echo '<p>';
				...
				echo '<span class=\"explication\">'._T('metas:mots_importants_explication').'</span>';
			echo '</p>';
			echo '<p style="text-align: right;"><input class="fondo" name="valider" type="submit" value="'._T('metas:valider').'" /></p>';
		echo fin_cadre_trait_couleur(true);
	echo '</form>';
