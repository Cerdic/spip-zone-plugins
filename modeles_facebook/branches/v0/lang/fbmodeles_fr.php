...
Le plugin est pr&eacute;vu pour proposer une page de configuration gr&acirc;ce au plugin {{[CFG : moteur de configuration->https://contrib.spip.net/?rubrique575]}} mais celui-ci n\'est pas obligatoire.
...
Les diff&eacute;rents blocs ci-dessous vous pr&eacute;sentent un exemple de chaque mod&egrave;le avec des valeurs fictives ({la page utilisera vos valeurs si vous utilisez [CFG->https://contrib.spip.net/?rubrique575]}). Reportez-vous au mod&egrave;le correspondant pour les options.',
