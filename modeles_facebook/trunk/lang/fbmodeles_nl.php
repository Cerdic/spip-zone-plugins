...
// extrait automatiquement de https://trad.spip.net/tradlang_module/fbmodeles?lang_cible=nl
...
De verschillende blokken hieronder geven een voorbeeld van ieder model. Gegevens zijn fictief. Kijk bij ieder model voor de opties.',
	...
	'info_skel_contrib' => 'Volledige documentatie online op [spip-contrib->https://contrib.spip.net/?article3872].',
...
-* [Modus "model SPIP"->@mode_spip@] ({compatibel})',
	...
	// L
	'licence' => 'Plugin voor SPIP 2.0+ : {{"Facebook Models" - copyright © 2009 [Piero Wbmstr->https://www.spip-contrib.net/PieroWbmstr] onder ([GPL->http://www.opensource.org/licenses/gpl-3.0.html]}) licentie}}.',
