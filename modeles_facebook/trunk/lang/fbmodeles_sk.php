...
// extrait automatiquement de https://trad.spip.net/tradlang_module/fbmodeles?lang_cible=sk
...
-* [formát "šablóna SPIPu"->@mode_spip@] ({kompatibilné s distribuovanou verziou})',
	...
	// L
	'licence' => 'Zásuvný modul pre SPIP >2.0: {{"Šablóny pre Facebook" – copyright © 2009 [Piero Wbmstr->http://contrib.spip.net/PieroWbmstr] s licenciou [GPL->http://www.opensource.org/licenses/gpl-3.0.html].}}', # MODIF
