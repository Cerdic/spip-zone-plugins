...
// inc/raper_api_abstract_sql.php
...
if (version_compare($GLOBALS['spip_version_code'], '1.9300', '<')
	AND $f = charger_fonction('compat_raper', 'inc'))
		$f();
...
function inc_compat_raper_dist($quoi = NULL) {
	if (!function_exists($f = 'compat_raper_defs')) $f .= '_dist';
	$defs = $f();
...
function compat_raper_defs_dist() {
	$defs = array(
		'sql_fetch' => 
			'(
				$res, 
