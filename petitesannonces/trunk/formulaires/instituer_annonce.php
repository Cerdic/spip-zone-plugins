 ...
 * @return array|bool
 */
function formulaires_instituer_annonce_charger_dist($objet,$id_objet,$retour="",$editable = true){
 ...
 * @return array
 */
function formulaires_instituer_annonce_verifier_dist($objet,$id_objet,$retour="",$editable = true){
	$erreurs = array();
	// charger le contenu de l'objet
	// dont son champ statut
	$v = formulaires_editer_objet_charger($objet,$id_objet,0,0,'','');
 ...
 * @return array
 */
function formulaires_instituer_annonce_traiter_dist($objet,$id_objet,$retour="",$editable = true){
