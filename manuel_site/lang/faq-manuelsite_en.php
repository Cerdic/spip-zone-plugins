...
_ {Please note that the max size of a file is '.$max_filesize.', about a length of '.$duree_son_64m_max_mn.' minutes}',
...
_ {Please note that the max size of a file is '.$max_filesize.', about a length of '.$duree_video_320x240_max_mn.' minutes}',
