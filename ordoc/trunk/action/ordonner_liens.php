...
function action_ordonner_liens_dist() {
	...
	if (!autoriser('modifier', $objet_lie, $id_objet_lie)) {
		return ordoc_json_erreur(_T('ordoc:erreur_autorisation') . ' ' . _T('ordoc:erreur_deplacement_impossible'));
	}
