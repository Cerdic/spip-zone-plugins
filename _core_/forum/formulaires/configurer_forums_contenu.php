...
function formulaires_configurer_forums_contenu_charger_dist(){
	...
	return array(
		'forums_titre' => $GLOBALS['meta']["forums_titre"]=='oui',
		'forums_texte' => $GLOBALS['meta']["forums_texte"]=='oui',
		'forums_urlref' => $GLOBALS['meta']["forums_urlref"]=='oui',
		'forums_afficher_barre' => $GLOBALS['meta']["forums_afficher_barre"]=='oui',
