...
// extrait automatiquement de https://trad.spip.net/tradlang_module/fulltext?lang_cible=fr_tu
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'configurer_egalement_doc' => 'Tu peux également configurer l’indexation des documents :',
	...
	'erreur_doc_bin' => 'Tu dois renseigner le binaire à utiliser pour extraire les .doc',
	'erreur_intervalle_cron' => 'Tu dois indiquer un intervalle supérieur à une seconde.',
	'erreur_nb_docs' => 'Tu dois indiquer un nombre de documents à traiter par itération supérieur à un.',
	'erreur_pdf_bin' => 'Tu dois renseigner le binaire à utiliser pour extraire les .pdf',
	'erreur_ppt_bin' => 'Tu dois renseigner le binaire à utiliser pour extraire les .ppt',
	...
	'erreur_xls_bin' => 'Tu dois renseigner le binaire à utiliser pour extraire les .xls',
	'et' => 'ET',
	'etranger' => 'étranger',
	...
	'fulltext_documentation' => 'Pour plus d’information sur la configuration, consulte la documentation en ligne :',
	...
	'index_reinitialise_totalement' => 'Les documents ont tous été réinitialisés',
	...
	'infos' => 'Informations',
	'infos_documents_proteges' => 'Tu trouveras ici la liste des documents protégés et donc non-indexés par Fulltext',
	'infos_fulltext_document' => 'Tu pourras ici choisir quels type de documents sont indexés par Fulltext et configurer les binaires utilisés et leurs options.',
	...
	// M
	'mais_pas' => 'mais PAS',
	'message_ok_configuration' => 'Enregistrement de tes préférences terminé',
	'message_ok_update_configuration' => 'Mise à jour de tes préférences terminée',
