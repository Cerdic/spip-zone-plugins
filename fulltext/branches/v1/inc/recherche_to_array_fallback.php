...
/*
 * C'est le fichier inc/rechereche_to_array.php du core dont la fonction est renomee
 */

// methodes sql
function inc_recherche_to_array_fallback_dist($recherche, $options = array()) {
