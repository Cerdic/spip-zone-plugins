...
function fulltext_declarer_tables_principales($tables_principales) {
	...
	$tables_principales['spip_documents']['field']['indexe'] = "VARCHAR(3) NOT NULL default 'non'";
  ...
  if ((!isset($GLOBALS['meta'][$nom_meta_base_version]))
    ...
    if (version_compare($current_version,'0.1','<')) {
		...
		ecrire_meta($nom_meta_base_version,$current_version="0.1",'non');
      	spip_log('Installation des tables du plugin Fulltext en version 0.1', 'fulltext');
    }
  }
}
