...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'entree_tri_alpha' => 'Sortering rubrieken (alfabetisch). Kies "date" om op datum te sorteren',
	'entree_tri_alpha_articles' => 'Sortering van artikelen (alfabetisch). Kies "date" om op datum te sorteren',
	'entree_tri_alpha_articles_inverse' => 'Omgekeerde volgorde?',
	'entree_tri_alpha_inverse' => 'Omgekeerde volgorde?',
	'entree_tri_num' => 'Sortering van rubrieken (numeriek). Kies eventueel voor "titre"',
	'entree_tri_num_articles' => 'Sortering van artikelen (numeriek).  Kies eventueel voor "titre"',
	'entree_tri_num_articles_inverse' => 'Omgekeerd numeriek?',
	'entree_tri_num_inverse' => 'Omgekeerd numeriek?',
