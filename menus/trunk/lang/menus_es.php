...
// extrait automatiquement de https://trad.spip.net/tradlang_module/menus?lang_cible=es
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'description_menu_objet' => 'Crea un enlace a un objeto de SPIP: artículo, sección u otro. De manera predeterminada, la entrada será el título del objeto.', # MODIF
	...
	'description_menu_page_speciale_zajax' => 'Añadir un enlace a un bloque de una página accesible por una url del tipo <code>spip.php?page=nom¶m1=xx¶m2=yyy...</code> Esto requiere un esqueleto de tipo Z y el plugin <a href="http://contrib.spip.net/MediaBox"> Mediabox</ a>.', # MODIF
	...
	'entree_articles_max_affiches' => 'Número máximo de artículos listados (seguidos de un enlace "... Todos los artículos", hacia la sección madre)',
	...
	'entree_rubriques_max_affichees' => 'Número máximo de secciones listadas (seguidas de un enlace "... Todas las secciones", hacia la sección madre)',
	...
	'entree_traduction_objet' => 'Elegir la traducción en función del contexto (poner "trad" para esto)',
	'entree_tri' => 'Criterio de orden de las secciones ("titre" para ordenar por título, "num titre" para ordenar por número de título, si se prefija con un "!" se invierte el orden)',
	'entree_tri_articles' => 'Criterio de orden de los artículos ("titre" para ordenar por título, "num titre" para ordenar por número de título, si se prefija con un "!" se invierte el orden)',
