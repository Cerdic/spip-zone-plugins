...
'entree_id_rubrique_pipe'=> 'Num&eacute;ro(s) de(s) rubrique(s) parente(s), s&eacute;par&eacute;s par un "|"',
...
'entree_nombre_evenements' => 'Nombre d\'&eacute;v&eacute;nements au maximum (0 par défaut)',
	'entree_page' => 'Nom de la page',
	'entree_parametres' => 'Liste des param&egrave;tres',
	'entree_sur_n_articles' => '@n@ articles affich&eacute;(s)',
'entree_sur_n_evenements'=>'@n@ &eacute;v&eacute;nements affich&eacute;(s)',
...
'exclure_niveau_pipe'=>'Num&eacute;ro(s) de(s) rubrique(s) &agrave; exclure, s&eacute;par&eacute;s par un "|"',
