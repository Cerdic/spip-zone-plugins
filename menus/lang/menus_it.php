...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'description_menu_deconnecter' => 'Se il visitatore &egrave; connesso, aggiungi un link per proporgli la disconnessione.',
	'description_menu_espace_prive' => 'Link che permette di connettersi al sito se non lo si &egrave; gi&agrave;, e poi di andare in redazione se si &egrave; autorizzati.',
	'description_menu_groupes_mots' => 'Mostra automaticamente un menu che elenca le parole chiave di un gruppo e gli articoli collegati. Normalmente, mostra la lista dei gruppi di parole chiave e le parole collegate. Se un modello groupes_mots.html esiste, il link verso il gruppo verr&agrave; utilizzato',
	'description_menu_lien' => 'Aggiunge un link arbitrario, interno (URL relativo) o esterno (http://...).',
	'description_menu_mapage' => 'Se il visitatore &egrave; connesso, aggiunge un link verso la sua pagina autore.',
	'description_menu_mots' => 'Mostra automaticamente un men&ugrave; che elenca gli articoli collegati alla parola chiave.',
	'description_menu_objet' => 'Crea un link verso un oggetto di SPIP: articolo, rubrica o altro. In maniera predefinita, il link avr&agrave; il titolo dell\'oggetto.',
	...
	'editer_menus_explication' => 'Crea e configura qui i men&ugrave; del tuo sito',
	'editer_menus_exporter' => 'Esporta questo men&ugrave;',
	'editer_menus_nouveau' => 'Crea un nuovo men&ugrave;',
	'editer_menus_titre' => 'Men&ugrave; del sito',
	'entree_aucun' => 'Nessun',
	'entree_choisir' => 'Scegli il tipo di voce che vuoi aggiungere:',
	'entree_css' => 'Classi CSS della voce',
	...
	'erreur_menu_inexistant' => 'Il men&ugrave; richiesto numero @id@ non esiste.',
	'erreur_mise_a_jour' => 'Si &egrave; verificato un errore durante l\'aggiornamento del database.',
	'erreur_parametres' => 'C\'&egrave; un errore nei parametri della pagina',
	'erreur_type_menu' => 'Devi scegliere un tipo di men&ugrave;',

	// F
	'formulaire_ajouter_entree' => 'Aggiungi una voce',
	'formulaire_ajouter_sous_menu' => 'Crea un sotto men&ugrave;',
	'formulaire_css' => 'Classi CSS',
	'formulaire_css_explication' => 'Puoi aggiungere al men&ugrave; delle eventuali classi CSS supplmentari.',
	...
	'formulaire_modifier_menu' => 'Modifica il men&ugrave;:',
	'formulaire_nouveau' => 'Nuovo men&ugrave;',
	'formulaire_partie_construction' => 'Costruzione del men&ugrave;',
	'formulaire_partie_identification' => 'Identificativo del men&ugrave;',
	'formulaire_supprimer_entree' => 'Elimina questa voce',
	'formulaire_supprimer_menu' => 'Elimina il men&ugrave;',
	'formulaire_supprimer_sous_menu' => 'Elimina il sotto men&ugrave;',
