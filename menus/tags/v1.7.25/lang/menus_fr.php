...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'entree_lien_direct_articles_uniques' => 'Si oui et si les articles uniques sont masqués, lorsqu’une une rubrique contient un seul article, faire le lien vers l’article ? (mettre "oui" pour cela)',
