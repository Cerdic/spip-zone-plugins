...
// extrait automatiquement de https://trad.spip.net/tradlang_module/menus?lang_cible=fa
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'description_menu_objet' => 'ايجاد پيوند به چيزهاي اسپيپي: مقاله، بخش يا چيزهاي ديگر. پيش‌گزيده، هر مدخل تيتر آن چيز را داراست.', # MODIF
	...
	'description_menu_page_speciale_zajax' => 'افزودن يك پيوند به يك بلوك در صفحه‌اي قابل دسترس به وسيله‌ي يك يوآرال از نوع <code>spip.php?page=nom&param1=xx&param2=yyy...</code>. اين مستلزم يك استكلت نوع z و يك پلاگين <a href="http://contrib.spip.net/MediaBox">médiabox</a> خواهد بود.  ', # MODIF
...
', # MODIF
	...
	'entree_traduction_objet' => 'در مور مقاله، ترجمه را در ارتباط با آن متن انتخاب كنيد (براي آن trad را بگذاريد)', # MODIF
