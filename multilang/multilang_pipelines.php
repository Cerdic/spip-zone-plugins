					...
					multilang_avail_langs.unshift(multilang_lang_courante) ;
				  	...
				  	jQuery(document).ready(function(){
						function multilang_init(){
							root = "'.$root.'";
							fields_selector = "textarea,input:text:not(input#new_login,input#email,#titreparent,input.date,input.heure,input#largeur,input#hauteur,.ac_input,#url_syndic,*.nomulti,*.multi_lang_no_multi),.multilang";
