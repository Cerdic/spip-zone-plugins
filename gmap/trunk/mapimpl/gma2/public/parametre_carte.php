...
function mapimpl_gma2_public_parametre_carte_dist($viewport, $params, $profile = 'interface')
{
	...
	$code = '{ // Paramètres Google Maps V2
		...
		styleNavigationCommand: "'.(isset($params['ctrl_nav']) ? $params['ctrl_nav'] : gmap_lire_config($apiConfigKey, 'nav_control_style', "3D")).'",
		...
		enableContinuousZoom: '.(((isset($params['option_soft_zoom']) ? $params['option_soft_zoom'] : gmap_lire_config($apiConfigKey, 'allow_continuous_zoom', "non")) === "oui") ? 'true' : 'false').',
