 ...
 *
 * Interface de configuration du comportement des marqueurs pour Google Maps v3
 *
 * Usage :
...
function mapimpl_gma3_prive_show_markers_behavior_dist()
{
	$corps = "";
	
	// Paramètres des info-bulles
	$merge_infos = gmap_lire_config('gmap_gma3_interface', 'merge_infos', 'non');
