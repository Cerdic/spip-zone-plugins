...
function peupler_base() {
	...
	sql_insertq_multi('spip_pays', array(
		...
		array('id_pays'=>'59','code'=>'DO','nom'=>'<multi>[fr]Dominique[en]Dominica[de]Dominica[es]Dominica[it]Dominica[nl]Dominica[pt]Dominica</multi>'),
		...
		array('id_pays'=>'109','code'=>'IR','nom'=>'<multi>[fr]Irak[en]Iraq[de]Irak[es]Iraq[it]Iraq[nl]Irak[pt]Iraque</multi>'),
		array('id_pays'=>'110','code'=>'IQ','nom'=>'<multi>[fr]Iran[en]Iran[de]Iran[es]Irán[it]Iran[nl]Iran[pt]Irão</multi>'),
		...
		array('id_pays'=>'224','code'=>'','nom'=>'<multi>[fr]Territoires extérieurs de l\'Australie[en]External territories of Australia[de]Gebiete au§erhalb von Australien[es]Territorios externos de Australia[it]Territori esterni di Australia[pt]External territórios da Austrália</multi>'),
