...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'explication_framerate' => 'Leave this field blank to keep the same framerate than the original', # MODIF
	...
	'explication_vorbis_qualite' => 'Vorbis codec (or libvorbis) don\'t use constant bit rate but variable, it is preferable to specify the quality not by a bit rate but with a quality level.', # MODIF
	...
	'lien_forcer_ffmpeg_infos' => 'Force the update of these informations', # MODIF
