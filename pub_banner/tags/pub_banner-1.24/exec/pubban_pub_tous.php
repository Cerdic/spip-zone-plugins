...
function exec_pubban_pub_tous_dist() {
	...
	$commencer_page = charger_fonction('commencer_page', 'inc');
 	$titre_page = _T('pubban:liste_pub');
	$rubrique = 'pubban';
	...
	$contexte = array(
		...
		'inverse_2' => _request('inverse_2'),
		'liste_2' => _request('inverse_2') ? _request('inverse_2') : _request('liste_2'),
	...
	$milieu = recuperer_fond("prive/pub_liste_voir",$contexte);
