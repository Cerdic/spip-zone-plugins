...
function exec_pubban_integer_dist() {
	...
	$boite = "<div class='cadre_padding'><div class='infos'>"
		...
		."<li class='poubelle ".(($s == '3') ? "selected" : "" )."'><a href=\"javascript:delete_entry('".generer_action_auteur("activer_emplacement", "trash-$id_empl", generer_url_ecrire('pubban_integer_tous'))."', '"._T('pubban:confirm_delete_empl')."');\"><img src='../prive/images/puce-poubelle.gif' alt=\""._T('pubban:poubelle')."\"  />"._T('pubban:poubelle')."</a></li>"
		."</ul></li></ul>"
	...
	$res = icone_horizontale(_T('pubban:home'), generer_url_ecrire("pubban_admin"), find_in_path("img/stock_home.png"), "rien.gif", false)
		. icone_horizontale(_T('pubban:retour_liste_empl'), generer_url_ecrire("pubban_integer_tous"), find_in_path("img/stock_left.png"), "rien.gif", false)
	...
	$contexte = array(
		'id_empl' => $id_empl,
		'icone_editer' => icone_inline(_T('bouton_modifier'), generer_url_ecrire("pubban_integer_edit","id_empl=$id_empl"), find_in_path("img/stock_edit.png"), "rien.gif",$GLOBALS['spip_lang_right']),
		...
		'redirect'=> generer_url_ecrire("pubban_integer"),
	...
	echo creer_colonne_droite('', true), debut_droite('', true), debut_cadre_trait_couleur(false, true),
		pipeline('affiche_milieu', array( 'args' => array( 'exec' => 'pubban_integer' ), 'data' => $milieu ) ),
