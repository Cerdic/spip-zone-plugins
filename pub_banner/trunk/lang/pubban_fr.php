...
// B //
	...
	'bannieres_pub' => 'Banni&egrave;re(s)',
...
// C //
	...
	'comment_code_pub' => '<em>Pour une publicit&eacute; de type \'image\' ou \'swf\', vous ne devez indiquer ici que l\'adresse url de cette image. Pour un objet flash, vous devez en indiquer le code complet ...</em>',
	...
	'comment_illimite' => '<em>Affichages et clics illimit&eacute;s ; vous pouvez pr&eacute;ciser une date de d&eacute;but ou de fin de p&eacute;riode d\'affichage.</em>',
...
// D //
	...
	// Documentation
	'doc_chapo' => 'Le plugin "Pub Banner" propose une gestion de banni&egrave;res publicitaires pour des squelettes SPIP.',
...
// E //
	...
	'erreur_titre' => 'Vous devez indiquer un titre pour votre publicit&eacute; (<em>il apparaitra au passage de la souris</em>)',
...
// I //
	...
	'info_titre_id_comment' => 'Si le champs est vide, cette valeur sera générée à partir du titre. <em>Il est fortement d&eacute;conseill&eacute; d\'utiliser des caract&egrave;res accentu&eacute;s ou sp&eacute;ciaux, cela pourrait provoquer une erreur lors de l\'appel de la balise PUBBAN ...</em>',
	'info_taille_banniere' => 'Dimensions de la banni&egrave;re',
	'info_banniere' => 'Statut de la banni&egrave;re',
	'info_ratio_banniere' => 'Ratio de la banni&egrave;re (<em>optionnel</em>)',
	'info_refresh_banniere' => 'Délai de rafraîchissement',
	'intro_integer' => 'Les <em>banni&egrave;res</em> : banni&egrave;res publicitaires',
	...
	'intro_admin' => 'Gestion des <em>Banni&egrave;res Publicitaires</em>',
	'info_stats' => 'Quelques chiffres ...',
	'info_ratio' => 'Ratio (clics/affichages)', 
	'info_search_box' => '<em>Rechercher</em> > saisissez une r&eacute;f&eacute;rence, un mot ou groupe de mots &agrave; rechercher',
...
// N //
	...
	'nb_bannieres' => 'Nombre de banni&egrave;res',
...
// V //
	...
	'voir_les_statistiques' => 'Voir les statistiques (fen&ecirc;tre popup)',
