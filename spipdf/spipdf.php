...
function spipdf_nettoyer_html($html,$params_pdf=array()) {
    ...
    if(!empty($params_pdf['float'])) {
	    ...
	    function remplaceSpan($matches) { return str_replace('img', 'img style="padding:5px;" class="pdf_img_float_'.$matches[1].'"', $matches[2]); }
    } else {
    ...
    if(!empty($params_pdf['float'])) {
	    ...
	    function remplaceDt($matches) { return str_replace('img', 'img style="padding:5px;" class="pdf_img_float_'.$matches[1].'"', $matches[2]); }
    } else {
