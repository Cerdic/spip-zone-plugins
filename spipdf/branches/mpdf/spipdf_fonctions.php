...
function spipdf_html2pdf($html, $file = false){
	...
	$possible_librairies = array(
		...
		'mpdf8' => array( // mpdf v8 ou plus charger via autoloader
			'float' => true,
			'caption' => true,
			'traite_balise_page' => true,
		),
	...
	if ($librairie_pdf=='mpdf'){ // la librairie mPDF
		...
		include_once _DIR_PLUGIN_SPIPDF.'vendor/autoload.php';

		$options = array(
			'tempDir'    => _MPDF_TEMP_PATH,
			'charset_in' => SPIPDF_CHARSET,
			'format'     => $format_page,
			//'mode' => '1',
		);
