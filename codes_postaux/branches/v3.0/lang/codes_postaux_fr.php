...
'choississez_le_fichier_a_telecharger' => 'Choississez le fichier à télécharger à partir du serveur Geonames',
	...
	// C
		...
		'codes_postaux_titre' => 'Codes postaux',
		'configuration' => 'Configuration',

'description_option_filtre' => 'Exemple : "code_departement=59" pour importer uniquement les code postaux du département Nord',
...
'importer' => 'Importer',
'importer_les_codes_postaux' => 'Importer les codes postaux',

'label_chemin_cp' => 'Dossier des données',
'label_chemin_codes_postaux_details' => 'Indiquez le chemin dans lequel les données téléchargées sont stockées.',
'liste_codes_postaux' => 'Liste des codes postaux',
