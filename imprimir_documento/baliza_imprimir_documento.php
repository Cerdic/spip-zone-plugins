...
// prepara el enlace completo
		$enlace = $javascript_centrar_imprimir."<a href=\"javascript:;\" onClick=\"centrarVentana('$url','Enviar_documento','scrollbars=yes,resizable=yes','700','470','true')\" title=\"Versión para imprimir de este documento\" border=\"0\"><img src=\"$logo\" border=\"0\" /> Versión imprimir</a>";
		return $enlace;

}

// la baliza a llamar como #ENVIAR_EMAIL** (importante los dos asteriscos para que funcione el javascript anterior de centrar la ventana por-up)
