...
#			WHERE id_syndic_article='$supprimer_lien'");
			spip_query("UPDATE spip_articles SET statut='refuse'
...
// BEGIN HACK
//
// Renvoi vers la rubrique
	if($statut=='publie')
	icone_horizontale(_T('syndicarticles:voir_rubrique'),"?exec=naviguer&id_rubrique=$id_syndic","rubrique-24.gif","");
//
// END HACK
//
...
#		ORDER BY date DESC");
		"SELECT * FROM spip_articles WHERE id_rubrique=$id_syndic
		ORDER BY date DESC");
//
// END HACK
//
...
//
// BEGIN HACK - taches de routine
//
include_spip('inc/cron_syndic_articles');
//
// END HACK
//
