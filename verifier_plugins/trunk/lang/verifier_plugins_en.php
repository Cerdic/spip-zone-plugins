...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	// B
	'bilan' => '@total@ active plugin(s) - @total_notok@ incompatible plugin(s)',
	'bilan_inactif' => '@total@ active plugin(s) - @total_notok@ incompatible plugin(s)',

	// L
	'liste_plugins' => 'List of active plugins',
	...
	// T
	'titre_verifier_plugins' => 'Check the compatibility of plugins with another version of SPIP',
