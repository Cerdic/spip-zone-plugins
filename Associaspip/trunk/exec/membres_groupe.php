...
function exec_membres_groupe_args($id_groupe, $groupe) {
	...
	echo association_navigation_raccourcis(array(
		($id_groupe<100?'les_groupes_dacces':'tous_les_groupes') => array('grille-24.png', array(($id_groupe<100?'association_autorisations':'groupes'), "id=$id_groupe" ), array(($id_groupe<100?'gerer_autorisations':'voir_groupe'), 'association') ),
		'editer_groupe' => array('edit-24.gif', array(($id_groupe<100?'edit_groupe_autorisations':'edit_groupe'), "id=$id_groupe" ), array(($id_groupe<100?'gerer_autorisations':'editer_groupe'), 'association') ),
	), $id_groupe<100?0:1);
