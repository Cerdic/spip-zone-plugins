...
$barre_menu['principal']['asuivre'] = new menuItem(
		_T('icone_a_suivre'),  // titre
		'./', 			// url
		'asuivre', // nom
		"asuivre-48.png",	// icone
		'', // condition
		''); 	// nom sous menu
$barre_menu['principal']['documents'] = new menuItem(
		_T('icone_edition_site'),  // titre
		generer_url_ecrire("naviguer"), 			// url
		'documents', // nom
		"documents-48$spip_lang_rtl.png",	// icone
		'', // condition
		'rubriques'); 	// nom sous menu
$barre_menu['principal']['redacteurs'] = new menuItem(
		_T('titre_forum'),  // titre
		generer_url_ecrire("forum_admin"), 			// url
		'redacteurs', // nom
		"messagerie-48.png",	// icone
		'', // condition
		'forum-interne'); 	// nom sous menu
$barre_menu['principal']['auteurs'] = new menuItem(
		_T('icone_auteurs'),  // titre
		generer_url_ecrire("auteurs"), 			// url
		'auteurs', // nom
		"redacteurs-48.png",	// icone
		'', // condition
		'redacteurs'); 	// nom sous menu
$barre_menu['principal']['suivi'] = new menuItem(
		_T('icone_statistiques_visites'),  // titre
		generer_url_ecrire("statistiques_visites"), 			// url
		'suivi', // nom
		"statistiques-48.png",	// icone
		'($GLOBALS["connect_statut"]=="0minirezo"  AND $GLOBALS["meta"]["activer_statistiques"]!="non")', // condition
		'statistiques'); 	// nom sous menu
$barre_menu['principal']['administration'] = new menuItem(
		_T('icone_configuration_site'),  // titre
		generer_url_ecrire("configuration"), 			// url
		'administration', // nom
		"administration-48.png",	// icone
		'($GLOBALS["connect_statut"]=="0minirezo"  AND $GLOBALS["connect_toutes_rubriques"])', // condition
		'configuration'); 	// nom sous menu

$barre_menu['principal']['nop'] = new menuItem(
		"",  // titre
		"", 			// url
		'', // nom
		"",	// icone
...
$barre_menu['principal']['vide'] = new menuItem(
		_T('icone_aide_ligne'),  // titre
		"javascript:window.open('" .
				 generer_url_ecrire("aide_index","var_lang=$spip_lang") .
				 "', 'aide_spip', 'scrollbars=yes,resizable=yes,width=740,height=580');", 			// url
		'vide', // nom
		"aide-48".aide_lang_dir($spip_lang,$spip_lang_rtl).".png",	// icone
		'', // condition
		'aide-en-ligne', // nom sous menu
		generer_url_ecrire("aide_index","var_lang=$spip_lang") ); // url sans js

$barre_menu['principal']['visiter'] = new menuItem(
		_T('icone_visiter_site'),  // titre
		$GLOBALS['meta']['adresse_site'], 			// url
		'visiter', // nom
		"visiter-48$spip_lang_rtl.png",	// icone
		'', // condition
		'visiter' ); // nom sous menu

$barre_menu['documents'][] = new menuItem(
		_T('icone_tous_articles'),  // titre
		generer_url_ecrire("articles_page"), 			// url
		'articles', // nom
		"article-24.gif",	// icone
		'$GLOBALS["connect_statut"]=="0minirezo" AND $GLOBALS["connect_toutes_rubriques"] AND spip_num_rows(spip_query("SELECT art.id_article FROM spip_articles AS art, spip_auteurs_articles AS lien WHERE lien.id_auteur = \'$connect_id_auteur\' AND art.id_article = lien.id_article LIMIT 1"))>0'); // condition
$barre_menu['documents'][] = new menuItem(
		_T('icone_breves'),  // titre
		generer_url_ecrire("breves"), 			// url
		'breves', // nom
		"breve-24.gif",	// icone
		'$GLOBALS["connect_statut"]=="0minirezo" AND $GLOBALS["connect_toutes_rubriques"] AND $GLOBALS["meta"]["activer_breves"]!="non"'); // condition
$barre_menu['documents'][] = new menuItem(
		_T('icone_mots_cles'),  // titre
		generer_url_ecrire("mots_tous"), 			// url
		'mots', // nom
		"mot-cle-24.gif",	// icone
		'$GLOBALS["connect_statut"]=="0minirezo" AND $GLOBALS["connect_toutes_rubriques"] AND $GLOBALS["options"]=="avancees" AND $GLOBALS["meta"]["articles_mots"]!="non"'); // condition
$barre_menu['documents'][] = new menuItem(
		_T('icone_sites_references'),  // titre
		generer_url_ecrire("sites_tous"), 			// url
		'sites', // nom
		"site-24.gif",	// icone
		'$GLOBALS["connect_statut"]=="0minirezo" AND $GLOBALS["connect_toutes_rubriques"] AND $GLOBALS["options"]=="avancees" AND $GLOBALS["meta"]["activer_sites"]!="non"'); // condition
$barre_menu['documents'][] = new menuItem(
		_T('icone_doc_rubrique'),  // titre
		generer_url_ecrire("documents_liste"), 			// url
		'documents', // nom
		"doc-24.gif",	// icone
		'$GLOBALS["connect_statut"]=="0minirezo" AND $GLOBALS["connect_toutes_rubriques"] AND $GLOBALS["options"]=="avancees" AND @spip_num_rows(spip_query("SELECT * FROM spip_documents_rubriques LIMIT 1")) > 0'); // condition

$barre_menu['redacteurs'][] = new menuItem(
		_T('icone_forum_administrateur'),  // titre
		generer_url_ecrire("forum_admin","admin=admin"), 			// url
		'privadm', // nom
		"forum-admin-24.gif",	// icone
		'$GLOBALS["connect_statut"]=="0minirezo" AND $GLOBALS["connect_toutes_rubriques"] AND $GLOBALS["options"]=="avancees" AND $GLOBALS["meta"]["forum_prive_admin"] == "oui"'); // condition
$barre_menu['redacteurs'][] = new menuItem(
		_T('icone_suivi_forums'),  // titre
		generer_url_ecrire("controle_forum"), 			// url
		'forum-controle', // nom
		"forum-admin-24.gif",	// icone
		'$GLOBALS["connect_statut"]=="0minirezo" AND $GLOBALS["connect_toutes_rubriques"]'); // condition
$barre_menu['redacteurs'][] = new menuItem(
		_T('icone_suivi_pettions'),  // titre
		generer_url_ecrire("controle_petition"), 			// url
		'suivi-petition', // nom
		"suivi-petition-24.gif",	// icone
		'$GLOBALS["connect_statut"]=="0minirezo" AND $GLOBALS["connect_toutes_rubriques"]'); // condition

$barre_menu['auteurs'][] = new menuItem(
		_T('icone_informations_personnelles'),  // titre
		generer_url_ecrire("auteurs_edit","id_auteur=$connect_id_auteur"), 			// url
		'perso', // nom
		"fiche-perso-24.gif",	// icone
		'$GLOBALS["connect_statut"]=="0minirezo" AND $GLOBALS["connect_toutes_rubriques"]'); // condition
$barre_menu['auteurs'][] = new menuItem(
		_T('icone_creer_nouvel_auteur'),  // titre
		generer_url_ecrire("auteur_infos","new=oui"), 			// url
		'xxx', // nom
		"auteur-24.gif",	// icone
		'$GLOBALS["connect_statut"]=="0minirezo" AND $GLOBALS["connect_toutes_rubriques"]'); // condition

$barre_menu['suivi'][] = new menuItem(
		_T('icone_repartition_visites'),  // titre
		generer_url_ecrire("statistiques_repartition"), 			// url
		'repartition', // nom
		"rubrique-24.gif",	// icone
		'$GLOBALS["connect_statut"]=="0minirezo" AND $GLOBALS["connect_toutes_rubriques"] AND $GLOBALS["meta"]["activer_statistiques"] != "non"'); // condition
$barre_menu['suivi'][] = new menuItem(
		_T('onglet_repartition_lang'),  // titre
		generer_url_ecrire("statistiques_lang"), 			// url
		'repartition-langues', // nom
		"langues-24.gif",	// icone
		'$GLOBALS["connect_statut"]=="0minirezo" AND $GLOBALS["connect_toutes_rubriques"] AND $GLOBALS["meta"]["activer_statistiques"] != "non" AND ($GLOBALS["meta"]["multi_articles"] == "oui" OR $GLOBALS["meta"]["multi_rubriques"] == "oui")'); // condition
$barre_menu['suivi'][] = new menuItem(
		_T('titre_liens_entrants'),  // titre
		generer_url_ecrire("statistiques_referers"), 			// url
		'referers', // nom
		"referers-24.gif",	// icone
		'$GLOBALS["connect_statut"]=="0minirezo" AND $GLOBALS["connect_toutes_rubriques"] AND $GLOBALS["meta"]["activer_statistiques"] != "non"'); // condition

$barre_menu['administration'][] = new menuItem(
		_T('icone_gestion_langues'),  // titre
		generer_url_ecrire("config_lang"), 			// url
		'langues', // nom
		"langues-24.gif",	// icone
		'$GLOBALS["connect_statut"]=="0minirezo" AND $GLOBALS["connect_toutes_rubriques"]'); // condition
$barre_menu['administration'][] = new menuItem(
		_T('icone_maintenance_site'),  // titre
		generer_url_ecrire("admin_tech"), 			// url
		'base', // nom
		"base-24.gif",	// icone
		'$GLOBALS["connect_statut"]=="0minirezo" AND $GLOBALS["connect_toutes_rubriques"] AND $GLOBALS["options"] == "avancees"'); // condition
$barre_menu['administration'][] = new menuItem(
		_T('onglet_vider_cache'),  // titre
		generer_url_ecrire("admin_vider"), 			// url
		'cache', // nom
		"cache-24.gif",	// icone
		'$GLOBALS["connect_statut"]=="0minirezo" AND $GLOBALS["connect_toutes_rubriques"] AND $GLOBALS["options"] == "avancees"'); // condition
$barre_menu['administration'][] = new menuItem(
		_T('icone_sauver_site'),  // titre
		generer_url_ecrire("admin_tech"), 			// url
		'base', // nom
		"base-24.gif",	// icone
		'$GLOBALS["connect_statut"]=="0minirezo" AND $GLOBALS["connect_toutes_rubriques"] AND $GLOBALS["options"] != "avancees"'); // condition
...
global $barre_onglets;
$barre_onglets['repartition'][] = new menuItem(
		_T('onglet_repartition_rubrique'),    					// titre
		generer_url_ecrire("statistiques_repartition"), // url
		"rubriques", 																		// nom
		"rubrique-24.gif",															// icone
		'($GLOBALS["meta"]["multi_articles"] == "oui" OR $GLOBALS["meta"]["multi_rubriques"] == "oui")'); // condition
$barre_onglets['repartition'][] = new menuItem(	
		_T('onglet_repartition_lang'),    					// titre
		generer_url_ecrire("statistiques_lang"), // url
		"langues", 																		// nom
...
$barre_onglets['rep_depuis'][] = new menuItem(	
		_T('icone_repartition_actuelle'),    					// titre
		generer_url_ecrire("statistiques_lang"), // url
		"popularite");
$barre_onglets['rep_depuis'][] = new menuItem(	
		_T('onglet_repartition_debut'),    					// titre
		generer_url_ecrire("statistiques_lang","critere=debut"), // url
		"debut");

$barre_onglets['stat_depuis'][] = new menuItem(	
		_T('icone_repartition_actuelle'),    					// titre
		generer_url_ecrire("statistiques_repartition"), // url
		"popularite");
$barre_onglets['stat_depuis'][] = new menuItem(	
		_T('onglet_repartition_debut'),    					// titre
		generer_url_ecrire("statistiques_repartition","critere=debut"), // url
		"debut");

$barre_onglets['stat_referers'][] = new menuItem(	
		ucfirst(_T('date_aujourdhui')),    					// titre
		generer_url_ecrire("statistiques_referers"), // url
		"jour");
$barre_onglets['stat_referers'][] = new menuItem(	
		ucfirst(_T('date_hier')),    					// titre
		generer_url_ecrire("statistiques_referers","jour=veille"), // url
		"veille");

$barre_onglets['auteur'][] = new menuItem(	
		_T('onglet_auteur'),    					// titre
		generer_url_ecrire("auteurs_edit","id_auteur=$id_auteur"), // url
		"auteur",
		"auteur-24.gif");
$barre_onglets['auteur'][] = new menuItem(	
		_T('onglet_informations_personnelles'),    					// titre
		generer_url_ecrire("auteur_infos","id_auteur=$id_auteur"), // url
		"infos",
		"fiche-perso-24.gif");

$barre_onglets['administration'][] = new menuItem(	
		_T('onglet_save_restaur_base'),    					// titre
		generer_url_ecrire("admin_tech"), // url
		"sauver",
		"base-24.gif");
$barre_onglets['administration'][] = new menuItem(	
		_T('onglet_affacer_base'),    					// titre
		generer_url_ecrire("admin_effacer"), // url
		"effacer",
		"supprimer.gif");

$barre_onglets['configuration'][] = new menuItem(	
		_T('onglet_contenu_site'),    					// titre
		generer_url_ecrire("configuration"), // url
		"contenu",
		"racine-site-24.gif");
$barre_onglets['configuration'][] = new menuItem(	
		_T('onglet_interactivite'),    					// titre
		generer_url_ecrire("config_contenu"), // url
		"interactivite",
		"forum-interne-24.gif");
$barre_onglets['configuration'][] = new menuItem(	
		_T('onglet_fonctions_avances'),    					// titre
		generer_url_ecrire("config_fonctions"), // url
		"fonctions",
		"image-24.gif");

$barre_onglets['config_lang'][] = new menuItem(	
		_T('info_langue_principale'),    					// titre
		generer_url_ecrire("config_lang"), // url
		"langues",
		"langues-24.gif");
$barre_onglets['config_lang'][] = new menuItem(	
		_T('info_multilinguisme'),    					// titre
		generer_url_ecrire("config_multilang"), // url
		"multi",
		"traductions-24.gif");
$barre_onglets['config_lang'][] = new menuItem(	
		_T('module_fichiers_langues'),    					// titre
		generer_url_ecrire("lang_raccourcis"), // url
		"fichiers",
		"traductions-24.gif",
		'($GLOBALS["meta"]["multi_articles"] == "oui" OR $GLOBALS["meta"]["multi_rubriques"] == "oui")');

$barre_onglets['suivi_forum'][] = new menuItem(	
		_T('onglet_messages_publics'),    					// titre
		generer_url_ecrire("controle_forum","page=public"), // url
		"public",
		"forum-public-24.gif");
$barre_onglets['suivi_forum'][] = new menuItem(	
		_T('onglet_messages_internes'),    					// titre
		generer_url_ecrire("controle_forum","page=interne"), // url
		"interne",
		"forum-interne-24.gif");
$barre_onglets['suivi_forum'][] = new menuItem(	
		_T('onglet_messages_vide'),    					// titre
		generer_url_ecrire("controle_forum","page=vide"), // url
		"vide",
		"",
		'$query_forum = "SELECT * FROM spip_forum WHERE statut=\'publie\' AND texte=\'\' LIMIT 1";$result_forum = spip_query($query_forum);return ($row = spip_fetch_array($result_forum);');
$barre_onglets['suivi_forum'][] = new menuItem(	
		_T('texte_statut_attente_validation'),    					// titre
		generer_url_ecrire("controle_forum","page=prop"), // url
		"prop",
		"",
		'$query_forum = "SELECT * FROM spip_forum WHERE statut=\'prop\' LIMIT 1";$result_forum = spip_query($query_forum);return ($row = spip_fetch_array($result_forum);');
...
function barre_onglets($rubrique, $onglet){
	...
	if ($barre_onglets[$rubrique])
		foreach($barre_onglets[$rubrique] as $item)
			$item->onglet($onglet);
...
if ($spip_display == "4") {
	...
	foreach($barre_menu['principal'] as $item){
	  $item->menu_niveau1($rubrique,$sous_rubrique);
	  $liste_niveau2[$item->nom] = $item->nom_sousmenu;
 	}
	...
	$decal = 0;
	foreach($barre_menu['principal'] as $rub){
		$nom=$rub->nom;
		if (isset($barre_menu[$nom])) {
			if ($rubrique == $nom) {
				$class = "visible_au_chargement";
			} else {
				$class = "invisible_au_chargement";
			}
			echo "<div class='$class' id='bandeau$nom' style='position: absolute; $spip_lang_left: ".$decal."px;'><div class='bandeau_sec'><table class='gauche'><tr>\n";

			foreach($barre_menu[$nom] as $sous_item)
				$sous_item->menu_niveau2($sous_rubrique);
			echo "</tr></table></div></div>";
		}
		$decal += largeur_icone_bandeau_principal($rub->titre);
	}
