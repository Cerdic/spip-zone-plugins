...
include_spip('inc/documents');
	...
	OR preg_match(',^\w+://,', $f)) {
		...
		$doc = sql_fetsel("documents.id_document, types.mime_type, documents.extension", "spip_documents AS documents LEFT JOIN spip_types_documents AS types ON documents.extension=types.extension",$where);
