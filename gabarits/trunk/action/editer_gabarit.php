...
function action_gabarits_set($id_gabarit) {
	...
	$c = array();
	foreach (array('objet','id_objet','statut','titre', 'texte') as $champ) {
...
function gabarits_action_insert_gabarit() {
	...
	$champs = pipeline('pre_insertion', array(
		'args' => array('table' => 'spip_gabarits'),
		'data' => $champs
	));
...
function gabarits_action_revision_gabarit($id_gabarit, $c=false) {
	...
	modifier_contenu('gabarit', $id_gabarit, array('nonvide' => array('titre' => _T('info_sans_titre'))), $c);
