...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'construire_attention_modifie' => 'Il modulo in oggetto &egrave; diverso dal modulo iniziale. Hai la possibilit&agrave; di reinizializzare il suo stato a quello precedente alle modifiche.',
	...
	'construire_aucun_champs' => 'Al momento non &egrave; presente alcun campo in questo modulo.',
	...
	'construire_position_explication' => 'Indica prima di quale altro campo sar&agrave; spostato quello corrente.',
	...
	'erreur_option_nom_unique' => 'Questo nome &egrave; gi&agrave; utilizzato da un altro campo e deve essere univoco all\'interno del modulo.',
	...
	'option_attention_explication' => 'Un messaggio pi&ugrave; importante dei una spiegazione.',
	'option_attention_label' => 'Avvertimento',
	'option_autocomplete_defaut' => 'Lascia predefinito',
	'option_autocomplete_explication' => 'Al caricamento della pagina, il tuo navigatore pu&ograve; preimpostare il campo in funzione della sua storia',
	...
	'option_choix_destinataires_explication' => 'Uno o pi&ugrave; autori tra i quali l\'utente potr&agrave; fare una scelta. Se non si seleziona niente, &egrave; l\'autore che ha installato il sito che sar&agrave; scelto.',
	'option_choix_destinataires_label' => 'Possibili destinatari',
	'option_class_label' => 'Classi CSS supplementari',
	'option_cols_explication' => 'Larghezza del blocco in numero di caratteri. Questa opzione non &egrave; sempre applicata poich&egrave; gli stili CSS la possono annullare.',
	...
	'option_disable_explication' => 'Il campo non pu&ograve; ottenere il focus.',
	...
	'option_label_explication' => 'Il titolo che sar&agrave; mostrato.',
	'option_label_label' => 'Etichetta',
	'option_maxlength_explication' => 'L\'utente non pu&ograve; digiatare pi&ugrave; caratteri del numero qui indicato.',
	'option_maxlength_label' => 'Numero massimo di caratteri',
	'option_multiple_explication' => 'L\'utente pu&ograve; selezionare pi&ugrave; valori',
	...
	'option_pliable_label_case' => 'Il gruppo di campi pu&ograve; essere chiuso.',
	'option_plie_label' => 'Gi&agrave; chiuso',
	'option_plie_label_case' => 'Se il gruppo di campi &egrave; richiudibile, sar&agrave; gi&agrave; chiuso alla visualizzazione del modulo.',
	'option_previsualisation_explication' => 'Se porte-plume &egrave; attivo, aggiungi una scheda per previsualizzare la resa del testo inserito.',
	'option_previsualisation_label' => 'Attiva la previsualizzazione',
	'option_readonly_explication' => 'Il campo pu&ograve; essere letto, selezionato, ma non modificato.',
	'option_readonly_label' => 'Sola lettura',
	'option_rows_explication' => 'Altezza del blocco in numero ri righe. Questa opzione non &egrave; sempre applicata poich&egrave; gli stili CSS del sito potrebbero annullarla.',
	'option_rows_label' => 'Numero di righe',
	'option_size_explication' => 'Larghezza del campo in numero di caratteri. Questa opzione non &egrave; sempre applicata poich%egrave; gli stili CSS del sito potrebbero annullarla.',
	'option_size_label' => 'Dimensione del campo',
	'option_type_choix_plusieurs' => 'Consenti all\'utente di scegliere <strong>pi&ugrave;</strong> destinatari.',
	'option_type_choix_tous' => 'Imposta <strong>tutti</strong> questi autori come destinatari. L\'utente non avr&agrave; alcuna scelta.',
	'option_type_choix_un' => 'Consenti all\'utente di scegliere <strong>un solo</strong> destinatario.',
	'option_type_explication' => 'In modalit&agrave; "mascherata", il contenuto del campo non sar&agrave; visibile.',
	'option_type_label' => 'Tipo del campo',
	'option_type_password' => 'Mascherato',
	'option_type_text' => 'Normale',

	// S
	'saisie_auteurs_explication' => 'Consente di selezionare uno o pi&ugrave; autori',
	...
	'saisie_destinataires_explication' => 'Consente di scegliere uno o pi&ugrave; destinatari tra gli autore selezionati.',
	...
	'saisie_fieldset_explication' => 'Un blocco che pu&ograve; contenere pi&ugrave; campi.',
	'saisie_fieldset_titre' => 'Gruppo di campi',
	'saisie_file_explication' => 'Invio di un file',
	'saisie_file_titre' => 'File',
	'saisie_hidden_explication' => 'Un campo preimpostato che l\'utente non potr&agrave; vedere.',
	'saisie_hidden_titre' => 'Campo nascosto',
	'saisie_input_explication' => 'Una semplice riga di testo, che pu&ograve; essere visibile o mascherata (password).',
	...
	'saisie_radio_explication' => 'Consente di scegliere un\'opzione tra pi&ugrave; disponibili.',
	...
	'saisie_selection_multiple_explication' => 'Consente di scegliere pi&ugrave; opzioni con un elenco.',
	'saisie_selection_multiple_titre' => 'Scelta multipla',
	'saisie_selection_titre' => 'Menu a tendina',
	'saisie_textarea_explication' => 'Un campo di testo su pi&ugrave; linee.',
