...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'option_aff_langue_label' => 'Показать текущий язык', # MODIF
	...
	'option_attention_label' => 'Примечание!', # MODIF
	...
	'option_cols_explication' => 'Длина поля в символах. С помощью CSS возможно переопределить значение данного поля.', # MODIF
	'option_cols_label' => 'Ширина',
	'option_datas_explication' => 'Укажите возможные варианты в формате: ключ|вариант', # MODIF
	'option_datas_label' => 'Список возможных вариантов', # MODIF
	...
	'option_erreur_obligatoire_explication' => 'Выводится, если поле не заполнено. Если оставить пустым - то выведется сообщение по умолчанию.',
	'option_erreur_obligatoire_label' => 'Сообщение о ошибке',
	'option_explication_explication' => 'Краткое описание (по необходимости)', # MODIF
	'option_explication_label' => 'Комментарий', # MODIF
	...
	'option_readonly_explication' => 'Поле можно просмотреть, выбрать, но изменить нельзя.', # MODIF
	'option_readonly_label' => 'Только для чтения',
	'option_rows_explication' => 'Высота поля в строках.', # MODIF
	'option_rows_label' => 'Высота', # MODIF
	'option_size_explication' => 'Длина поля в символах.', # MODIF
