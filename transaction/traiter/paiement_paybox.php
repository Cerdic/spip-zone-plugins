...
function traiter_paiement_paybox_dist($args, $retours){
	...
	$retours['message_ok'] .=  "<div class='transaction_ok paybox' style='background: url(".find_in_path('paiement/paybox/logo.png').") no-repeat top left'>"._T('transaction:traiter_message_paybox').'<p><a href="'.find_in_path("paiement/paybox/paiement.php").'"  class="valider"><span>'._T('transaction:valider_paiement').'</span></a></p></div>';
