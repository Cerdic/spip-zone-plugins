...
$GLOBALS['licence_licences'] = array (
		...
		"12" => array(
				...
				"abbr"		=> "cc0"),
		"13" => array(
				"name"		=> _T('licence:titre_publicdomain'), // nom de la licence
				"id"		=> "13", // numero d'identifiacation de la licence
				"icon"		=> "cc-publicdomain.png",
				"link"		=> _T('licence:lien_publicdomain'),
				"description" => _T('licence:description_publicdomain'),
				"abbr"		=> "public-domain"),
		"99" => array(
