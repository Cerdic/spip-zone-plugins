 ...
 * de dossier.
 * Mais il peut arriver parfois qu'on récupère des sites qui
...
function medias_reparer_documents_fichiers()
{
    ...
    if (count($docs_fichiers) > 0) {
        ...
        $docs_bdd = sql_allfetsel('id_document,fichier', 'spip_documents', 'fichier IN ('.implode(',', $url_fichiers).')');
