...
// extrait automatiquement de http://trad.spip.net/tradlang_module/skeleditor?lang_cible=de
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
  ...
  Originaldatei @source@',
	...
	'erreur_droits' => 'Fehler: Datei kann nicht angelegt werden. Überprüfen sie die Zugriffsrechte für ihr Skelett-Verzeichnis.',
	'erreur_ecrire_dans_sous_dossier' => 'In das Unterverzeichnis @dir@ kann  nicht geschrieben werden.',
	'erreur_ecriture_fichier' => 'Datei kann nicht gespeichert werden.',
	'erreur_edition_ecriture' => 'Fehler: Datei kann nicht geändert werden.',
	...
	'erreur_fichier_supprime' => 'Diese Datei wurde gelöscht, während sie an ihr gearbeitet haben. Inhalt kopieren und falls erforderlich neue Datei anlegen.',
	'erreur_ouvert_ecrit' => 'Fehler: Datei kann nicht geöffnet oder geändert werden.',
	'erreur_ouverture_fichier' => 'Fehler: Datei kann nicht geöffnet werden.',
	...
	'explications_creer_dossier_squelettes' => 'Zum EInsatz des Skelett-Editors legen sie ein Verzeichnis<b>squelettes/</b> im Wurzelverzeichnis ihrer Website an, falls es nicht bereits existiert, und ordnen sie ihm Schreibrechte zu.',
