...
// extrait automatiquement de http://trad.spip.net/tradlang_module/paquet-player?lang_cible=de
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	// P
	'player_description' => 'Dieses Plugin erlaubt, Töne und Videos auszugeben. Es stellt Flash-Player für das .mp3 Format bereit.
...
-* In ein Skelett fügt der Code  <code>#MODELE{playliste}</code> eine Abspielliste der letzten MP3-Datein ein.', # MODIF
	'player_slogan' => 'Lire des sons et des vidéos' # NEW
);
