...
function inserer_article_syndique ($data, $now_id_syndic, $statut, $url_site, $url_syndic, $resume, $documents) {
	...
	if ($n == 0 and !spip_sql_error()) {
		spip_query("INSERT INTO spip_syndic_articles (id_syndic, url_propre, url, date, statut) VALUES ('$now_id_syndic', " . spip_abstract_quote($le_lien) . ", " . spip_abstract_quote($le_lien_sale) . ", FROM_UNIXTIME(".$data['date']."), '$statut')");
		$ajout = true;
	}	
...
// https://code.spip.net/@cron_syndic
