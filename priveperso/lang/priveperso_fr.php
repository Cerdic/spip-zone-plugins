...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'action_modifier_title' => 'Modifier les param&egrave;tres de la rubrique',
	...
	'choix_rubrique' => 'Choix de la rubrique &agrave; personnaliser :',
	
	//E

	'erreur_action' => "L'action @action@ n'existe pas",
	
	//I
	'icone_creer_priveperso' => 'Cr&acute;er une nouvelle personnalisation de rubrique',
	...
	'personnaliser_espace_prive' => 'Personnaliser l\'espace priv&eacute;',
	'personnaliser_texte' => 'Personnaliser le texte des champs de saisie',
	'personnaliser_texte_interro' => 'Personnaliser le texte des champs de saisie?',
	'perso_sauvegarde' => 'Personnalisation de la rubrique sauvegard&eacute;e !',
	'pb_sauvegarde' => 'Un probl&egrave; est survenu lors de l\'&eacute;criture dans la base de donnée',
	'Prive_perso'=> 'Priv&eacute; perso',

	//R
	'racine' => 'Racine',
	'rubrique_deja_perso' => 'Rubrique d&eacute;j&agrave; personnalis&eacute;e',
	'rubrique' => 'Rubrique',
	'rubrique_inexistante' => "La rubrique @rubrique@ n'existe plus",
	//S

	//T

	//V
	'veuillez_choisir_rubrique' => 'Veuillez choisir une rubrique!'
);
?>
