...
// actijour 1.54 - 4/2008 -> todo 1.55
// by chryjs
...
'articles_crees_modifies' => 'Created/modified articles', ## 1.55
...
// C
'configuration_commune' => 'Common Configuration', 
'configuration_perso' => 'Private Configuration of: @nom@', 
'conf_nbl_art' => 'Number of lines per parts, of the array of the daily visited news.', 
'conf_nbl_aut' => 'Number of authors shown in the
					"Last connections" array.', 
'conf_nbl_mensuel' => 'Number of months shown in the array of monthly visits(gauges).', 
'conf_nbl_topgen' => 'TopTen page. Move your Topten array "General Topten" into Top-15, 20..<br />
						Fill the number of news to show.', 
...
'conf_nbl_topsem' => 'TopTen Page. Move the array "8 days Topten" into Top-15, 20..<br />
						Fill the number of news to show.', 
'conf_ordon_milieu' => 'Move the order of the center column blocks on the main page: "Today".<br />
						- news array: <b>1</b><br />
...
// O
'onglet_actijour_hier' => 'Yesterday',
'onglet_actijour_pg' => 'Today', ## m 1.55
'onglet_actijour_prev' => 'forecasts', 
'onglet_actijour_top' => 'TopTen', 
'onglet_actijour_conf' => 'Config', 
'onglet_actijour_connect' => 'Connected', ## 1.55
'onglet_connect_0minirezo' => 'Administrators', ## 1.55
'onglet_connect_1comite' => 'R&eacute;dactors', ## 1.55
'onglet_connect_6forum' => 'Visitors', ## 1.55
'onglet_connect_tous' => 'All', ## 1.55
...
//R
'repartition_visites_secteurs' => 'Visits of the day per Sectors/rubrics du jour (viewed news pages)', 

// S
's' => 's',
'signature_plugin' => '<b>Daily activity - @version@</b><br />(2004/10 - 2008/5)<br />
...
// V
'visites_jour' => 'v. day', // write short
'visites' => 'Visits',
'voir' => 'see',
'voir_details' => 'Voir d&eacute;tails', ## 1.55
'voir_plugin' => 'See page: ', 
