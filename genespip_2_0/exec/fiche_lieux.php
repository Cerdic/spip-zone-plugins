...
function exec_fiche_lieux(){
	...
	echo "<tr>",
		  ...
		  "<td>"._T('genespip:num departement')."</td>",
	...
	echo "</table><br />";
	echo "</fieldset>";
	echo "<br /><fieldset><legend>"._T('genespip:Liste des lieux')."</b></i></legend>";
	echo "<table cellpadding='3' cellspacing='0'>";
	echo "<tr>",
		  "<td><b>"._T('genespip:ville')."</b></td>",
		  "<td><b>"._T('genespip:departement')."</b></td>",
		  "<td><b>"._T('genespip:num departement')."</b></td>",
	...
	echo "<tr style='background-color:$color'>",
		  ...
		  "<td><a href='".$url_action_fiche."&action=del_lieu&id_individu=".$id_individu."&id_lieu=".$lieux['id_lieu']."'><img border='0' noborder src='"._DIR_PLUGIN_GENESPIP."img_pack/del.gif' alt='Supprimer' /></a></td>",
		  "</tr>",
	...
	if ($val==$lieux['pays']){
	$action_sql = "UPDATE spip_genespip_lieux SET pays= '".$key."' where id_lieu = ".$lieux['id_lieu'];
	...
	$drapeaun=$flag;
	  ...
	  echo "</select>";
	echo "<td colspan='4' style='border-bottom:1px solid #808080;text-align:center'><a href='".$url_action_evt."&id_lieu=".$lieux['id_lieu']."'>"._T('genespip:evenements lies')." &raquo; $compte</a></td></tr>";
