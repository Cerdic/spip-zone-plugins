...
function action_tradlang_supprimer_langue_cible_dist() {
	...
	if ($lang_cible and intval($id_tradlang_module) and autoriser('modifier', 'tradlang') and !sql_countsel('spip_tradlangs', 'id_tradlang_module = ' . intval($id_tradlang_module) . ' AND lang = ' . sql_quote($lang_cible) . ' AND statut="0K"')) {
		/**
