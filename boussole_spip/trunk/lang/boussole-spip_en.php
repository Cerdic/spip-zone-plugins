...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'descriptif_site_spip_demo' => 'DEMO.SPIP.org is a test website reset every night. In one click and without having to install it, you can test, as administrator or editor, the SPIP latest stable release.', # MODIF
	'descriptif_site_spip_doc' => 'DOC.SPIP.org is where every fonction from the SPIP source code is detailled, analysed and comment (name, place, parameters, meaning and use).', # MODIF
	'descriptif_site_spip_edgard' => 'Edgard is the faithfull and tireless companion of SPIP IRC where he shares his knowledge, with tenderness and humor. From his home, EDGARD.SPIP.org brings advices on IRC, answers and happiness. Edgard is definitely a robot (but he doesn\'t know about it...)', # MODIF
	'descriptif_site_spip_forum' => 'FORUM.SPIP.org is the place to exchange between SPIP users and get help. This site, translated in 10 languages, has four main sections : installation and update, private area usage, website administration, management and configuration, templates creation.', # MODIF
	'descriptif_site_spip_herbier' => 'SPIP herbarium is not just a link directory. No. It\'s a memory album of websites made with SPIP, at one moment of their existence. It tells a web story , the one of SPIP, since 2001. This herbarium gathers websites we wanted to show, because their content was interresting and their design were too, fonctions skilfully implemented, or just nice designs. Websites we remember, where we came back, which were some kind of references to their time in one way or another.',
	'descriptif_site_spip_info' => 'In a few pages, SPIP-INFO.net answers to whom is wondering about SPIP ability to fulfil his specific website objectives. Individuals, NGOs and companies will find useful information to make their own choice.',
	'descriptif_site_spip_irc' => 'SPIP community never sleeps ! A SPIP IRC canal is open 24/7 to everybody : http://webchat.freenode.net/?channels=#spip',
	...
	'descriptif_site_spip_party' => 'To spend some time on coding SPIP : it\'s nice. To meet users and developers in real life, with cakes and fruitjuice  (or any other beverage...) : it\'s better ! SPIP-PARTY.net provides information about past meetings (minutes, photos) and coming events (date, agenda).',
	...
	'descriptif_site_spip_programmer' => 'PROGRAMMER.SPIP.org is for developpers or webmasters who have knowledge in PHP, SQL, HTML, CSS and JavaScript. PROGRAMMER.SPIP.org shows most of the functions (APIs, overloads, pipelines,...) of SPIP with numerous coding exemples. You can download the entire website in pdf format under free licence cc-by-sa. PROGRAMMER.SPIP.org is available in French, English and Spanish.', # MODIF
	'descriptif_site_spip_sedna' => 'SEDNA.SPIP.org feed RSS on news about the SPIP Galaxy. Informations from more than 70 websites about SPIP can be consulted.', # MODIF
	...
	'slogan_site_spip_doc' => 'Technical coding reference of SPIP', # MODIF
