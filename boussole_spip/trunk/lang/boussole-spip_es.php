...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'descriptif_site_spip_demo' => 'Sitio de testeo reiniciado cada noche, DEMO.SPIP.org permite a todo el mundo probar SPIP en su última versión estable (con, según la elección, el estatus de redactor o administrador), en un click y sin tener que instalarla.', # MODIF
	'descriptif_site_spip_doc' => 'DOC.SPIP.org es el sitio de referencia donde se detalla, analiza y comenta (nombre, emplazamiento, argumentos, rol y uso) cada una de las funciones del código fuente de SPIP.', # MODIF
	...
	'descriptif_site_spip_programmer' => 'Especialmente destinado a un público de desarrolladores o webmasters teniendo ya conocimientos de PHP, SQL, HTML, CSS y JavaScript, PROGRAMMER.SPIP.org presenta la mayor parte de las funcionalidades (APIs, sobrecargas, segmentaciones...) de SPIP mediante numerosos ejemplos de código. El sitio ofrece como descarga la integridad de su contenido en formato pdf bajo licencia libre cc-by-sa. PROGRAMMER.SPIP.org puede consultarse en francés, inglés y español. ', # MODIF
	'descriptif_site_spip_sedna' => 'SEDNA.SPIP.org es el agregador RSS para toda la actualidad de la galaxia SPIP. Las últimas informaciones de más de 70 sitios girando en torno a SPIP pueden consultarse asimismo.', # MODIF
	...
	'slogan_site_spip_doc' => 'La referencia técnica del código de SPIP', # MODIF
