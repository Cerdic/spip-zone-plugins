...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'descriptif_site_spip_core' => 'Le site CORE.SPIP.net rassemble l’historique des modifications du code de SPIP, une gestion de tickets permettant de signaler des bugs et de proposer des suggestions d’amélioration et un espace de téléchargement des versions de SPIP.',
	...
	'descriptif_site_spip_party' => 'Passer son temps entre un clavier et un écran pour coder du SPIP : c’est bien. Se rencontrer entre développeurs et utilisateurs dans la vraie vie, en chair et en os, autour d’un gâteau et d’un jus de fruit (ou autre boisson...) : c’est beaucoup mieux. SPIP-PARTY.net est le site qui recense toutes ces rencontres : passées (compte-rendus, photos) et à venir (calendrier, agenda).',
	...
	'descriptif_site_spip_plugincode' => 'CODE.PLUGINS.SPIP.net est un espace de documentation des plugins SPIP pour leurs APIs, leur code source, et certains de leurs fonctionnements techniques. Ce site est généré automatiquement à partir du PHPDoc inclus dans le code des plugins.',
	...
	'descriptif_site_spip_syntaxe' => 'SPIP Syntaxe propose une seule page avec le formulaire d’édition de SPIP en accès libre pour tester tous les raccourcis typographiques et visualiser immédiatement le rendu.',
	...
	'nom_site_spip_plugincode' => 'Code des Plugins',
	'nom_site_spip_programmer' => 'Programmer SPIP',
	'nom_site_spip_sedna' => 'Sedna',
	'nom_site_spip_syntaxe' => 'SPIP Syntaxe',
	...
	'slogan_site_spip_plugincode' => 'La documentation du code des plugins',
	'slogan_site_spip_programmer' => 'La documentation des développeurs SPIP',
	'slogan_site_spip_sedna' => 'Le flux RSS de la galaxie SPIP',
	'slogan_site_spip_syntaxe' => 'Tester l’édition de texte dans SPIP',
