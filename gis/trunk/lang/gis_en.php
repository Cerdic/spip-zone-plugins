...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'cfg_inf_adresse' => 'Displays additional address fields (country, city, state, address ...)', # MODIF
	'cfg_inf_cloudmade' => 'This API needs a key you can create on <a href=\'@url@\'>the CloudMade website</a>.', # MODIF
	'cfg_inf_geocoder' => 'Enable geocoder functions in forms (search from an address, recovery of the address from the coordinates).', # MODIF
	'cfg_inf_geolocaliser_user_html5' => 'If the user\'s browser allows it, its approximate geographic location is retrieved to give the default position when creating a new point.', # MODIF
	...
	'cfg_lbl_api_key_cloudmade' => 'CloudMade API key', # MODIF
	'cfg_lbl_api_key_google' => 'GoogleMaps API key', # MODIF
	'cfg_lbl_api_key_yandex' => 'Yandex API key', # MODIF
	...
	'cfg_lbl_geolocaliser_user_html5' => 'At the creation step, center the map on the location of the user', # MODIF
	...
	'editer_gis_explication' => 'This page lists the whole location-based points of the website.', # MODIF
	'editer_gis_nouveau' => 'Create a new point', # MODIF
	'editer_gis_titre' => 'The location-based points', # MODIF
	'erreur_recherche_pas_resultats' => 'No point corresponds to the searched text.', # MODIF
	...
	// F
	'formulaire_creer_gis' => 'Create a new location-based point :', # MODIF
	'formulaire_modifier_gis' => 'Modify the location-based point :', # MODIF
	...
	// I
	'icone_gis_tous' => 'Location-based points', # MODIF
	...
	'info_numero_gis' => 'Point number', # MODIF
	'info_objet' => 'Object',
	'info_recherche_gis_zero' => 'No result for « @cherche_gis@ ».',
	'info_supprimer_lien' => 'Unlink', # MODIF
	'info_supprimer_liens' => 'Unlink all the points', # MODIF
