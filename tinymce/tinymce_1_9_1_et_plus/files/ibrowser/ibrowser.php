...
// ============================================================
	function init() {
		...
		//ajout ACTi pour ajouter les styles de tinyMCE à iBrowser
		var t;
		if (t!=undefined) {
			var csses = t.getCSSClasses('mce_editor_0');
			var selectElm = document.getElementById('pr_class');
			if (csses && selectElm)	{
...
<form id="iBrowser" name="iBrowser" method="post" action="scripts/rfiles.php<?php echo '?library='.$_GET['library'].'&lang='.$_GET['lang']; ?>" enctype="multipart/form-data" target="inSelFrame">
                ...
                <div class="colLeft">
                  <div style="float: left;">
                    ...
                    <div class="rowDiv">
                      ...
                      <div id="inSelDiv">
                        <iframe name="inSelFrame" id="inSelFrame" src="scripts/rfiles.php?clib=<?php echo $clib; ?><?php echo '&library='.$_GET['library'].'&lang='.$_GET['lang']; ?>" style="width: 100%; height: 100%px;" scrolling="no" marginheight="0" marginwidth="0" frameborder="0"></iframe>
                      </div>
                    </div>
                  </div>
                </div>
