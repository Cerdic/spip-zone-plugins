...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'erreur_501_serveur_nok_message'    => 'Vous avez essayé d\'utiliser l\'API SVP sur un serveur qui n\'est pas correctement configuré pour cela. En effet, le serveur concerné est configuré en mode « SVP runtime » ce qui est incompatible avec le service REST SVP.',
