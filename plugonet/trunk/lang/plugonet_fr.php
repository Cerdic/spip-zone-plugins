...
// Fichier source, a modifier dans https://git.spip.net/spip-contrib-extensions/plugonet.git
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	// D
	'details_generation_paquetxml_erreur' => 'Le paquet.xml du plugin n’a pas été généré car des erreurs se sont produites pendant la génération. Veuillez consulter les informations ci-dessous pour apporter les corrections nécessaires.',
	'details_generation_paquetxml_erreur_pluriel' => 'Les paquet.xml des @nb@ plugins n’ont pas été générés car des erreurs se sont produites pendant la génération. Veuillez consulter les informations ci-dessous pour apporter les corrections nécessaires.',
	'details_generation_paquetxml_notice' => 'Le paquet.xml du plugin a été correctement généré mais son plugin.xml source contient des erreurs. Veuillez donc vérifier le plugin.xml et les fichiers résultant (paquet.xml, fichiers de langue) pour déterminer si des corrections doivent être apportées.',
	...
	'details_generation_paquetxml_succes' => 'Le paquet.xml du plugin a été correctement généré.',
	'details_generation_paquetxml_succes_pluriel' => 'Les paquet.xml des @nb@ plugins ont été correctement générés.',
	'details_validation_paquetxml_erreur' => 'La validation formelle du paquet.xml a révélé des erreurs. Veuillez consulter les informations ci-dessous pour apporter les corrections.',
	'details_validation_paquetxml_erreur_pluriel' => 'La validation formelle des @nb@ paquet.xml a révélé des erreurs. Veuillez consulter les informations ci-dessous pour apporter des corrections.',
	'details_validation_paquetxml_succes' => 'La validation formelle du paquet.xml n’a révélé aucune erreur.',
	'details_validation_paquetxml_succes_pluriel' => 'La validation formelle des @nb@ paquet.xml n’a révélé aucune erreur.',
	'details_verification_pluginxml_erreur' => 'La vérification du plugin.xml a révélé des erreurs. Veuillez consulter les informations ci-dessous pour apporter des corrections si besoin (toutes les erreurs liées à l’utilisation de balise a, code, br... dans la description ne sont pas à considérer).',
	'details_verification_pluginxml_erreur_pluriel' => 'La vérification des @nb@ plugin.xml a révélé des erreurs. Veuillez consulter les informations ci-dessous pour apporter des corrections si besoin (toutes les erreurs liées à l’utilisation de balise a, code, br... dans la description ne sont pas à considérer).',
	'details_verification_pluginxml_succes' => 'La vérification du plugin.xml n’a révélé aucune erreur.',
	'details_verification_pluginxml_succes_pluriel' => 'La vérification des @nb@ plugin.xml n’a révélé aucune erreur.',
	...
	'index_aide_paqxmlexe' => 'Exemples de paquet.xml',
	'index_aide_paqxmlfoi' => 'Les fonctions, options et administrations',
	'index_aide_paqxmlgen' => 'Le fichier de description d’un plugin : <code>paquet.xml</code>',
	'index_aide_paqxmlgenie' => 'La balise <code>genie</code>',
	...
	'index_aide_paqxmlscript' => 'Les balises <code>script</code> et <code>style</code>',
	...
	'info_paquet_existant' => 'paquet.xml existant',
