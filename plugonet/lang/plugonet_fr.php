...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'details_validation_paquetxml_erreur' => 'La validation formelle du paquet.xml listé ci-dessous a révélé des erreurs. Veuillez consulter les informations ci-dessous pour apporter les corrections.',
	'details_validation_paquetxml_erreur_pluriel' => 'La validation formelle des @nb@ paquet.xml listés ci-dessous a révélé des erreurs. Veuillez consulter les informations ci-dessous pour apporter des corrections.',
	'details_validation_paquetxml_succes' => 'La validation formelle du paquet.xml listé ci-après n\'a révélé aucune erreur.',
	'details_validation_paquetxml_succes_pluriel' => 'La validation formelle des @nb@ paquet.xml listés ci-après n\'a révélé aucune erreur.',
