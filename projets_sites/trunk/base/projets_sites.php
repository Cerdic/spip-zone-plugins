...
function projets_sites_declarer_tables_objets_sql($tables) {
	...
	$tables['spip_projets_sites'] = array(
		'type' => 'projets_site',
		'principale' => "oui",
		'table_objet_surnoms' => array('projetssite'),
		// table_objet('projets_site') => 'projets_sites'
		'field' => array(
			...
			"logiciel_charset" => "varchar(25) DEFAULT '' NOT NULL",
			"auteurs_admin" => "text DEFAULT '' NOT NULL",
			"auteurs_webmestres" => "text DEFAULT '' NOT NULL",
			"fo_url" => "varchar(255) NOT NULL DEFAULT ''",
			"fo_login" => "varchar(255) NOT NULL DEFAULT ''",
			"fo_password" => "tinytext NOT NULL DEFAULT ''",
			"bo_url" => "varchar(255) NOT NULL DEFAULT ''",
			"bo_login" => "varchar(255) NOT NULL DEFAULT ''",
			"bo_password" => "tinytext NOT NULL DEFAULT ''",
			...
			"sas_port" => "varchar(5) NOT NULL DEFAULT ''",
			"sas_protocole" => "varchar(50) NOT NULL DEFAULT ''",
			"sas_login" => "varchar(255) NOT NULL DEFAULT ''",
			"sas_password" => "tinytext NOT NULL DEFAULT ''",
			...
			"sgbd_gestion" => "varchar(255) NOT NULL DEFAULT ''",
			"sgbd_nom" => "varchar(50) NOT NULL DEFAULT ''",
			"sgbd_prefixe" => "varchar(25) NOT NULL DEFAULT ''",
			"sgbd_charset" => "tinytext NOT NULL DEFAULT ''",
			"sgbd_collation" => "tinytext NOT NULL DEFAULT ''",
			"sgbd_login" => "varchar(255) NOT NULL DEFAULT ''",
			"sgbd_password" => "tinytext NOT NULL DEFAULT ''",
			...
			"php_timezone" => "tinytext DEFAULT '' NOT NULL",
