...
jQuery(document).ready(function(){
	...
	jQuery('#formulaire_courrier_edit').submit(function(){
		...
		// c'est le bouton de previsu qui valide
			var data = jQuery('input['+jqss+'name=titre],input['+jqss+'name=avec_intro],input['+jqss+'name=avec_patron],input['+jqss+'name=id_courrier],input['+jqss+'type=checkbox]['+jqss+'checked],input['+jqss+'type=radio]['+jqss+'checked],select,textarea',this).serialize();
