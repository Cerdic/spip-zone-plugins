<?php
	...
	$GLOBALS[$GLOBALS['idx_lang']] = array(
		...
		'facteur_filtres_descriptif' => "Des filtres peuvent &ecirc;tre appliqu&eacute;s aux notifications au moment de l'envoi.",
		'facteur_filtre_images' => "Embarquer les images r&eacute;f&eacute;renc&eacute;es dans les notifications",
		...
		'note_test_configuration' => "Une notification sera envoy&eacute;e &agrave; l'adresse d'envoi d&eacute;finie (ou celle du webmaster).",
		'notification_de_test' => "Notification de test accentué",  // Laisser tel quel, car 
		'version_html' => "Version HTML.",
		'version_texte' => "Version texte.",
		'tester' => "Tester",
		'erreur' => "Erreur",
		'notification_envoyee' => "Notification envoy&eacute;e !",
