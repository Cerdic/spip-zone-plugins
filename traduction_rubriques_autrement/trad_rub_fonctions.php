...
function destination_traduction($lang,$id_trad){
	...
	if($id_trad_parent['id_trad']){
		...
		if($id_trad=sql_getfetsel('id_trad','spip_rubriques','id_trad='.$id_trad_parent['id_parent'].' AND lang="'.$lang.'"'))
			$trads = sql_getfetsel('id_rubrique','spip_rubriques','id_trad='.$id_trad.' AND lang="'.$lang.'"');	
		}
