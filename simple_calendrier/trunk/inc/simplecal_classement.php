...
function simplecal_get_liste_annees($id_rubrique){
    ...
    */
    ...
    // Pour le calcul des années invisibles (ex : du xx/yy/2009 au xx/yy/2011 => 2010 invisible
...
function simplecal_get_liste_mois($annee, $id_rubrique){
    ...
    foreach ($liste_m3 as $row){
        ...
        for ($a = $a1; $a<=$a2; $a++){
            // On ne traite que l'année concernée
            if ($a == $annee){
                
                // Années identiques => Les mois de m1 à m2
                if ($a1 == $a2){
                    for ($m = $m1 ; $m<=$m2 ; $m++){
                        $m < 10 ? $s="0$m":$s="$m"; 
                ...
                // Années différentes => Les mois de a1 (de m1 à decembre)
                if ($a1 != $a2 and $a1 == $a){
                    for ($m = $m1 ; $m<=12 ; $m++){
                        $m < 10 ? $s="0$m":$s="$m"; 
                        if (!in_array($s, $tab_mois)){
                ...
                // Années différentes => Les mois de a2 (de janvier à m2)
                if ($a1 != $a2 and $a2 == $a){
                    for ($m = 1 ; $m<=$m2 ; $m++){
                        $m < 10 ? $s="0$m":$s="$m"; 
                        if (!in_array($s, $tab_mois)){
                ...
                // Années différentes => Les mois de l'année invisible (de janvier à decembre)
