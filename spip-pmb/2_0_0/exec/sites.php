	...
	$onglet_contenu =
		...
		. (($syndication == "oui" OR $syndication == "off" OR $syndication == "sus") ?
		  ...
		  .	http_img_pack('feed.png', 'RSS').	'</a>'._T('info_site_syndique').'</p>'
			...
			. afficher_objets('syndic_article',_T('titre_articles_syndiques'). " PMB", array('FROM' => 'spip_syndic_articles_pmb', 'WHERE' => "id_syndic=$id_syndic", 'ORDER BY' => "date DESC"), $id_syndic)
