...
function devdebug_charger_debug(){
	...
	if(_DEVDEBUG_MODE==1){
		// Les liens d'erreur gŽnŽrŽs par PHP renvoient ... en local ! dans le php.ini standard
		// On les dŽfinit du type 'http://fr.php.net/manual/en/ %s .php' (nŽcessite une connexion)
		@ini_set('docref_root', "http://fr.php.net/manual/en/");
		@ini_set('docref_ext', '.php');
		// On lance le php error tracking quoiqu'il arrive
		@ini_set('track_errors',1);
		// On Žvite d'afficher les erreurs rŽpŽtŽes
		@ini_set('ignore_repeated_errors',1);
		// Compatibilite PHP (recup de 'inc_version', mais qui le dŽfinit trop tard)
