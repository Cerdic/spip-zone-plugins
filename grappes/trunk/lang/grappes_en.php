...
// extrait automatiquement de https://trad.spip.net/tradlang_module/grappes?lang_cible=en
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'autoriser_associer_non' => 'You are not authorized to perform this action.', # MODIF
	...
	'info_changer_nom_grappe' => 'Change the name of the bunch', # MODIF
	'info_creation_grappes' => 'Create or modify elements bunches', # MODIF
	'info_grappes_association' => 'What kind of objects can be linked to the bunch?', # MODIF
	'info_nom_grappe' => 'Name of the bunch', # MODIF
	'info_qui_peut_lier' => 'Who can link objects to the bunch?', # MODIF
