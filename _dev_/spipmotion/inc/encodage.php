...
{
	  return encodage($sources, $file, $type, $id, $id_document, $actifs);
}

function encodage($sources, $file, $type_lien, $id_lien, $id_document, &$documents_actifs){
		
	$dir_ftp = determine_upload();
	spip_log ("encodage de la video $dir_ftp$file  (T '$type_lien' L '$id_lien' D '$id_document')");
