...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'info_installer_encoder_ftp' => 'En tant qu\'administrateur, vous pouvez installer (par FTP) des fichiers de type .AVI, .MPG, .MP4 dans le dossier @upload@ pour ensuite les encoder au format flv ici.',
	'info_installer_ftp' => 'En tant qu\'administrateur, vous pouvez installer (par FTP) des fichiers de type .FLV dans le dossier @upload@ pour ensuite les ins&eacute;rer dans vos articles ici.',
