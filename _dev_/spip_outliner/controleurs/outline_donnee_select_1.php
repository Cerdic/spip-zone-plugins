...
function controleurs_outline_donnee_select_1_dist($regs) {
	...
	// retirer les span label and co
	$html = preg_replace(",(<div[^>]*spip_form_champ[^>]*>).*(<select[^>]*>.*</select>).*(</div>),Uims","\\1 \\2 \\3",$html);
