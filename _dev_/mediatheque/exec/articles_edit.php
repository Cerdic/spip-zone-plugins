...
function articles_edit($id_article, $id_rubrique,$lier_trad,  $id_version, $new, $config_fonc)
{
	...
	if (!$new){
		...
		// ---------------------------------------------
		//		insertion (temporaire) pour mediatheque
		// ---------------------------------------------
		// Acces phototeque
		print "<div class='cadre-info'><p class='verdana2'><strong>Phototh&egrave;que</strong></p><ul class='verdana1'>";
		print "<li><a href=\"#\" 
		onclick=\"window.open('?exec=image_add&amp;id_article=$id_article&amp;set_wysiwyg=$set_wysiwyg', 'toto', 'resizable=yes,scrollbars=yes, width=650, height=600');return false;\">
		Ajouter une image</a>";
				
		print "<li><a href=\"#\" 
		onclick=\"window.open('?exec=image_insert&amp;id_article=$id_article&amp;set_wysiwyg=$set_wysiwyg', 'toto', 'resizable=yes,scrollbars=yes, width=650, height=600');return false;\">
		Ins&eacute;rer une image</a>";
		
		print "<li><a href=\"?exec=mediatheque_img_browser\">G&eacute;rer la photot&egrave;que</a>";
		print "</li></ul></div>";
		...
		// Acces documentheque		
		print "<br/>";
		print "<div class='cadre-info'><p class='verdana2'><strong>Documenth&egrave;que</strong></p><ul class='verdana1'>";
		print "<li><a href=\"?exec=doc_add\">Ajouter un document</a>";
		print "<li><a href=\"?exec=doc_insert\">Ins&eacute;rer un document</a></li></ul></div>";
