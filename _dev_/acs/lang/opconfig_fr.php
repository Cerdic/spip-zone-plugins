...
// Override du fichier éponyme pour le plugin openPublishing (si installé)
// Override the same named file from openPublishing plugin (if installed)

$GLOBALS[$GLOBALS['idx_lang']] = array(

// A
'ajouter_agenda' => 'Ajouter à l\'agenda',
...
'agenda_explique2' => 'Pour annoncer un évènement, précisez bien la date et l\'heure.',
...
'configurer_op' => 'Configurer ACS-openPublishing',
...
// E
'explication_agenda' => 'Sinon, la date de publication sera celle d\'aujourd\'hui et votre évènement ne sera pas annoncé à la bonne date/heure dans l\'agenda.',
...
// O
'op_config' => 'Configuration du plugin openPublishing intégré à ACS',
'op_info' => 'infos &agrave; propos de la configuration du plugin openPublishing',
'configure_op' => 'Configurer le plugin openPublishing',
'op_voir_info' => '<b>Configuration actuelle de l\'openPublishing ACS:</b>',
