...
function convert_to_html($in) {
	...
	*/
	...
	$in = str_replace('é', '&eacute;', $in);
	$in = str_replace('è', '&egrave;', $in);
	$in = str_replace('à', '&agrave;', $in);
	$in = str_replace('ê', '&ecirc;', $in);
	$in = str_replace('î', '&icirc;', $in);
	$in = str_replace('ï', '&iuml;', $in);
	$in = str_replace('Î', '&Icirc;', $in);
	$in = str_replace('É', '&Eacute;', $in);
	$in = str_replace('ç', '&ccedil;', $in);
	$in = str_replace('ô', '&ocirc;', $in);
	$in = str_replace('ë', '&euml;', $in); 
	return $in;
