...
//			'csv2spip' => 'csv2spip',
			...
			'titre_choix_fichier' => 'Fichier CSV à importer : ',
			'choix_fichier' => 'Choix du fichier CSV : ',
			'options_maj' => 'Options de mise à jour : ',
			'maj_mdp' => 'Mise à jour des mots de passe des rédacteurs existants :',
			'suppr_redac' => 'Suppression des rédacteurs qui ne sont pas dans le fichier CSV importé :',
			'help_suppr_redac' => 'Pas de suppression automatique des administrateurs de rubriques !<br>
												    (pour IACA, cela correspond à une "bascule année" pour les élèves d\'un établissement)',
			...
			'nom_rubrique_archive' => 'Nom de la rubrique pour l\'archivage : ',
			'choix_parent_archive' => 'Choix de la rubrique parent de la rubrique d\'archivage :',
			...
			'attribuer_articles' => 'supprimer les auteurs et attribuer les articles à l\'auteur',
			'passe_egale_login' => '(mot de passe idem login)',
			'creation_rubriques' => 'Création des rubriques pour les sous-groupes administrateurs (PROFS) : ',
			'rubrique_ss_groupes' => 'Créer une rubrique pour chaque sous-groupe d\'administrateurs (disciplines) :',
			'profs_admins' => '(les profs d\'une discipline seront administrateurs de leur rubrique)',
			'article_rubrique' => 'Créer un article dans chaque rubrique pour les rendre visibles :',
			'choix_parent_rubriques' => 'Choix de la rubrique parent des rubriques à créer :',
			'nom_groupe_admin' => 'Groupe des administrateurs de rubrique : ',
			'help_nom_groupe_admin' => '(si ce champ est vide, tous les utilisateurs seront simples rédacteurs)',
			'lancer' => 'Lancer la moulinette',
			
			'titre_help' => 'Caractéristiques du fichier .CSV à envoyer:'
