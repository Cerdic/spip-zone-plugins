...
// Google map KEY	
    ...
    if ($google_key=="") { 
		...
		echo '<br/>';
		echo '<label>Google AJAX Search API Key <a href="http://code.google.com/apis/ajaxsearch/signup.html" target="_blank" >'._T('googleajaxsearch:getkey').'</a></label> <input type="text" name="key" value="'.$google_key.'" size="30" />';
