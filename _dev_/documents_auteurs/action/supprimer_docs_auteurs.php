...
function action_supprimer_docs_auteurs_dist() {

	$securiser_action = charger_fonction('securiser_action', 'inc');
	$arg = $securiser_action();

	preg_match('/^(\w+)\W(.*)$/', $arg, $r);
	$var_nom = 'action_supprimer_docs_auteurs_' . $r[1];
...
function action_supprimer_docs_auteurs_document($arg) {
	global $redirect;
...
function action_supprimer_docs_auteurs_rubrique($id_rubrique)
{
