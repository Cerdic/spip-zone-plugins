...
function inc_joindre_auteurs_dist($script, $args, $id=0, $intitule='', $mode='', $type='', $ancre='', $id_document=0,$iframe_script='') {
  ...
  if($iframe_script)
	...
	return generer_action_auteur('joindre_auteurs',
...
function texte_upload_manuel_docs_auteurs($dir, $inclus = '', $mode = 'document') {
...
function afficher_transferer_upload_docs_auteurs($texte_upload, $dir)
{
