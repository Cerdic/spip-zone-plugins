...
function IntertitresTdm_table_des_matieres($texte,$tableseule=false) {
  ...
  $table = "\n<a name=\"table_des_matières\"></a><div id=\"tablematiere\">\n<ul>";
  $lastlevel = 1;
  $cite[''] = '';
  ...
  // si tableseule alors le $ref correspond au contenu du <a name=''></a>... Je sais pas si ça marche: pas testé ! :o)
	if ($tableseule) {
		preg_match(
			"/(<a name=')(.*?)('><\/a>)/",
			$matches[3+$ajout][$j],
...
// avant propre, convertir à la volée les intertitres d'enluminures
