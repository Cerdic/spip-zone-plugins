<?php
	...
	$GLOBALS[$GLOBALS['idx_lang']] = array(
		...
		'aucun_theme_disponible' => "Nenhum tema disponível atualmente",
		'champs_obligatoires_erreur' => "Certos campos obrigatórios (*) não foram corretamente preenchidos",
		'champs_obligatoires' => "Campos obrigatórios",
		'email' => "E-mail",
		'nom' => "Nome",
		'format' => "Formato",
		'format_html' => "HTML",
