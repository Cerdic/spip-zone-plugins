<?php
	...
	$GLOBALS[$GLOBALS['idx_lang']] = array(
		...
		'utiliser_cette_date_pour_programmer_envoi' => "Utiliser cette date pour programmer l'envoi de la lettre",
		'auteurs' => "AUTEURS",
		...
		'tester' => "Tester (envoi aux auteurs)",
		'envoyer' => "Envoyer",
		'supprimer' => "Supprimer",
		'arreter_envoi' => "Arrêter l'envoi",
		'envoi_termine' => "Envoi terminé !",
		'les_abonnes_suivants_recevront_cette_lettre' => "Les abonnés suivants recevront cette lettre (affichage des 100 derniers)",
		'les_abonnes_suivants_ont_recu_cette_lettre' => "Les abonnés suivant ont reçu cette lettre (affichage des 100 derniers)",
		...
		'tous_abonnes_rubrique' => "Tous les abonnés de cette rubrique (affichage des 100 derniers)",
		'en_cours_redaciton' => "en cours de rédaction",
		'envoi_en_cours' => "envoi en cours",
		'envoyees' => "envoyees",
		'total_minuscules' => "total",
		'lettres_trouvees' => "Lettres trouvées",
		'abonnes_trouves' => "Abonnés trouvés (affichage des 100 derniers)",
		'lettres_trouvees_dans_texte' => "Lettres trouvées (dans le texte)",
		...
		'copier_cetter_lettre' => "Copier cette lettre",
		'copie' => "Copie",
		'articles' => "ARTICLES",
