...
function exec_sites_dist()
{
	...
	if ($syndication == "oui" OR $syndication == "off" OR $syndication == "sus") {
		...
		echo afficher_syndic_articles(_T('titre_articles_syndiques'). " PMB", array('FROM' => 'spip_syndic_articles_pmb', 'WHERE' => "id_syndic=$id_syndic", 'ORDER BY' => "date DESC"), $id_syndic);
