...
debut_droite();
 ...
 echo afficher_sites('<b>' . _T('titre_sites_syndiques') . ' PMB</b>', array('FROM' => 'spip_syndic', 'WHERE' => "(syndication='oui' OR syndication='sus') AND statut='publie' AND id_syndic IN (select id_syndic from spip_syndic_articles_pmb)", 'ORDER BY' => "nom_site"));
...
echo afficher_syndic_articles('<b>' . _T('titre_dernier_article_syndique') . '</b>', array('FROM' => 'spip_syndic_articles_pmb', 'ORDER BY' => "date DESC",  'LIMIT' => "50"));
