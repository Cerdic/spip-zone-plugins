...
function revision_auteur($id_auteur, $c=false) {
	...
	modifier_contenu('auteur', $id_auteur,
		array(
			'champs' => array('nom', 'bio', 'nom_famille', 'prenom', 'adresse', 'codepostal', 'ville', 'pays', 'latitude', 'longitude', 'url_organisation', 'organisation', 'telephone', 'fax', 'pgp', 'nom_site', 'lien_site', 'email', 'url_propre'),
