...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	// A
	'alerte_publie_contenant' => '<MODIF>Be careful, this content is published, but contains links to other contents that are not!',
	...
	// C
	'confirmation_depublication' => '<MODIF>Be careful, a published content contains at least one link to this one and will be affected if you change its status!\\n\\nDo you still want to change the status?',
	'confirmation_publication' => '<MODIF>Be careful, this content links to at least one other content that is not yet published!\\n\\nDo you still want to change the status?',
	'confirmation_suppression' => '<MODIF>Be careful, a published content contains at least one link to this one and will be affected if you delete it!\\n\\nDo you still want to delete it?',
