...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	// M
	'maintenance' => 'N\'oubliez pas d\'enlever<br />"Fermeture pour maintenance",<br />sur les Forums concern&eacute;s.',
...
Les mots de moins de trois lettres sont ignor&eacute;s.',
	...
	'reglement' => '<p>Les administrateurs et mod&eacute;rateurs de ce forum s\'efforceront de supprimer ou &eacute;diter tous les messages &agrave; caract&eacute;re r&eacute;pr&eacute;hensible aussi rapidement que possible. Toutefois, il leur est impossible de passer en revue tous les messages. Vous admettez donc que tous les messages post&eacute;s sur ces forums expriment la vue et opinion de leurs auteurs respectifs, et non pas des administrateurs, ou mod&eacute;rateurs, ou webmestres (except&eacute; les messages post&eacute;s par eux-m&ecirc;me) et par cons&eacute;quent ne peuvent pas &ecirc;tre tenus pour responsables.</p>
