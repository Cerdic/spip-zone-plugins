...
'admin_ban_ip_info' => 'To write more than one IP or server names, separate them using commas. To specify IP intervals, separate the bign and the end with a dash -, to specify a joker use a star *',
'admin_ban_ip_none' => 'No banned address',
'admin_ban_user' => 'Banned logins admin',
'admin_ban_user_info' => 'You can ban more than one user at a time using CTRL or UP combined with the mouse or the keybard',
...
'admin_spip_forums_erreur' => '<b>Error: You must enable SPIP public forums.</b>',
...
'admin_unban_email_info' => 'You can unban many addresses at a time using combined CTRL and UP with mouse or keyboard',
'admin_unban_ip_info' => 'You can unban many addresses at a time using combined CTRL and UP with mouse or keyboard',
'admin_unban_user_info' => 'You can unban many users at a time using combined CTRL and UP with mouse or keyboard',
'admin_valeur' => 'Value',

'aecrit' => 'wrote:',
'alerter_abus' => 'Signaler ce message comme abusif/injurieux...', ## GAF 0.5
'alerter_sujet' => 'Post reported abusive', ## GAF 0.5
'alerter_texte' => 'Please take a look to this post:', ## GAF 0.5
...
'bouton_unselect_all' => 'Unselect all',
...
'creer_forum' => 'Create a new Forum', ## GAF 0.6

//D
'dans_forum' => 'in the forum',
'deconnexion_' => 'Logout ',
'deplacer' => 'Move', ## deplacer.html
...
'dernier' => '&nbsp;Last' , # exec/spipbb_admin.php ##Â GAF 0.6
'dernier_membre' => 'Last registered member: ',
'derniers_messages' => 'Last topics',
'diviser' => 'Split', ## diviser.html
...
'en_rep_sujet_' => '&nbsp;:::&nbsp;Topic : ',
'etplus' => '...and more...', ## GAF 0.6
'extra_avatar_saisie_url' => 'Your avatar\'s URL (http://... ...)', ## GAF 0.6
'extra_avatar_saisie_url_info' => 'Visitor\'s avatar URL', ## GAF 0.6
...
'extra_refus_suivi_thread' => '(don\'t follow). Do not modify!', ## GAF 0.6
'extra_refus_suivi_thread_info' => 'Threads you want not to follow any more',
'extra_signature_saisie_texte' => 'Fill your signature here', ## GAF 0.6+
'extra_signature_saisie_texte_info' => 'Short signature',
'extra_visible_annuaire' => 'Appear in the (public) members\' list', ## GAF 0.6
...
'fil_deplace' => 'Move this thread', ## inc/spipbb_presentation.php ## GAF 0.6
'filtrer' => 'Filter',
'forum' => 'Forums',
'forum_annonce_annonce' => 'Mark as announce', ## inc/spipbb_presentation.php
'forum_annonce_desannonce' => 'Remove the announce mark', ## inc/spipbb_presentation.php
'forum_dpt' => 'Forum&nbsp;: ',
'forum_ferme' => 'This forum is disabled',
'forum_ferme_texte' => 'This forum is disabled. You cannot post to it anymore.',
'forum_maintenance' => 'This forum is close for maintenance', ## GAF 0.6
'forum_ouvrir' => 'Open this Forum', ##Â exec/spipbb_admin.php ## GAF 0.6
...
//H
'haut_page' =>  'Top of page', ## GAF 0.6

//I

'icone_ferme' => 'Close', ##Â GAF 0.6
...
'info' => 'Information',
'info_annonce_ferme' => 'State Announce/Closed', ## 0.6
'info_confirmer_passe' => 'Confirm this new password:',
'info_ferme' => 'State closed', ## inc/spipbb_presentation.php ## 0.6
...
'le' => 'The',
'liste_des_messages' => 'Posts list', ## liste_messages.html
...
'post_propose' => 'Suggested post', ## GAF 0.6
...
'redige_post' => 'Write a topic', ## GAF 0.6
...
'sujet_dpt' => 'Topic: ',
'sujet_ferme' => 'Topic: closed',  ## GAF 0.6
'sujet_nombre' => 'Topic number',  ## GAF 0.6
'sujet_nouveau' => 'New topic',
'sujet_rejete' => 'Rejected topic',  ## GAF 0.6
