...
// BEGIN HACK
//
		$select = "SELECT articles.id_article, articles.titre, articles.surtitre,
		articles.id_rubrique, articles.statut, articles.date";
//
// END HACK
//
...
// BEGIN HACK
//
if($surtitre) $s .= " (<a href='".$surtitre."' class='spip_out'>"._T('syndicarticles:sur_le_web')."</a>)";
//
// END HACK
//
