...
function accesgroupes_affiche_descendance($id_grpe, $Tdesc, $a_afficher = "") {
				 if (is_array($Tdesc[$id_grpe]) AND count($Tdesc[$id_grpe]) > 0) {
						...
						foreach ($Tdesc[$id_grpe] as $a => $Td) {
        					 ...
        					 $a_afficher .= "<img src='"._DIR_PLUGIN_ACCESGROUPES."/img_pack/groupe-12.png' alt='|_' style='vertical-align:top;'> <a href=\"$PHP_SELF?exec=accesgroupes_admin&groupe=".$Td['id']."\">".$Td['nom']."</a><br />";
