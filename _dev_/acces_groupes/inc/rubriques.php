...
// modif pour accesgroupes
	$sql_rub_restreintes = accesgroupes_rubriques_accessibles_where('id_rubrique ', 'prive');	
...
// modif pour accesgroupes
	...
	$result3 = spip_query("SELECT * FROM spip_rubriques 
					 	 						 WHERE id_parent='$collection2'
												 AND $sql_rub_restreintes 
												 ORDER BY 0+titre,titre");
