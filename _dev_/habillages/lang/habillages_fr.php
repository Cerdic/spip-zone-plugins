...
'accueil_infos' => 'Les &laquo; habillages &raquo; sont les &eacute;l&eacute;ments qui structurent et colorient un site SPIP, tant sur la partie publique que priv&eacute;e : les couleurs, la position des textes, la typographie, les formes des encadr&eacute;s, les logos , les ic&ocirc;nes, etc...                     ',
...
'squelettes_intro' => 'Choisissez le jeu de squelettes que vous souhaitez appliquer &agrave; votre site. Par d&eacute;faut, nous gardons votre squelette actuel. Nous vous conseillons de lire la l&eacute;gende ci-contre.     ',
...
'themes_intro' => 'Choisissez le th&egrave;me que vous souhaitez appliquer &agrave; votre site. Par d&eacute;faut, nous gardons le th&egrave;me par d&eacute;faut du jeu de squelettes que vous avez choisi. En d\'autres termes, l\'option par d&eacute;faut ne change rien au squelette que vous avez choisi tant que vous ne choisissez pas un th&egrave;me ci-dessous. Si donc vous souhaitez garder l\'apparence graphique du squelette que vous avez choisi, cocher la case Th&egrave;me par d&eacute;faut.  ',
