...
'accueil_extras' => 'Extras : personnalisation de votre site avec des &eacute;l&eacute;ments (comportements) imagin&eacute;s par les d&eacute;veloppeurs de SPIP.                                            ',
...
'accueil_general_squelettes' => 'Squelette actuel de votre site         ',
...
Un &laquo;habillage&raquo; est compos&eacute; d\'un &laquo;squelette&raquo;, &eacute;ventuellement agr&eacute;ment&eacute; d\'un &laquo;style&raquo;, auxquels on peut adjoindre des &laquo;extras&raquo; et des &laquo;logos&raquo;. Ouvrez ces rubriques pour en savoir plus, et suivez les instructions pour configurer les &eacute;l&eacute;ments d\'habillage de votre choix.                                                               ',
'accueil_logos' => 'logoth&egrave;que : des gammes de logos pour habiller votre site.                                                                                        ',
'accueil_squelettes' => 'squelette : c\'est l\'armature (disposition des textes) de votre site. Ici un jeu de squelettes propos&eacute;.                                                                                        ',
...
Squelettes, styles et logos pr&ecirc;ts &agrave; l\'emploi. Choisissez d\'abord un squelette dans la rubrique du m&ecirc;me nom. Le squelette est l\'armature de votre site, ou la disposition de vos textes dans votre site. Choisissez ensuite un style dans la rubrique du m&ecirc;me nom. A chaque squelette correspondent un ou plusieurs styles. Des styles diff&eacute;rents s\'affichent donc en fonction du squelette choisi. Le style correspond &agrave; la fa&ccedil;on dont telle partie sera mise en relief ou non, &agrave; la taille des caract&egrave;res, des titres, les effets de styles, etc... La logoth&egrave;que rassemble des boutons que vous pourrez ins&eacute;rer dans votre site selon votre choix.
...
// S
'squelettes_avance' => 'Les squelettes marqu&eacute;s de deux rouages n&eacute;cessitent d\'autres manipulations que leur seule activation. Celles-ci sont g&eacute;n&eacute;ralement indiqu&eacute;es dans le descriptif du squelette. ATTENTION : passez votre chemin si vous ne comprenez pas les instructions donn&eacute;es dans le descriptif des squelettes avanc&eacute;s.                        ',
'squelettes_avance_titre' => 'Usage avanc&eacute;                                                         ',
'squelettes_base' => 'squelettes  ',
'squelettes_base_acc' => 'Squelettes  ',
...
'squelettes_defaut_description' => 'Ceci est le squelette affich&eacute; par d&eacute;faut sur votre site.  S&eacute;lectionnez-le pour  revenir &agrave; la situation initiale, c\'est-&agrave;-dire pour habiller votre site avec votre squelette  original.                       ',
...
'squelettes_intro' => 'Choisissez ci-dessous le squelette que vous souhaitez appliquer &agrave; votre site. Par d&eacute;faut, nous gardons votre squelette actuel. Les squelettes sont class&eacute;s en deux niveaux selon leur difficult&eacute; d\'installation.                                  ',
