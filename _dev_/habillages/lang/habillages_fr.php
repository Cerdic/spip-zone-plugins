...
'accueil_infos' => 'Les &laquo; habillages &raquo; sont les &eacute;l&eacute;ments qui structurent un site SPIP, tant sur la partie publique que priv&eacute;e : les couleurs, la position des textes, la typographie, les formes des encadr&eacute;s, les logos , les ic&ocirc;nes, etc...    ',
'accueil_infos_deux' => 'Un &laquo;habillage&raquo; est compos&eacute; d\'un jeu de squelettes, &eacute;ventuellement agr&eacute;ment&eacute; d\'un &laquo;style&raquo;, auxquels on peut adjoindre des &laquo;extras&raquo; et des &laquo;logos&raquo;. Ouvrez ces rubriques pour en savoir plus, et suivez les instructions pour configurer les &eacute;l&eacute;ments d\'habillage de votre choix.                                                                                     ',
