...
// A
'accueil_aide' => 'Aide : vous &ecirc;tes perdu ? Obtenez dans cette rubrique de l\'aide.                      ',
'accueil_commentaire' => 'Vous g&eacute;rez ici les habillages de votre site. Choisissez dans les rubriques suivantes :                                  ',
'accueil_extras' => 'Texte d\'explication pour les extras.                        ',
'accueil_general' => 'Introduction.                                           ',
'accueil_general_logos' => 'Vous avez actuellement choisi le/les logo(s)                                           ',
'accueil_general_maintenance' => 'Pour nettoyer la base de donn&eacute;es (toujours faire cette op&eacute;ration avant de d&eacute;sactiver le plugin habillages). &lt;strong&gt;Attention, ceci remet tout &agrave; z&eacute;ro (squelettes, styles, etc.). [Nettoyer]                                           ',
'accueil_general_maintenance_titre' => 'Maintenance                                     ',
'accueil_general_squelettes' => 'Vous avez actuellement choisi le squelette                                           ',
'accueil_general_styles' => 'Vous avez actuellement choisi le th&egrave;me                                           ',
'accueil_icones' => 'Ic&ocirc;nes : changez les ic&ocirc;nes de l\'espace priv&eacute; de votre site SPIP.                      ',
'accueil_infos' => 'Ici sont propos&eacute;s les diff&eacute;rents squelettes, styles et logos qui habilleront votre site. Vous acc&eacute;dez &agrave; leur configuration tout simplement en cliquant sur &laquo;squelettes&raquo;, &laquo;styles&raquo;, et &laquo;logoth&egrave;que&raquo;. Ensuite, en cliquant sur le bouton rond en haut &agrave; gauche correspondant &agrave; chaque squelette, style ou logo, vous modifierez l\'apparence de votre site public.                                           ',
'accueil_logos' => 'logoth&egrave;que : les logos, qui vont habiller votre site.                                        ',
'accueil_squelettes' => 'squelette : c\'est l\'armature de votre site, ou la disposition de vos textes dans votre site. Ici un jeu de squelettes propos&eacute;.                                        ',
'accueil_themes' => 'Th&egrave;mes : Texte                              ',
...
- &lt;strong&gt;Personnaliser les ic&ocirc;nes&lt;/strong&gt;&lt;br /&gt;                                           ',
'aide_avance_deux' => 'Si le module que vous souhaitez ajouter fonctionne en plugin (si lorsque vous le mettez dans votre dossier \&quot;plugins\&quot; et lorsque vous l\'activez vous obtenez les resultats escompt&eacute;s), vous devez mettre dans le dossier de votre plugin un fichier theme.xml.       ',
'aide_avance_titre' => 'Comment ajouter ses propres squelettes, ses propres th&egrave;mes, ses propres logos et extras ?       ',
'aide_avance_un' => 'Vous devez vous assurer tout d\'abord que ce que vous souhaitez ajouter (jeu de squelettes, th&egrave;me applicable &agrave; un jeu de squelettes, extras, logos, icones) fonctionne en plugin dans le sens de SPIP.       ',
'aide_debutant_deux' => 'Choisissez ensuite un style dans la rubrique du m&ecirc;me nom. A chaque squelette correspondent un ou plusieurs styles. Des styles diff&eacute;rents s\'affichent donc en fonction du squelette choisi. Le style correspond &agrave; la fa&ccedil;on dont telle partie sera mise en relief ou non, &agrave; la taille des caract&egrave;res, des titres, les effets de styles, etc...     ',
'aide_debutant_titre' => 'Squelettes, th&egrave;mes, logos, et extras pr&ecirc;ts &agrave; l\'emploi     ',
'aide_debutant_un' => 'Choisissez d\'abord un squelette dans la rubrique du m&ecirc;me nom. Le squelette est l\'armature de votre site, ou la disposition de vos textes dans votre site.     ',
...
// S
'squelettes_avance' => 'Les squelettes marqu&eacute;s de deux rouages n&eacute;cessitent d\'autres manipulations que leur seule activation. Les manipulations suppl&eacute;mentaires sont g&eacute;n&eacute;ralement indiqu&eacute;es dans le descriptif du jeu de squelettes. ATTENTION : n\'utilisez pas ces squelettes si vous ne comprenez pas les instructions qui sont donn&eacute;es dans le descriptif des squelettes avanc&eacute;s.  ',
...
'squelettes_debutant' => 'Les squelettes marqu&eacute;s d\'un rouage ne n&eacute;cessitent aucune autre manipulation que leur activation en cochant la case &agrave; c&ocirc;t&eacute; du nom du jeu de squelettes.           ',
'squelettes_debutant_titre' => 'Usage d&eacute;butant         ',
'squelettes_defaut_description' => 'Ceci est le jeu de squelettes affich&eacute; par d&eacute;faut sur votre site. Vous devez choisir ce jeu si vous souhaitez revenir &agrave; la situation initiale, c\'est-&agrave;-dire habiller votre site avec votre jeu de squelettes original.             ',
...
'squelettes_intro' => 'Vous choisissez ci-dessous le jeu de squelettes que vous souhaitez voir sur votre site. Par d&eacute;faut, nous gardons votre jeu de squelettes actuel. Vous pouvez s&eacute;lectionner votre jeu de squelettes dans deux niveaux correspondant aux niveaux de difficult&eacute; d\'installation du jeu de squelettes :         ',
