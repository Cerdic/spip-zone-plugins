...
function boutique_ajouter_boutons($flux){
	$flux['naviguer']->sousmenu['produits_page']= new Bouton("../"._DIR_PLUGIN_BOUTIQUE."/img_pack/package-x-generic.png",_T('boutique:les_produits'));
	$flux['naviguer']->sousmenu['cadis_page']= new Bouton("../"._DIR_PLUGIN_BOUTIQUE."/img_pack/cadis.png",_T('boutique:les_cadis'));
	$flux['naviguer']->sousmenu['categories_page']= new Bouton("../"._DIR_PLUGIN_BOUTIQUE."/img_pack/folder.png",_T('boutique:les_categories'));
