...
function balise_FORMULAIRE_SPIPICIOUS_AJAX ($p) {
	return calculer_balise_dynamique($p,'FORMULAIRE_SPIPICIOUS_AJAX', array('id_article', 'page'));
}
...
function balise_FORMULAIRE_SPIPICIOUS_AJAX_dyn($id_article,$page) {
  ...
  return array('formulaires/formulaire_spipicious_ajax', $GLOBALS['delais'],
				   array('self' => $url,
						 'id' => $id_article,
						 'fond' => $page,
