...
$GLOBALS['SERVER_HOST'] = "http://www.kaltura.com";
$GLOBALS['SERVICE_URL'] = $GLOBALS['SERVER_HOST'] . "/index.php/partnerservices2/";
$GLOBALS['WIDGET_HOST'] = $GLOBALS['SERVER_HOST'];

function kalturaLog ( $str )
{
	
}

// this will be used as a global parameter
$GLOBALS['kaltura_ks'] = null; 
class kalturaService
{
	...
	{
		global $kaltura_partner_id;
		$kaltura_services = new kalturaService( $kaltura_partner_id );
	...
	{
		global $kaltura_subp_id;
		$this->partner_id = $partner_id;
		$this->subp_id = $kaltura_subp_id;
		$this->format = $format;
	}
...
if ( $log_kaltura_services ) kalturaLog ( "\n\n[$SERVICE_URL]" );
	...
	public function start ( $kaltura_user )
	{
		...
		$params = array( "secret" => $kaltura_secret );
