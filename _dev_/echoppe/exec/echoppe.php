...
function exec_echoppe(){
	...
	if ($GLOBALS['connect_statut'] == "0minirezo"){
		...
		$sql_categories = "SELECT DISTINCT cat.id_categorie, cat_desc.titre, cat_desc.descriptif FROM spip_echoppe_categories cat, spip_echoppe_categories_descriptions cat_desc WHERE id_parent = '0' AND cat.id_categorie = cat_desc.id_categorie ORDER BY cat.id_categorie;";
		//echo $sql_categories;
