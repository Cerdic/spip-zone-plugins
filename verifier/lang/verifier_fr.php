...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'erreur_php_file_'.UPLOAD_ERR_INI_SIZE => 'La taille du fichier « @name@ » dépasse celle permise par le serveur',
	'erreur_php_file_'.UPLOAD_ERR_FORM_SIZE => 'La taille du fichier « @name@ » dépasse celle permise par le formulaire', 
	'erreur_php_file_'.UPLOAD_ERR_PARTIAL => 'Le fichier « @name@ » n\'a été que partiellement téléchargé', 
	'erreur_php_file_'.UPLOAD_ERR_NO_TMP_DIR => 'Une erreur du serveur a empêché l\'envoi du fichier « @name@ »', 
	'erreur_php_file_'.UPLOAD_ERR_CANT_WRITE => 'Une erreur du serveur a empêché l\'envoi du fichier « @name@ »', 
	'erreur_php_file_8'.UPLOAD_ERR_EXTENSION => 'Une erreur du serveur a empêché l\'envoi du fichier « @name@ »', 
