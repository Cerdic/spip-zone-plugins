...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'erreur_taille_egal' => 'Údaj musí mať presne @egal@ znakov.', # MODIF
	'erreur_taille_entre' => 'Údaj musí mať medzi @min@ a @max@ znakov.', # MODIF
	'erreur_taille_max' => 'Údaj nesmie mať menej ako @max@ znakov.', # MODIF
	'erreur_taille_min' => 'Údaj nesmie mať menej ako @min@ znakov.', # MODIF
