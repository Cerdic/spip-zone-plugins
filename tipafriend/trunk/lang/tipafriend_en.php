...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'cfgform_info_patron_html' => 'If the plugin <a href="http://contrib.spip.net/?article3371"><strong>Facteur</strong></a> is installed and running on your site it is possible to construct an HTML version of the email sent.', # MODIF
...
-* ["SPIP skeleton mode->@mode_spip@] ({distribution compatible})',
	...
	// L
	'licence' => 'Copyright © 2009 [Piero Wbmstr->http://contrib.spip.net/PieroWbmstr] distributed under [GNU GPL v3->http://www.opensource.org/licenses/gpl-3.0.html] license.', # MODIF
	...
	'page_test_cfg_pas_installe' => 'The [CFG-> http://contrib.spip.net/?rubrique575] plugin does not seem to be installed ...', # MODIF
