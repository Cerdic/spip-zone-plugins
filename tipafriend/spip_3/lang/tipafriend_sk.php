...
Zásuvný modul definuje štýly CSS na modely štýlov distribúcie SPIPu; tieto štýly sa podľa predvolených nastavení vkladajú do formulára, ale môžete sa rozhodnúť, že ich tam nevložíte.',
	...
	'cfgform_info_patron_html' => '<strong>Ak je na vašej stránke nainštalovaný a aktivovaný zásuvný modul <a href="http://contrib.spip.net/?article3371"><strong>Faktor,</strong></a> dá sa vytvoriť HTML verzia odoslaného e-mailu.', # MODIF
...
-* [Režim "šablóna SPIP"->@mode_spip@] ({kompatibilné s distribúciou})',
	...
	// L
	'licence' => 'Copyright © 2009 [Piero Wbmstr->http://contrib.spip.net/PieroWbmstr] distribuovaný s licenciou [GNU GPL v3.->http://www.opensource.org/licenses/gpl-3.0.html]', # MODIF
	...
	'page_test_cfg_pas_installe' => 'Zdá sa, že zásuvný modul [CFG->http://contrib.spip.net/?rubrique575] nie je nainštalovaný.', # MODIF
