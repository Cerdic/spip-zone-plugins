...
// extrait automatiquement de https://trad.spip.net/tradlang_module/tipafriend?lang_cible=en
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'cfgform_info_patron_html' => 'If the plugin <a href="https://contrib.spip.net/?article3371"><strong>Facteur</strong></a> is installed and running on your site it is possible to construct an HTML version of the email sent.',
...
- [See the HTML model with dummy values->@url_model_html@] <small>(you need the plugin {{[Facteur->https://contrib.spip.net/?article3371]}})</small>

{{{CFG Configuration Settings of TIPAFRIEND}}}

If the plugin {{[CFG : Configuration Engine->https://contrib.spip.net/?rubrique575]}} is active on your site, the link below shows you the configuration values ​​recorded for the plugin "Tip A Friend".
...
-* ["SPIP skeleton mode->@mode_spip@] ({distribution compatible})',
	...
	// L
	'licence' => 'Copyright © 2009 [Piero Wbmstr->https://contrib.spip.net/PieroWbmstr] distributed under [GNU GPL v3->http://www.opensource.org/licenses/gpl-3.0.html] license.',
	...
	'page_test_cfg_pas_installe' => 'The [CFG-> https://contrib.spip.net/?rubrique575] plugin does not seem to be installed ...',
