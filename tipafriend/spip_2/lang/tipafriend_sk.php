...
// extrait automatiquement de https://trad.spip.net/tradlang_module/tipafriend?lang_cible=sk
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'cfgform_info_patron_html' => '<strong>Ak je na vašej stránke nainštalovaný a aktivovaný zásuvný modul <a href="https://contrib.spip.net/?article3371"><strong>Faktor,</strong></a> dá sa vytvoriť HTML verzia odoslaného e-mailu.',
...
- [Zobraziť šablónu ako HTML s fiktívnymi hodnotami->@url_model_html@] <small>(vyžaduje si zásuvný modul {{[Facteur->https://contrib.spip.net/?article3371]}})</small>

{{{Parametre CFG pre TIPAFRIEND}}}

Ak je zásuvný modul {{[CFG: nástroj na nastavenie->https://contrib.spip.net/?rubrique575]}} aktivovaný na vašej stránky, po kliknutí na tento odkaz sa zobrazia hodnoty na nastavení uložené pre zásuvný modul "Odporučiť priateľom".
...
-* [Režim "šablóna SPIP"->@mode_spip@] ({kompatibilné s distribúciou})',
	...
	// L
	'licence' => 'Copyright © 2009 [Piero Wbmstr->https://contrib.spip.net/PieroWbmstr] distribuovaný pod licenciou [GNU GPL v3.->http://www.opensource.org/licenses/gpl-3.0.html]',
	...
	'page_test_cfg_pas_installe' => 'Zdá sa, že zásuvný modul [CFG->https://contrib.spip.net/?rubrique575] nie je nainštalovaný.',
