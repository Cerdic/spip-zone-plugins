...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'cfgform_info_patron_html' => '<strong>Si le plugin <a href="https://contrib.spip.net/?article3371"><strong>Facteur</strong></a> est installé et actif sur votre site</strong>, il est possible de construire une version HTML du mail envoyé.',
...
-* [Mode "squelette SPIP"->@mode_spip@] ({compatible distribution})',
	...
	// L
	'licence' => 'Copyright © 2009 [Piero Wbmstr->https://contrib.spip.net/PieroWbmstr] distribué sous licence [GNU GPL v3->http://www.opensource.org/licenses/gpl-3.0.html].',
	...
	'page_test_cfg_pas_installe' => 'Le Plugin [CFG->https://contrib.spip.net/?rubrique575] ne semble pas installé ...',
