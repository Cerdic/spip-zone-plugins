...
-* [Mode "squelette SPIP"->@mode_spip@] ({compatible distribution})', # NEW
	...
	// L
	'licence' => 'Copyright © 2009 [Piero Wbmstr->http://contrib.spip.netPieroWbmstr] distribué sous licence [GNU GPL v3->http://www.opensource.org/licenses/gpl-3.0.html].', # NEW
