...
onlineChat($_GET['auteur'].'_'.$nom,$url,'record',$_SESSION['spipcatchatprivestatut'].$timer);/* si l'utilisateur n'est pas inscrit, on l'ajoute, et on modifie la date de sa derniere actualisation */
...
if(salon($_GET['auteur'],$_SESSION['catchatpriveridsalon'],'autorite','utf-8')!=0) //Si l'autorisation est toujours valable, nous continuons, sinon on éject 
