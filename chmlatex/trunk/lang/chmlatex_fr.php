...
$GLOBALS[$GLOBALS['idx_lang']] = array(
    ...
    'generation_latex'  => "Génération de la documentation au format LaTeX",
    'langue'            => "Langue de l'export",
    'secteur'           => "Secteur à exporter",
    'telecharger_html'  => "Télécharger le fichier ZIP contenant le secteur au format HTML pour compilation CHM",
    'telecharger_latex' => "Télécharger le fichier ZIP contenant le secteur au format LaTeX"
