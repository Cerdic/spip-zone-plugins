...
/**
 * HTML Edits Module, defines Edits. Core Module.
 */
class HTMLPurifier_HTMLModule_Edits extends HTMLPurifier_HTMLModule
{
    ...
    public function setup($config)
    {
        ...
        $this->addElement('ins', 'Block', 'Flow', 'Common', array('cite' => 'URI', 'datetime' => 'Text'));
        $this->addElement('del', 'Block', 'Flow', 'Common', array('cite' => 'URI', 'datetime' => 'Text'));
