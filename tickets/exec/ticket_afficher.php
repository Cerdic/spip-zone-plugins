...
function tickets_affiche($id_ticket, $row){
	...
	$actions =
	  ($flag_editable ? bouton_modifier_tickets($id_ticket, $modif, _T('ticket:avis_projet_modifie', $modif), "ticket-24.png", "edit.gif",$spip_lang_right) : "");
...
function bouton_modifier_tickets($id_ticket, $flag_modif, $mode, $ip, $im, $align='')
{
	...
	else return icone_inline(_T('tickets:icone_modifier_ticket'), generer_url_ecrire("ticket_editer","id_ticket=$id_ticket"), "ticket-24.png", "edit.gif", $align);
}
