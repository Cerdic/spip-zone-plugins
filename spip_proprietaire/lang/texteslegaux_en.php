...
', # MODIF
	'copyright_info' => '&copy; Copyright @date@ @nom_site@ | All rights reserved.', # MODIF
...
', # MODIF
	...
	// P
	'pas_config' => 'Il n\'y a pas assez d\'information pour g&eacute;n&eacute;rer cette page ... Veuillez renseigner ces informations sur [l\'espace de configuration du plugin "Mentions L&eacute;gales"->@url_config@].', # NEW
