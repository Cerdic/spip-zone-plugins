...
// Fichier source, a modifier dans https://git.spip.net/spip-contrib-extensions/spip_proprietaire.git
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'administrateur_aussi_comment' => 'Cochez cette case si la structure dont il s’agit est également <b>administrateur</b> du site.',
	...
	'adresse_comment' => 'Remplissez ces champs de manière la plus précise et simple possible. Si vos entrées le permettent, un lien vers une carte GoogleMap sera généré.',
	...
	'capital_social_comment' => 'Précisez la monnaie le cas échéant (<i>€ &dollar;</i>).',
	'capital_social_label' => 'Capital social',
	'cnil_comment' => 'Si vous avez effectué une déclaration auprès de la CNIL, précisez ici à quelle date et sous quel récépissé.',
	'cnil_date_label' => 'Date du dépôt',
	'cnil_legend' => 'Informations CNIL',
	'cnil_numero_label' => 'N° de récépissé',
	...
	'coordonnees_tel' => 'Tél.',
	'copyright_annee_label' => 'Année de céation',
	'copyright_comment' => 'Pour rappel, en France, il n’est pas nécessaire d’avoir déposé votre copyright auprès d’un organisme pour qu’une protection soit effective. Les informations de copyright peuvent donc être mentionnées par défaut.',
	'copyright_comment_label' => 'Mention de protection',
	'copyright_complement_label' => 'Complément',
	...
	// E
	'enregistre_pres' => ' enregistré auprès ',
	'enregistree_pres' => ' enregistrée auprès ',
	'enregistrement_numero_label' => 'Sous le N°',
	'enregistrement_organisme_comment' => 'Registre du Commerce et des Sociétés, Maison des artistes ...',
	...
	'exporter_configuration' => 'Exporter la configuration (<i>informations sur le propriétaire, l’éditeur ...</i>)',
	'exporter_fichiers_langues' => 'Exporter les chaînes de langues propres au site',
	...
	'forme_comment' => 'Société (<i>précisez le statut ...</i>), association ...',
	...
	// I
	'idem_label' => 'Même structure que',
	'import_avertissement' => 'Ne modifiez ces valeurs que lorsque vous êtes sûr de vous : cela effacera votre configuration courante et vos chaînes de langue !<br /><br /><b>Il est fortement conseillé de laisser la charge de cette page au webmestre principal de votre site.</b>',
	'importer_dump' => '<strong>Importer le fichier :</strong> ',
	'infos_createur' => 'Informations créateur',
	'infos_createur_short' => 'Créateur',
	'infos_hebergeur' => 'Informations hébergeur',
	'infos_hebergeur_short' => 'Hébergeur',
	'infos_idem' => 'Même structure',
	'infos_legend' => 'Informations générales',
	'infos_proprietaire' => 'Informations propriétaire',
	'infos_proprietaire_short' => 'Propriétaire',

	// L
	'la' => 'la ',
	'le' => 'le ',
	'legal_comment' => 'Ces informations sont optionnelles. Si elles sont saisies, elles seront mentionnées dans le bloc d’information généré.',
	'legal_legend' => 'Informations légales de la structure',
	'libelle_comment' => 'Complément associé au nom de structure.',
	...
	// O
	'ok_config' => 'OK - Les valeurs ont été enregistrées _',
	'ok_export' => 'OK - Votre configuration a été exportée dans le fichier :<br />"<strong>@fichier@</strong>"',
	'ok_import' => 'OK - Votre configuration a bien été restaurée',
	...
	// P
	'pays_label' => 'Pays',
	'pconfig_avertissement' => 'Ne modifiez ces valeurs que lorsque vous êtes sûr de vous : ces valeurs sont valables sur l’ensemble du site.<br /><br /><b>Il est fortement conseillé de laisser la charge de cette page au webmestre principal de votre site.</b>',
	'pconfig_divers_legend' => 'Informations complémentaires',
	'pconfig_texte' => 'Vous pouvez ici définir les coordonnées de l’organisme @type@ ainsi que ses informations légales.',
	'pconfig_texte_ajouts' => '<br />Le système présentera les informations qui sont précisées.<br />Notez cependant que certaines fonctionnalités du plugin, notamment la construction automatique d’informations légales et de conditions d’utilisation du site, nécessitent qu’un maximum d’informations soient saisies.',
	'pconfig_texte_lien_doc' => '<br /><br />Le bouton ci-dessous présente le résultat des différentes fonctionnalités pour vérifications :',
	'pconfig_texte_notes' => '<span style="color : red ;">*</span><small>Les champs marqués d’une astérisque rouge peuvent comporter un bloc ’multi’.<br /></small>',
	'pconfig_titre_page' => 'Configuration propriétaire',
	'pconfig_titre_page_short' => 'Configuration',
	'pourquoi_ce_plugin' => 'Pourquoi ce plugin ? (<i>rappels légaux</i>)',
...
',
	...
	'proprietaire_export_import' => 'Mentions Légales : maintenance',
	'proprietaire_export_import_texte_supp' => 'Vous pouvez ici sauvegarder votre configuration courante et vos chaînes personnelles de langues, ou les restaurer depuis une précédente sauvegarde (<i>y compris depuis un autre site</i>) ...<br /><br />',
	'proprietaire_retour_plateforme' => 'Retour à la plateforme',
	'proprietaire_texte' => 'Vous pouvez ici définir les options générales du site utilisées par le plugin <b>Mentions Légales</b>.<br /><br />Vous pouvez également définir des chaînes de langues particulières dont l’utilisation est rappelée sur la page concernée.<br />',
	...
	'proprietaire_titre_page' => 'Plateforme Mentions Légales',
	...
	'pskels_legal_legend_createur' => 'Informations sur le créateur du site',
	'pskels_legal_legend_hebergeur' => 'Informations sur l’hébergeur du site',
	'pskels_titre_page' => 'Configuration des squelettes',
	'ptexte_cliquez_pour_editer' => 'Cliquez ici pour éditer l′entrée avec les raccourcis de mise en page',
	'ptexte_editable_ttl' => 'Cliquez sur la ligne pour la modifier ...',
	'ptexte_form_titre' => 'Édition complète / Nouvelle entrée',
	...
	'ptexte_supprimer' => 'Supprimer l’entrée',
	...
	'ptexte_titre_page' => 'Textes de langue propriétaire',
	...
	// S
	'sauvegardes_dans_dump' => 'Vos sauvegardes sont à placer dans le répertoire ’tmp/dump/’.',
	'serveur_legend' => 'Informations sur le serveur hébergeant le site',
	'serveur_os_comment' => 'OS installé sur ce serveur.',
	'serveur_os_label' => 'Fonctionnant sur un système',
	'serveur_os_web_label' => 'Lien web d’informations sur ce système',
	...
	'spip_proprio' => 'Mentions Légales',

	// T
	'tel' => 'Téléphone',
	'tel_abbrev' => 'Tél',
	'telecopie_label' => 'Numéro de télécopie',
	'telephone_label' => 'Numéro de téléphone',
	...
	'testing_page_carte_visite' => 'Cartes de visite (<i>en développement</i>)',
	...
	'testing_page_carte_visite_normale' => 'Carte de visite "classique" (<i>défaut</i>)',
	'testing_page_carte_visite_site' => 'Carte de visite complète du site (<i>liens web</i>)',
...
Nous vous conseillons également de jeter un oeil au squelette [mentions légales->@mentions_legales@].',
	...
	'testing_page_modele' => 'Modèle : ',
	'testing_page_public' => 'Page de test',
	'testing_page_textes_proprietaire' => 'Utilisation des textes propriétaires',
	'testing_page_titre' => 'Test de la configuration propriétaire',
	...
	'tva_nonapplicable_comment' => 'Non soumis à la TVA selon l’article 293B du <abbr title="Code Général des Impôts">CGI</abbr> ; régime micro-social.',
