...
// extrait automatiquement de https://trad.spip.net/tradlang_module/texteslegaux?lang_cible=en
...
', # MODIF
	'copyright_info' => '© Copyright @date@ @nom_site@ | All rights reserved.', # MODIF
...
', # MODIF
	...
	// E
	'egalement_administrateur' => ' and is administrated', # MODIF
...
', # MODIF
	...
	// M
	'mention_cnil' => 'As such, {{[@nom_site@->@url_site@]}} was the subject of a statement from the {{<abbr title="National French Commission for informatical freedom - Commission Nationale de l\'informatique et des Libertés - www.cnil.fr">CNIL</abbr>}} on @date_cnil@, registered under reference {{@numero_cnil@.}}', # MODIF
...
The pages and content on this site are generated by {{SPIP}} free software, distributed under the GNU / GPL ({General Public License}). You can use it freely to make your own website. For more information, visit the website: [spip.net->https://www.spip.net].
...
', # MODIF
	...
	// O
	'os_du_serveur' => ' running on a system {{@os_serveur@}}', # MODIF

	// P
	'pas_config' => 'Il n\'y a pas assez d\'information pour générer cette page ... Veuillez renseigner ces informations sur [l\'espace de configuration du plugin "Mentions Légales"->@url_config@].', # NEW
...
- save it to your computer ({put the file extension {{\'.VCF\'}} if it\'s not the case}): {{[->@vcard_url_download@]}}' # MODIF
);
