...
// extrait automatiquement de http://trad.spip.org/tradlang_module/spipproprio?lang_cible=sk
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'administrateur_aussi_comment' => 'Skúste tu, ak do danej štruktúry patrí aj~<b>administrátor</b> stránky.', # MODIF
	...
	'adresse_comment' => 'Tieto polia vyplňte tak presne, ako sa dá. Ak to vaše údaje umožnia, vytvorí sa odkaz na GoogleMap.', # MODIF
	...
	'bouton_exporter' => 'Spustiť export', # MODIF
	'bouton_importer' => 'Spustiť import', # MODIF
	'bouton_saisie_libre' => 'Voľný vstup',

	// C
	'capital' => ' s hlavným mestom',
	'capital_social_comment' => 'Uveďte vhodnú peňažnú menu (<i>€ &dollar;</i>).', # MODIF
	'capital_social_label' => 'Hlavné mesto',
	'cnil_comment' => 'Ak ste vykonali deklaráciou do CNIL, uveďte s~akým dátumom a~číslom dokladu.', # MODIF
	'cnil_date_label' => 'Dátum podania', # MODIF
	'cnil_legend' => 'Informácie o CNIL',
	'cnil_numero_label' => 'Č. dokladu', # MODIF
	...
	'copyright_annee_label' => 'Rok vytvorenia', # MODIF
	'copyright_comment' => 'Majte na pamäti, že vo Francúzsku netreba autorské práva zapísať aj so spoločnosťou, pre ktorú platia. Informácia o autorských právach môže byť uvedená v predvolených nastaveniach.', # MODIF
	'copyright_comment_label' => 'Záznam o ochrane',
	'copyright_complement_label' => 'Doplnenie', # MODIF
	...
	// E
	'enregistre_pres' => ' zaregistrované s ', # MODIF
	'enregistree_pres' => ' zaregistrované s ', # MODIF
	'enregistrement_numero_label' => 'Pod č. ', # MODIF
	'enregistrement_organisme_comment' => 'Obchodný register, Register umelcov...', # MODIF
	'enregistrement_organisme_label' => 'Zaregistrované u', # MODIF
	'enregistrement_ou_label' => 'Automatický údaj pre Francúzsko (<i>možnosť, ktorá nahradí pole, ktoré sa nachádza vyššie</i>)', # MODIF
	'enregistrement_siren_comment' => 'napr. 123 456 78 (9: automatický kľúč)', # MODIF
	'enregistrement_siren_label' => 'SIREN [<abbr title="Système d\'Identification du Répertoire des ENtreprises – kód INSEE, ktorý označuje legálny podnik (ako naše IČO)">?</abbr>]', # MODIF
	'enregistrement_siren_title' => '9-miestny kód spoločnosti, môžete zadať len prvých osem číslic.', # MODIF
	'enregistrement_siret_comment' => 'napr. 1234 (5: automatický kľúč)', # MODIF
	'enregistrement_siret_label' => 'SIRET (NIC) [<abbr title="Č. podniku – Č. podľa vnútornej klasifikácie">?</abbr>]', # MODIF
	'enregistrement_siret_title' => 'Zadajte 5 číslic, nemôžete zadať nuly ani posledné číslice.', # MODIF
	'enregistrement_tvaintra_comment' => 'napr. FR 45 (automaticky)',
	'enregistrement_tvaintra_label' => 'Daňové identifikačné číslo', # MODIF
	'enregistrement_tvaintra_title' => 'Automaticky zistiť z čísla SIREN.', # MODIF
	'erreur_config' => '!! - Nastala neznáma chyba _',
	'erreur_export' => '!! - Nastala neznáma chyba _',
	'erreur_import' => '!! - Nastala neznáma chyba _',
	'exporter_configuration' => 'Nastavenia exportu (<i>informácie o vlastníkovi, redaktorovi a pod.</i>', # MODIF
	'exporter_fichiers_langues' => 'Reťazce z jazykov stránky na export', # MODIF
	'exporter_importer' => 'Exportovať/Importovať',

	// F
	'fax' => 'Fax', # MODIF
	'fax_abbrev' => 'Fax',
	'feminin' => 'ženský rod', # MODIF
	'fonction_administrateur' => 'Administrátor',
	'fonction_webmaster' => 'Webmaster',
	'forme' => 'Právnický',
	'forme_comment' => 'Spoločnosť (<i>uveďte právnu formu...</i>), združenie...', # MODIF
	...
	// I
	'idem_label' => 'Tá istá štruktúra ako', # MODIF
	'import_avertissement' => 'Nemeňte hodnoty, keď si sami nie ste istí: toto vymaže vaše súčasné nastavenie a reťazce jazyka!<br /><br /><b>Veľmi sa odporúča prenechať riadenie tejto stránky webmasterovi hlavnej stránky.</b>', # MODIF
	'importer_dump' => '<strong>Nahrať súbor:</strong> ',
	'infos_createur' => 'Informácie o autorovi', # MODIF
	'infos_createur_short' => 'Créateur', # NEW
	'infos_hebergeur' => 'Informácie o hostingu', # MODIF
	'infos_hebergeur_short' => 'Hébergeur', # NEW
	'infos_idem' => 'Rovnaká štruktúra', # MODIF
	'infos_legend' => 'Všeobecné informácie', # MODIF
	'infos_proprietaire' => 'Informácie o vlastníkovi', # MODIF
	'infos_proprietaire_short' => 'Propriétaire', # NEW

	// L
	'la' => 'dňa',
	'le' => ' ',
	'legal_comment' => 'Tento údaj je nepovinný. Ak ho zadáte, uvedie sa vo vytvorenom bloku údajov.', # MODIF
	'legal_legend' => 'Právne informácie o štruktúre', # MODIF
	'libelle_comment' => 'Doplnok pripojený k názvu štruktúry.', # MODIF
	'libelle_label' => 'Štylizácia', # MODIF
	...
	'masculin' => 'mužský rod',
	'mel' => 'E-mail',
	'mentions_legales' => 'Informácie právneho charakteru', # MODIF

	// N
	'new_window' => 'Nové okno', # MODIF
	'news' => 'Novinky', # MODIF
	...
	// O
	'ok_config' => 'V poriadku – hodnoty boli zaznamenané _', # MODIF
	'ok_export' => 'V poriadku – vaše nastavenia boli exportované do súboru:<br />"<strong>@fichier@</strong>"', # MODIF
	'ok_import' => 'V poriadku – vaše nastavenia boli obnovené', # MODIF
	...
	// P
	'pays_label' => 'Krajina',
	'pconfig_avertissement' => 'Nemeňte tieto hodnoty, ak si nie ste istí: tieto hodnoty platia pre celú stránku.<br /><br /><b>Odporúča sa prenechať túto stránku hlavnému webmasterovi.</b>', # MODIF
	'pconfig_divers_legend' => 'Ďalšie údaje', # MODIF
	'pconfig_texte' => 'Môžete zadať súradnice @type@ inštitúcie a údaje právneho charakteru.', # MODIF
	'pconfig_texte_ajouts' => '<br />Systém zobrazí údaje, ktoré uvediete. <br />Majte na pamäti, že niektoré funkcie zásuvného modulu, vrátane automatického vytvárania "informácií právneho charakteru" a "podmienok používania" si vyžadujú, aby bol údaj zadaný.', # MODIF
	'pconfig_texte_lien_doc' => '<br /><br />Tlačidlo nižšie ukazuje výsledok rôznych funkcií na schválenie:', # MODIF
	'pconfig_texte_notes' => '<span style="color: red;">*</span><small>Polia označené červenou hviezdičkou môžu obsahovať "viacnásobný" blok.<br /></small>', # MODIF
	'pconfig_titre_page' => 'Nastavenia', # MODIF
	'pconfig_titre_page_short' => 'Nastavenia',
	'pourquoi_ce_plugin' => 'Prečo tento zásuvný modul ? (<i>upozornenia právneho charakteru</i>)', # MODIF
...
Vo všeobecnejšej rovine treba informácie právneho charakteru pre vašu stránku prispôsobiť vašej činnosti ({viazaná živnosť, komerčná stránka, atď.}).', # MODIF
...
Viac informácií nájdete na stránke s príkladmi ({táto stránka berie do úvahy údaje v rôznych formulároch zásuvného modulu; na to, aby sa niečo zobrazilo, treba vyplniť aspoň niektoré}).', # MODIF
...
Od verzie 1.1 poskytuje zásuvný modul prispôsobenie pre šablóny, ktoré sú kompatibilné s týmito šablónami.  Ak ich chcete zobraziť, jednoducho pridajte do šablón, ktoré sú uvedené vyššie "_zpip". Obsah týchto šablón nájdete v priečinku "public/contenu/".', # MODIF
	'proprietaire' => 'vlastník', # MODIF
	'proprietaire_export_import' => 'Informácie právneho charakteru: technická údržba', # MODIF
	'proprietaire_export_import_texte_supp' => 'Tu môžete zálohovať svoje súčasné nastavenia a svoje vlastné jazykové reťazce alebo ich obnoviť z predtým vytvorenej zálohy (<i>vrátane tých z inej stránky...</i>)<br /><br />', # MODIF
	'proprietaire_retour_plateforme' => 'Späť na platformu', # MODIF
	'proprietaire_texte' => 'Tu môžete definovať všeobecné možnosti stránky, ktoré využíva zásuvný modul s názvom <b>Informácie právneho charakteru.</b><br /><br />Môžete definovať aj jazykové reťazce, ktorých použitie je vymedzené na príslušnej stránke.<br />', # MODIF
	...
	'proprietaire_titre_page' => 'Platforma Informácie právneho charakteru', # MODIF
	...
	'pskels_legal_legend_createur' => 'Údaje o tvorcovi stránky', # MODIF
	'pskels_legal_legend_hebergeur' => 'Údaje o poskytovateľovi webhostingu', # MODIF
	'pskels_titre_page' => 'Nastavenie šablón',
	'ptexte_cliquez_pour_editer' => 'Na upravenie zápisu klávesovými skratkami kliknite sem', # MODIF
	'ptexte_editable_ttl' => 'Ak to chcete zmeniť, kliknite na daný riadok.',
	'ptexte_form_titre' => 'Úpravy dokončené/Nový zápis', # MODIF
	...
	'ptexte_supprimer' => 'Vymazať vstup', # MODIF
	...
	'ptexte_titre_page' => 'Texty v jazyku majiteľa', # MODIF
	...
	'retour' => 'Späť',
	'rue_label' => 'Ulica', # MODIF

	// S
	'sauvegardes_dans_dump' => 'Zálohy majú byť umiestnené v priečinku "tmp/dump/".', # MODIF
	'serveur_legend' => 'Údaje o serveri, na ktorom sa nachádza stránka', # MODIF
	'serveur_os_comment' => 'Operačný systém nainštalovaný na tomto serveri.', # MODIF
	'serveur_os_label' => 'Beží na systéme', # MODIF
	'serveur_os_web_label' => 'Odkaz s informáciami o tomto systéme na internete', # MODIF
	'serveur_type_comment' => 'Technické parametre servera, na ktorom sa stránka nachádza.', # MODIF
	'serveur_type_label' => 'Typ servera',
	'siege' => 'Centrála', # MODIF
	...
	'sous_le_numero' => ' pod číslom', # MODIF
	'spip_proprio' => 'Informácie právneho charakteru', # MODIF

	// T
	'tel' => 'Telefón', # MODIF
	'tel_abbrev' => 'Tel.', # MODIF
	'telecopie_label' => 'Fax', # MODIF
	'telephone_label' => 'Telefónne číslo', # MODIF
	...
	'testing_page_carte_visite' => 'Vizitky (<i>vo vývoji</i>)', # MODIF
	...
	'testing_page_carte_visite_normale' => 'Klasická vizitka (<i>predvolené</i>)', # MODIF
	'testing_page_carte_visite_site' => 'Vizitka celej stránky (<i>internetové odkazy</i>)', # MODIF
...
Tiež vám odporúčame, aby ste sa pozreli na  [informácie právneho charakteru->@mentions_legales@] o šablóne.', # MODIF
	...
	'testing_page_textes_proprietaire' => 'Použitie textov vlastníka', # MODIF
	'testing_page_titre' => 'Test nastavení vlastníka', # MODIF
	'testing_page_vcard' => 'Informácie o "vCard" a odkazy na ňu',
	'tva_intracommunautaire' => 'DIČ',
	'tva_intracommunautaire_abbrev' => 'DIČ',
	'tva_non_applicable' => 'Nepodlieha DPH podľa odseku 293B <abbr title="French Code Général des Impôts">CGI</abbr>', # MODIF
	'tva_nonapplicable_comment' => 'nepodlieha DPH podľa odseku 293B <abbr title="French Code Général des Impôts">CGI</abbr> ; micro-social regime.', # MODIF
