...
- {{[vizika webmastera.->@webmaster@]}}', # MODIF
...
', # NEW
	'copyright_info' => '© Copyright @date@ @nom_site@ | Všetky práva vyhradené.', # MODIF
...
Internetovú stránku {{[@nom_site@->@url_site@]}} vytvoril jej vlastník.
', # MODIF

	// E
	'egalement_administrateur' => ' a riadi ju', # MODIF
	'enregistre_pres' => 'zaregistrovaný cez', # MODIF

	// H
	'hebergeur_mentions_legales' => '[Poskytovateľ webostingu <-]{{{Webhosting}}}
...
{{@proprietaire_nom@}} neprijíma žiadnu zodpovednosť pre prerušenie prevádzky {{[@nom_site@->@url_site@]}} a jej služieb.
', # MODIF
...
', # NEW
	...
	// O
	'os_du_serveur' => ' beží na systéme {{@os_serveur@}}', # MODIF

	// P
	'pas_config' => 'Na vytvorenie tejto stránky nie je dosť údajov. Vyplňte, prosím, tieto údaje v [časti s nastaveniami zásuvného modulu s názvom "Informácie právneho charakteru".->@url_config@]', # MODIF
	'pour_les_contacter' => 'Ak ich chcete kontaktovať, použite e-mailovú adresu: [@mail@.->mailto:@mail@]',
	'proprietaire_mentions_legales' => '[editeur<-]{{{Vlastník/vydavateľ}}}
