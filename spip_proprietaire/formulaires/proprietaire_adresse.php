...
function formulaires_proprietaire_adresse_charger_dist($who='proprietaire'){
	...
	$valeurs = array(
		...
		'adresse_pays' => $conf[$who.'_adresse_pays'] ? $conf[$who.'_adresse_pays'] : 'France',
		'adresse_telephone' => $conf[$who.'_adresse_telephone'],
		'adresse_telecopie' => $conf[$who.'_adresse_telecopie'],
	);
	return $valeurs;
}
