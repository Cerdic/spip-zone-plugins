...
function vu_upgrade($vu_base_version,$version_cible){
	...
	if ((!isset($GLOBALS['meta'][$vu_base_version])) 						// si la variable vu_base_version est n'est pas renseignée
		...
		if ($current_version<0.2){
			...
			// Table evenements : on ajoute un champ texte 'lieu_evenement'
			sql_alter("TABLE vu_evenements ADD lieu_evenement text NOT NULL AFTER date_evenement");
			...
			// Toutes les tables doit avoir un champ 'langue'
			sql_alter("TABLE vu_annonces ADD langue text NOT NULL AFTER descriptif");
			sql_alter("TABLE vu_evenements ADD langue text NOT NULL AFTER descriptif");
			...
			sql_alter("TABLE vu_annonces_mots RENAME TO spip_vu_annonces_mots");
			sql_alter("TABLE vu_evenements_mots RENAME TO spip_vu_evenements_mots");		
			sql_alter("TABLE vu_publications_mots RENAME TO spip_vu_publications_mots");
