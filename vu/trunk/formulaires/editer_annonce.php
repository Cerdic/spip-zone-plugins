...
/*	Fichier PHP du formulaire CVT : editer_annonce. Etroitement 	*/
...
/*	#FORMULAIRE_EDITER_ANNONCE dans le fond				*/ 
/*	'prive/editer/annonce.html'.					*/
...
function annonces_edit_config($row)
{
...
function formulaires_editer_annonce_charger_dist($id_annonce='new', $id_rubrique='', $retour='', $lier_trad=0, $config_fonc='annonces_edit_config', $row=array(), $hidden=''){
	...
	$valeurs = formulaires_editer_objet_charger('annonce',$id_annonce,$id_parent, $lier_trad,$retour,$config_fonc,$row,$hidden);
	return $valeurs;
...
function formulaires_editer_annonce_verifier_dist($id_annonce='new', $id_rubrique='', $retour='', $lier_trad=0, $config_fonc='annonces_edit_config', $row=array(), $hidden=''){
	...
	$erreurs = formulaires_editer_objet_verifier('annonce',$id_annonce,array('titre'));
...
function formulaires_editer_annonce_traiter_dist($id_annonce='new', $id_rubrique='', $retour, $lier_trad=0, $config_fonc='annonces_edit_config', $row=array(), $hidden=''){
	...
	$resultat = formulaires_editer_objet_traiter('annonce',$id_annonce,$id_parent,$lier_trad,$retour,$config_fonc,$row,$hidden);
	return $resultat;
}
