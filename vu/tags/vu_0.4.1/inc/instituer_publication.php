...
function inc_instituer_publication($id_objet, $statut=-1)
{
	$type_objet = 'publication';
	...
	$liste_statuts = array(
		...
		'prop' => array(_T('vu:item_'.$type_objet.'_proposee'),''),	
		'publie' => array(_T('vu:item_'.$type_objet.'_validee'),''),	
		'refuse' => array(_T('vu:item_'.$type_objet.'_refusee'),''),
	...
	$res =
	  ...
	  . "<li>" . _T('vu:entree_'.$type_objet.'_publiee') 
	  ."<ul>";
