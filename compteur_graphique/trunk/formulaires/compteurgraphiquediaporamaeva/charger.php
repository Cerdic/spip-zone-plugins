<?php
function formulaires_compteurgraphiquediaporamaeva_charger_dist($id_article){
    ...
    if ($num_compt!='') {
        ...
        if ($resultat2!=''){
            ...
            return array('compteurgraphiquediaporamaeva'=>$envoi_final);
        }
        //Si suppression : retour d'une chaine vide
        else {
        return array('compteurgraphiquediaporamaeva'=>'');
        }
    }
    else {
        ...
        //On récupère les données de la table des compteurs pour vérifier si l'identifiant de l'article y est défini 
		    ...
		    else {return array('compteurgraphiquediaporamaeva'=>'');}
                }
            }
        }
