...
// extrait automatiquement de http://trad.spip.org/tradlang_module/paquet-coloration_code?lang_cible=sk
...
_ <code>#TEXTE**|coloration_code_color{spip,code}</code> : colore #TEXTE avec le language spip en format code (sans cadre), voir exemple lecode.html. L\'url depuis l\'article serait <code>#URL_SITE_SPIP/spip.php?page=lecode&id_article=#ENV{id_article}</code>', # NEW
