...
// extrait automatiquement de https://trad.spip.net/tradlang_module/paquet-diogene?lang_cible=en
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	// D
	'diogene_description' => 'The plugin Diogene permits to create sector-specific forms masks for the three specific object types:
-* articles;
-* sections;
-* websites;
