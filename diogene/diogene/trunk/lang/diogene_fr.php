...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'explication_contenu_attente' => 'Ces objets d\'autres auteurs sont en attente de publication définitive. Leur publication a été demandée.',
	...
	// M
	'message_article_mis_a_jour' => 'L\'article a été mis à jour',
	...
	'message_objet_cree' => 'Votre nouvel objet a été créé.',
	'message_objet_mis_a_jour' => 'Votre objet a été mis à jour.',
	'message_objet_mis_a_jour_lien' => 'Vous pouvez le consulter en suivant <a href="@url@" class="spip_in">ce lien</a>.',
	'message_objet_supprime' => 'Votre objet a été supprimé.',
	'message_pas_auteur' => 'Attention. Vous n\'êtes pas listé comme auteur de cet objet.',
	'message_rubrique_creee' => 'La rubrique a été correctement créée. Elle ne sera visible que lorsqu\'un élément y sera publié.',
	'message_rubrique_mis_a_jour' => 'La rubrique a été mise à jour.<br />Vous pouvez la consulter en suivant <a href="@url@" class="spip_in">ce lien</a>',
	'message_site_cree' => 'Votre site a été créé.',
	'message_site_mis_a_jour' => 'Le site a été mis à jour.<br />Vous pouvez le consulter en suivant <a href="@url@" class="spip_in">ce lien</a>',
