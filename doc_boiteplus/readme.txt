...
Une photo dans le dossier demo de ce plugin permet d'avoir un aperçu du rendu final,
...
n'activez pas l'option 'choisir un seul mot dans ce groupe' car la liste serait trop lourde à l'affichage (TODO)

N'hesitez pas à faire des remarques sur la zone spip
