...
function taille_du_cache() {
	$s = spip_query("SELECT SUM(taille) AS n FROM spip_caches WHERE type='t'");
...
//
// https://code.spip.net/@suivre_invalideur
...
//
// https://code.spip.net/@retire_vieux_caches
...
// https://code.spip.net/@purger_repertoire
...
// https://code.spip.net/@cron_invalideur
