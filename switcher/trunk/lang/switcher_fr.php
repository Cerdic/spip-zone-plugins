<?php
    ...
    $GLOBALS[$GLOBALS['idx_lang']] = array(
        'configurer_switcher' => 'Configurer le switcher',
    
        'repertoires_alternatifs_label' => 'Liste des squelettes alternatifs',
        'repertoires_alternatifs_explication' => 'Indiquez les repertoires contenant vos squeletts alternatifs, vous pouvez les séparer avec des virgules ","',
