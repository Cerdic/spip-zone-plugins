...
function formulaires_configurer_media_verifier_dist(){
	...
	foreach(array('media_taille_vignette_largeur','media_taille_vignette_hauteur','media_taille_petit_largeur', 'media_taille_petit_hauteur','media_taille_moyen_largeur','media_taille_moyen_hauteur','media_taille_grand_largeur', 'media_taille_grand_hauteur', 'media_largeur_min_legende', 'media_largeur_max_legende') as $champ)
