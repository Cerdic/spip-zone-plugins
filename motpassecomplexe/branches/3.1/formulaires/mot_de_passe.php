 ...
 * On verifie qu'un mot de passe est saisi, et que sa longueur est suffisante
...
function formulaires_mot_de_passe_verifier_dist($id_auteur=null, $jeton=null){
  ...
  else if ( $erreur_motpasse = motpassecomplexe_verifier_pass($p = _request('oubli')) )      // PLUGIN MOTPASSECOMPLEXE
    $erreurs['oubli'] = $erreur_motpasse;  // PLUGIN MOTPASSECOMPLEXE
  else {		
