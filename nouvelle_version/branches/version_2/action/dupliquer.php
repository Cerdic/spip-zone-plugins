...
function dupliquer_article($article, $rubrique)
{
    ...
    // $maj_statut_article = sql_updateq("spip_articles", array('statut' => $infos[0]['statut']),
...
/* FONCTION HONTEUSEMENT ADAPTEE DE DOCUCOPIEUR ==> http://www . contrib.spip . net/DocuCopieur */
