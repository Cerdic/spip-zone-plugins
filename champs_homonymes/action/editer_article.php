...
function revisions_articles ($id_article, $new) {
	...
	if ($GLOBALS['champs_extra']) {
		...
		//$champs['extra'] = extra_recup_saisie("articles", _request('id_secteur'));//original
		$champs['extra'] = extra_recup_saisie("articles", $id_article);// modifié le 24-09-2006 par francois.vachon@iago.ca pour le plugin champs homonymes
	}
