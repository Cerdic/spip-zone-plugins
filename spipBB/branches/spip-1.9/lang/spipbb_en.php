...
$GLOBALS[$GLOBALS['idx_lang']] = array(
 ...
 Consult the [documentation on Spip-Contrib->http://contrib.spip.net/SpipBB-le-forum] or [support on spipbb.spip-zone->http://spipbb.spip-zone.info/spip.php?article11]',
 ...
 _ A post-it is placed underneath announcements, before ordinary messages. It only appears once in the list.',
	...
	'par_' => 'by ',
	'plugin_auteur' => 'The SpipBB Team: [See the list of contributors on Spip-contrib->http://contrib.spip.net/Plugin-SpipBB#contributeurs]',
...
',
 ...
 regulations.</p>',
	...
	'sign_admin' => '<MODIF>{{This page can only be seen by the site owner.}}<p>It provides access to the plugin configuration of &laquo;{{<a href="http://contrib.spip.net/Plugin-SpipBB#contributeurs" class="copyright">SpipBB</a>}}&raquo; and the forum management of your site.</p><p>Version : @version@ @distant@</p><p>See&nbsp;:
...
_ • [The help and support on spipbb.spip-zone.info->http://spipbb.spip-zone.info/spip.php?article11]</p>@reinit@',
 ...
 _ • [the whole plugin->@plugin@]</p>',
	'sign_tempo' => 'Build with <a href="http://contrib.spip.net/Plugin-SpipBB#contributeurs" class="copyright">SpipBB</a>',
	'signature' => 'Signature',
	'sinscrire' => 'Register',
