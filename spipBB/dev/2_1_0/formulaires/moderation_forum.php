...
function formulaires_moderation_forum_charger_dist(
...
function formulaires_moderation_forum_verifier_dist(
	$titre, $table, $type, $script,
	$id_rubrique, $id_forum, $id_article, $id_breve, $id_syndic,
	$ajouter_mot, $ajouter_groupe, $afficher_texte, $url_param_retour)
{
...
function formulaires_moderation_forum_traiter_dist() {
