...
function spipbb_declarer_tables_auxiliaires($tables_auxiliaires){
	$spip_auteurs_extra = array(
	"id_auteur" 	=> "bigint(21) NOT NULL",
	"date_crea_spipbb" 	=> "date NOT NULL",
	"avatar" 		=> "text",
	"signature_post" 		=> "text",
	"annuaire_forum" 		=> "text",
	"localisation" 		=> "text",
	...
	"nom_yahoo" 		=> "text",
	"nom_msnm" 		=> "text",
	"refus_suivi_thread" 		=> "text"

	
	);

$spip_auteurs_extra_key = array(
	'PRIMARY KEY'	=> "id_auteur"
	); //(`date`,`id_forum`)

$tables_auxiliaires['spip_auteurs_extra'] = array(
	'field' => &$spip_auteurs_extra,
	'key' => &$spip_auteurs_extra_key);
