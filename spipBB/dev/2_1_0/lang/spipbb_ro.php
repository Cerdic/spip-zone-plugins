...
// extrait automatiquement de https://trad.spip.net/tradlang_module/spipbb?lang_cible=ro
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
 ...
 Consultaţi [documentaţia de la Spip-Contrib->http://contrib.spip.net/SpipBB-le-forum] sau [suportul pentru spipbb.spip-zone->http://spipbb.spip-zone.info/spip.php?article11]', # MODIF
	...
	'admin_plugin_requis_erreur_balisesession' => 'Instalaţi plug-in-ul Balise SESSION şi activaţi-l ! [Documentaie aici->http://contrib.spip.net/?article1224], [Arhivă ZIP aici->https://files.spip.net/spip-zone/balise_session.zip].', # MODIF
	'admin_plugin_requis_erreur_cfg' => 'Instalaţi plug-in-ul CFG şi activaţi-l ! [Documentaţie aici->http://contrib.spip.net/?article1605], [Arhivă ZIP aici->https://files.spip.net/spip-zone/cfg.zip].', # MODIF
	...
	'admin_plugin_requis_ok_cfg' => '[Plug-in CFG->http://contrib.spip.net/?article1605] : furnizează funcţii şi balize.', # MODIF
