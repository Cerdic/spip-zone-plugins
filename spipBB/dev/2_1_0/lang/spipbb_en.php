...
$GLOBALS[$GLOBALS['idx_lang']] = array(
 ...
 Refer to the [documentation on Spip-Contrib->http://contrib.spip.net/SpipBB-le-forum] or [support on spipbb.spip-zone->http://spipbb.spip-zone.info/spip.php?article11]', # MODIF
	...
	'admin_plugin_requis_erreur_balisesession' => 'Install le "Balise SESSION" plugin  and activate it! [Documentation here->http://contrib.spip.net/?article1224], [ZIP file here->http://files.spip.org/spip-zone/balise_session.zip].', # MODIF
	'admin_plugin_requis_erreur_cfg' => 'Install the CFG plugin and activate it![Documentation here->http://contrib.spip.net/?article1605], [Zip file here->http://files.spip.org/spip-zone/cfg.zip].', # MODIF
