...
$GLOBALS[$GLOBALS['idx_lang']] = array(
 ...
 Refer to the [documentation on contrib.spip->https://contrib.spip.net/SpipBB-le-forum] or [support on spipbb.spip-zone->http://spipbb.spip-zone.info/spip.php?article11]',
	...
	'admin_plugin_requis_erreur_balisesession' => 'Install le "Balise SESSION" plugin  and activate it! [Documentation here->https://contrib.spip.net/?article1224], [ZIP file here->http://files.spip.org/spip-zone/balise_session.zip].',
	'admin_plugin_requis_erreur_cfg' => 'Install the CFG plugin and activate it![Documentation here->https://contrib.spip.net/?article1605], [Zip file here->http://files.spip.org/spip-zone/cfg.zip].',
 ...
 _ A post-it is placed underneath announcements, before ordinary messages. It only appears once in the list.',
	...
	'par_' => 'by ',
	'plugin_auteur' => 'The SpipBB Team: [See the list of contributors on contrib.spip->https://contrib.spip.net/Plugin-Forum-SpipBB#contributeurs]',
...
nbr_post@ message(s). Deleted along with it!\\n',
 ...
 regulations.</p>',
	...
	'sign_admin' => '{{This page can only be seen by the site owner.}}<p>It provides access to the plugin configuration of «{{<a href="https://contrib.spip.net/Plugin-Forum-SpipBB#contributeurs" class="copyright">SpipBB</a>}}» as well as to the forum management of your site.</p><p>Version : @version@ @distant@</p><p>See :
...
_ • [Help and support on spipbb.spip-zone.info->http://spipbb.spip-zone.info/spip.php?article11]</p>@reinit@',
 ...
 _ • [the whole plugin->@plugin@]</p>',
	'sign_tempo' => 'Build with <a href="https://contrib.spip.net/Plugin-Forum-SpipBB#contributeurs" class="copyright">SpipBB</a>',
	'signature' => 'Signature',
	'sinscrire' => 'Register',
