...
// extrait automatiquement de https://trad.spip.net/tradlang_module/spipbb?lang_cible=en
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
 ...
 Refer to the [documentation on Spip-Contrib->http://contrib.spip.net/SpipBB-le-forum] or [support on spipbb.spip-zone->http://spipbb.spip-zone.info/spip.php?article11]', # MODIF
	...
	'admin_plugin_requis_erreur_balisesession' => 'Install le "Balise SESSION" plugin  and activate it! [Documentation here->http://contrib.spip.net/?article1224], [ZIP file here->https://files.spip.net/spip-zone/balise_session.zip].', # MODIF
	'admin_plugin_requis_erreur_cfg' => 'Install the CFG plugin and activate it![Documentation here->http://contrib.spip.net/?article1605], [Zip file here->https://files.spip.net/spip-zone/cfg.zip].', # MODIF
	...
	'admin_plugin_requis_ok_balisesession' => '[Plugin BALISE_SESSION->http://contrib.spip.net/?article1224] : gives information on visitors who are logged in.', # MODIF
	'admin_plugin_requis_ok_cfg' => '[Plugin CFG->http://contrib.spip.net/?article1605] : provides tags and functions.', # MODIF
 ...
 _ A post-it is placed underneath announcements, before ordinary messages. It only appears once in the list.',
	...
	'par_' => 'by ',
	'plugin_auteur' => 'The SpipBB Team: [See the list of contributors on Spip-contrib->http://contrib.spip.net/Plugin-Forum-SpipBB#contributeurs]', # MODIF
...
_ [Access to the management panel-> .?exec=spipbb_configuration]', # MODIF
	...
	'plugin_lien' => '[See the documentation of the plugin from Spip-contrib->http://contrib.spip.net/SpipBB-le-forum]', # MODIF
...
_ • [Help and support on spipbb.spip-zone.info->http://spipbb.spip-zone.info/spip.php?article11]</p>@reinit@', # MODIF
 ...
 _ • [the whole plugin->@plugin@]</p>',
	'sign_tempo' => 'Build with <a href="http://contrib.spip.net/Plugin-Forum-SpipBB#contributeurs" class="copyright">SpipBB</a>', # MODIF
	'signature' => 'Signature',
	'sinscrire' => 'Register',
