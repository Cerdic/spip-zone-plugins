...
$GLOBALS[$GLOBALS['idx_lang']] = array(
 ...
 به [documentation on Spip-Contrib->http://contrib.spip.net/SpipBB-le-forum] or  مراجعه كنيد.[support on spipbb.spip-zone->http://spipbb.spip-zone.info/spip.php?article11]', # MODIF
	...
	'admin_plugin_requis_erreur_balisesession' => 'پلاگين  Balise SESSION فعال كنيد! [مستندات آن اينجاست->http://contrib.spip.net/?article1224], [Archive ZIP là->https://files.spip.net/spip-zone/balise_session.zip].', # MODIF
	'admin_plugin_requis_erreur_cfg' => 'پلاگين CFG را نصب و فعال كنيد!  [مستنداتش اينجاست->http://contrib.spip.net/?article1605], [Archive ZIP là->https://files.spip.net/spip-zone/cfg.zip].', # MODIF
