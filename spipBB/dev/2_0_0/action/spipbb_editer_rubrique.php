...
function action_spipbb_editer_rubrique_dist() {
...
# h. retour spipbb_admin => arg = id_salon
	$redirect = parametre_url(
		urldecode(_request('redirect')),
		'id_salon', $id_rubrique, '&');
...
#h. ne sert plus ==> on a interdit le deplacement, dans le formulaire !(v. gaf_rubriques_edit)
