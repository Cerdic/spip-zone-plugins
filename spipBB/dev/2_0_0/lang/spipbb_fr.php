...
Consultez la [documentation sur Spip-Contrib->http://contrib.spip.netSpipBB-le-forum] ou le [support sur spipbb.spip-zone->http://spipbb.free.fr/spip.php?article11]',
	...
	'admin_plugin_requis_erreur_balisesession' => 'Installez le plugin Balise SESSION et activez le ! [Documentation ici->http://contrib.spip.net?article1224], [Archive ZIP l&agrave;->http://files.spip.org/spip-zone/balise_session.zip].',
	'admin_plugin_requis_erreur_cfg' => 'Installez le plugin CFG et activez le ! [Documentation ici->http://contrib.spip.net?article1605], [Archive ZIP l&agrave;->http://files.spip.org/spip-zone/cfg.zip].',
