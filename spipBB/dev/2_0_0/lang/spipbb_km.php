...
$GLOBALS[$GLOBALS['idx_lang']] = array(
 ...
 Refer to the [documentation on Spip-Contrib->https://contrib.spip.net/SpipBB-le-forum] or [support on spipbb.spip-zone->http://spipbb.spip-zone.info/spip.php?article11]', # NEW
	...
	'admin_plugin_requis_erreur_balisesession' => 'Install le "Balise SESSION" plugin  and activate it! [Documentation here->https://contrib.spip.net/?article1224], [ZIP file here->http://files.spip.org/spip-zone/balise_session.zip].', # NEW
	'admin_plugin_requis_erreur_cfg' => 'Install the CFG plugin and activate it![Documentation here->https://contrib.spip.net/?article1605], [Zip file here->http://files.spip.org/spip-zone/cfg.zip].', # NEW
