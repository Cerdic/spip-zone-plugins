...
-* Lorsqu\'un sujet de forum est ferm&amp;ecute;, seuls les mod&eacute;rateurs peuvent y ajouter des r&eacute;ponses.',
 ...
 _ Un postit est situ&eacute; en dessous des annonces, avant les messages ordinaires. Il n\'appara&icirc;t qu\'une seule fois dans la liste.',
	...
	'par_' => 'par ',
	'plugin_auteur' => 'La SpipBB Team : [voir la liste des contributeurs sur Spip-contrib->http://contrib.spip.net/Plugin-SpipBB#contributeurs]',
...
_ [Acc&egrave;s au panneau d\'administration-> .?exec=spipbb_configuration]',
	...
	'sign_admin' => '{{Cette page est uniquement accessible aux responsables du site.}}<p>Elle donne acc&egrave;s &agrave; la configuration du plugin &laquo;{{<a href="http://contrib.spip.net/Plugin-SpipBB#contributeurs" class="copyright">SpipBB</a>}}&raquo; ainsi qu\'&agrave; la gestion des forums du site.</p><p>Version : @version@ @distant@</p><p>Consulte&nbsp;:
...
_ • [de tout le plugin->@plugin@]</p>',
	'sign_tempo' => 'R&eacute;alis&eacute; avec <a href="http://contrib.spip.net/Plugin-SpipBB#contributeurs" class="copyright">SpipBB</a>',
	'signature' => 'Signature',
