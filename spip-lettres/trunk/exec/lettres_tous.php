<?php
	...
	function exec_lettres_tous() {
		...
		echo bloc_des_raccourcis(
				icone_horizontale(_T('lettresprive:creer_nouvelle_lettre'), generer_url_ecrire("lettres_edit"), _DIR_PLUGIN_LETTRES."prive/images/lettre-add-24.png", 'rien.gif', false).
