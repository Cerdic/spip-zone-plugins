<?php
	...
	function exec_abonnes_edit() {
		...
		if ($abonne->existe)
			echo icone_inline(_T('icone_retour'), generer_url_ecrire('abonnes', 'id_abonne='.$abonne->id_abonne), 'abonne-24.png', "rien.gif", $GLOBALS['spip_lang_left']);
		else
			echo icone_inline(_T('icone_retour'), generer_url_ecrire('abonnes_tous'), 'abonne-24.png', "rien.gif", $GLOBALS['spip_lang_left']);
