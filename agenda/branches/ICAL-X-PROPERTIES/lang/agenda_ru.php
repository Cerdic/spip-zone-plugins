...
// extrait automatiquement de https://trad.spip.net/tradlang_module/agenda?lang_cible=ru
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'aucune_rubrique_mode_agenda' => 'По умолчанию можно использовать события во всех рубриках. Если вы установите режим расписания в одной (или нескольких) рубриках, управление событиями ограничиться только её (или их) подрубриками.', # MODIF
	...
	'notification_propose_titre' => 'Событие предложено',
	'notification_publie_titre' => 'Событие опубликовано',
