...
// extrait automatiquement de https://trad.spip.net/tradlang_module/agenda?lang_cible=en
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'confirm_evenement_modifie_a_des_repetitions' => 'You changed this event which has repetitions:', # RELIRE
	'confirm_evenement_modifie_est_une_repetition' => 'You changed the event which is part of a series of repetitions:', # RELIRE
	...
	'erreur_timezone_invalide' => 'This time zone is not valid', # RELIRE
	...
	'evenement_timezone_affiche' => 'Time zone', # RELIRE
	'evenement_timezone_all' => 'All time zone', # RELIRE
	'evenement_timezone_most_used' => 'Most used', # RELIRE
	...
	'info_evenement_modif_synchro_source_non' => 'Changes to this event will not affect other occurrences', # RELIRE
	'info_evenement_poubelle' => 'Event deleted',
	'info_evenement_propose' => 'Event proposed',
	'info_evenement_publie' => 'Event published',
	'info_evenement_repetition' => 'This event is a repetition', # RELIRE
	...
	'info_timezone_affiche' => 'Time zone:', # RELIRE
	...
	'label_modif_synchro_source_0' => 'Change only this occurence', # RELIRE
	'label_modif_synchro_source_1' => 'Change all occurences', # RELIRE
	...
	'notification_propose_detail' => 'The event "@titre@" is proposed to publication since', # RELIRE
	'notification_propose_sujet' => '[@nom_site_spip@] Proposed: @titre@', # RELIRE
	'notification_propose_titre' => 'Event proposed',
	'notification_publie_detail' => 'The event "@titre@" has just been published by @connect_nom@.', # RELIRE
	'notification_publie_sujet' => '[@nom_site_spip@] PUBLISHED: @titre@', # RELIRE
