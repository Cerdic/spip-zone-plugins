<?php
/**
 * Définit les autorisations du plugin Création de cartes
 *
...
/**
 * Autorisation de voir un élément de menu (cartes)
 *
...
/**
 * Autorisation de voir le bouton d'accès rapide de création (carte)
 *
 * @param  string $faire Action demandée
 * @param  string $type  Type d'objet sur lequel appliquer l'action
 * @param  int    $id    Identifiant de l'objet
 ...
 * @return bool          true s'il a le droit, false sinon
**/
function autoriser_carte_voir_dist($faire, $type, $id, $qui, $opt) {
	return true;
}

/**
 * Autorisation de modifier (carte)
 *
 * @param  string $faire Action demandée
 * @param  string $type  Type d'objet sur lequel appliquer l'action
 * @param  int    $id    Identifiant de l'objet
 ...
 * @return bool          true s'il a le droit, false sinon
**/
function autoriser_carte_modifier_dist($faire, $type, $id, $qui, $opt) {
	return in_array($qui['statut'], array('0minirezo', '1comite'));
}

/**
 * Autorisation de supprimer (carte)
 *
 * @param  string $faire Action demandée
 * @param  string $type  Type d'objet sur lequel appliquer l'action
 * @param  int    $id    Identifiant de l'objet
