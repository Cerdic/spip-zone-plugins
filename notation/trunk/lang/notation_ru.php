...
// extrait automatiquement de https://trad.spip.net/tradlang_module/notation?lang_cible=ru
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'info_ip' => 'Доступ к голосованию предоставляется посетителям сайта. Для получения более точного результата голосования с одного IP-адреса возможно проголосавть единожды.', # MODIF
