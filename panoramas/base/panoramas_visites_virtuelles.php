...
$visites_virtuelles_lieux = array(
		...
		"acces_carte"	=> "ENUM('toujours', 'si_visite') DEFAULT 'toujours' NOT NULL", /* permettre l'acc�s au lieu depuis la carte : toujours, ou uniquement si le lieu a d�j� �t� visit� */
