...
//=========================================================================
//
function table_amap_getmodif_liste_contrat($page, $table)
{
  $out = '';
  $hiddens = '';
  $idLieu = 0;
...
//=========================================================================
//
function table_amap_get_liste_contrat($page, $table, $idSaison, $idProduit)
{
  $out = '';
  $hiddens = '';
...
function table_amap_post_liste_contrat()
{
  ...
  $sqlResult = sql_insert('spip_amap_contrat',
                 "(" . join(', ', $description) . ")",
                 "(" . join(', ', $contenu) . ")");
