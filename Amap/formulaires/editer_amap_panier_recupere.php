...
function formulaires_editer_amap_panier_recupere_charger_dist($id_amap_panier,$id_auteur,$id_producteur,$date_distribution) {
...
function formulaires_editer_amap_panier_recupere_verifier_dist($id_amap_panier,$id_auteur,$id_producteur,$date_distribution){
	$erreurs = array();
...
function formulaires_editer_amap_panier_recupere_traiter_dist($id_amap_panier,$id_auteur,$id_producteur,$date_distribution) {
	// Le n° de panier
