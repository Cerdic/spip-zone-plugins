...
function projets_declarer_tables_objets_sql($tables) {
	...
	$tables['spip_projets'] = array(
		...
		'champs_editables'  => array('id_projet_parent', 'nom', 'url_site', 'id_projets_cadre', 'date_debut', 'date_livraison_prevue', 'date_livraison', 'nb_heures_estimees', 'nb_heures_reelles', 'actif', 'objectif', 'enjeux', 'methode', 'descriptif'),
