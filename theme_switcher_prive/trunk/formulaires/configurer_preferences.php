...
function formulaires_configurer_preferences_charger_dist(){
	...
	$valeurs = array();
	$valeurs['theme'] = isset($GLOBALS['visiteur_session']['prefs']['theme'])?$GLOBALS['visiteur_session']['prefs']['theme']:'spip';
...
function formulaires_configurer_preferences_traiter_dist(){
	if ($theme = _request('theme')) {
		$GLOBALS['visiteur_session']['prefs']['theme'] = $theme;
	}
