...
function balise_FORMULAIRE_EDITER_LOGO_dist ($p) {
	...
	return calculer_balise_dynamique($p,'FORMULAIRE_EDITER_LOGO', array('FORMULAIRE_EDITER_LOGO_TYPE_BOUCLE',$pk));
}
...
function balise_FORMULAIRE_EDITER_LOGO_TYPE_BOUCLE_dist($p) {
