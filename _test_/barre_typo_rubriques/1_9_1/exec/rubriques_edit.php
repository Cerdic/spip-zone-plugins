...
echo  generer_url_post_ecrire("naviguer",($id_rubrique ? "id_rubrique=$id_rubrique' name='formulaire" : ""));
...
fin_page();
echo("<script type=\"text/javascript\" src=\"img_pack/spip_barre.js\"></script>");
