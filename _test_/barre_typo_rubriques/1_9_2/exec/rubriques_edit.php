...
$afficher_barre = '<div>' 
	...
	echo redirige_action_auteur("editer_rubrique", $id_rubrique ? $id_rubrique : 'oui', 'naviguer', '', $form, "name='formulaire' method='post'");
	...
	echo("<script type=\"text/javascript\" src=\"../dist/javascript/spip_barre.js\"></script>");
}
?>
