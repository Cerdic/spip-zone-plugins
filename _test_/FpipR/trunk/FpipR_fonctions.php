...
function boucle_FLICKR_PHOTOS_GETWITHOUTGEODATA_dist($id_boucle, &$boucles) {
  ...
  $boucle->hash .= "FpipR_fill_table_boucle('flickr.photos.getWithoutGeoData',\$arguments);";
  return calculer_boucle($id_boucle, $boucles); 
}
...
function boucle_FLICKR_PHOTOS_GETWITHGEODATA_dist($id_boucle, &$boucles) {
  ...
  $boucle->hash .= "FpipR_fill_table_boucle('flickr.photos.getWithGeoData',\$arguments);";
  return calculer_boucle($id_boucle, $boucles); 
}
...
function boucle_FLICKR_PHOTOS_RECENTLYUPDATED_dist($id_boucle, &$boucles) {
  ...
  $boucle->hash .= "FpipR_fill_table_boucle('flickr.photos_recentlyUpdated',\$arguments);";
  return calculer_boucle($id_boucle, $boucles); 
}
...
function boucle_FLICKR_FAVORITES_GETLIST_dist($id_boucle, &$boucles) {
  ...
  $boucle->hash .= "FpipR_fill_table_boucle('flickr.favorites.getList',\$arguments);";
  return calculer_boucle($id_boucle, $boucles); 
}
...
function boucle_FLICKR_URLS_LOOKUPUSER_dist($id_boucle, &$boucles) {
  ...
  $boucle->hash .= "FpipR_fill_table_boucle('flickr.urls.lookupUser',\$arguments);";
  return calculer_boucle($id_boucle, $boucles); 
}
...
function boucle_FLICKR_CONTACTS_GETPUBLICLIST_dist($id_boucle,&$boucles) {
 $boucle = &$boucles[$id_boucle];
  ...
  $boucle->hash .= "FpipR_fill_table_boucle('flickr.contacts.getPublicList',\$arguments);";
  return calculer_boucle($id_boucle, $boucles); 
}
...
function boucle_FLICKR_CONTACTS_GETLIST_dist($id_boucle,&$boucles) {
 $boucle = &$boucles[$id_boucle];
  ...
  $boucle->hash .= "FpipR_fill_table_boucle('flickr.contacts.getList',\$arguments);";
  return calculer_boucle($id_boucle, $boucles); 
}
...
function boucle_FLICKR_PHOTOS_GETRECENT_dist($id_boucle,&$boucles) {
 $boucle = &$boucles[$id_boucle];
  ...
  $boucle->hash .= "FpipR_fill_table_boucle('flickr.photos.getRecent',\$arguments);";
  return calculer_boucle($id_boucle, $boucles); 
}
...
//======================================================================
function boucle_FLICKR_PHOTOS_GETUNTAGGED_dist($id_boucle, &$boucles) {
  $boucle = &$boucles[$id_boucle];
  $id_table = $boucle->id_table;
  $boucle->from[$id_table] =  "spip_fpipr_photos";
  ...
  $boucle->hash .= "FpipR_fill_table_boucle('flickr.photos.getUntagged',\$arguments);";
  return calculer_boucle($id_boucle, $boucles); 
}
...
function boucle_FLICKR_PHOTOS_GETEXIF_dist($id_boucle,&$boucles) {
  ...
  $boucle->hash = "// CREER la table flickr_exif et la peupler avec le resultat de la query
	  \$arguments = '';\n";
  foreach($arguments as $key => $val) {
	if($val) {
	  $boucle->hash .= "\$v=$val;\n";
  ...
  $boucle->hash .= "FpipR_fill_table_boucle('flickr.photos.getExif',\$arguments);";
  return calculer_boucle($id_boucle, $boucles); 
}
