...
Placée dans une boucle ARTICLE dans une squelette, la balise #CRYPTM affiche un 
...
#CRYPTM{squelette,texte_lien} ou 
#CRYPTM{squelette,"Voir une page pour l'impression"} ou :
...
(2) Voir l'article http://www.spip-contrib.net/Un-systeme-antispam pour plus de détails.
