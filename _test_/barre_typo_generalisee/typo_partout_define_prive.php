...
";
	...
	//rubriques
	if (($_GET['exec'] == "rubriques_edit") && (lire_config('typo_partout/rubriques_titre_typo_partout') == "on"))
	{
	...
	if (($_GET['exec'] == "mots_type") && (lire_config('typo_partout/groupesmots_nom_typo_partout') == "on"))	
	{
	...
	//mots clefs
	if (($_GET['exec'] == "mots_edit") && (lire_config('typo_partout/mots_nom_typo_partout') == "on"))	
	{
	...
	//sites référencés
	if (($_GET['exec'] == "sites_edit") && (lire_config('typo_partout/sites_nom_typo_partout') == "on"))		
	{
	...
	//configuration
	if (($_GET['exec'] == "configuration") && (lire_config('typo_partout/configuration_nom_typo_partout') == "on")) 	
	{
	...
	//articles
	if (($_GET['exec'] == "articles_edit") && (lire_config('typo_partout/articles_surtitre_typo_partout') == "on"))		
	{
		$barre_temporaire .= "<div id=\"barre_typo_article_surtitre\" style=\"display: none;\">".afficher_barre('document.formulaire.surtitre')."</div>";
	}
	if (($_GET['exec'] == "articles_edit") && (lire_config('typo_partout/articles_titre_typo_partout') == "on"))		
	{
		$barre_temporaire .= "<div id=\"barre_typo_article_titre\" style=\"display: none;\">".afficher_barre('document.formulaire.titre')."</div>";
	}
	if (($_GET['exec'] == "articles_edit") && (lire_config('typo_partout/articles_soustitre_typo_partout') == "on"))		
	{
	...
	//breves
	if (($_GET['exec'] == "breves_edit") && (lire_config('typo_partout/breves_titre_typo_partout') == "on"))		
	{
		$barre_temporaire .= "<div id=\"barre_typo_breve_titre\" style=\"display: none;\">".afficher_barre('document.formulaire_breve.titre')."</div>";
	}
	if (($_GET['exec'] == "breves_edit") && (lire_config('typo_partout/breves_lien_typo_partout') == "on"))		
	{
		$barre_temporaire .= "<div id=\"barre_typo_breve_lien\" style=\"display: none;\">".afficher_barre('document.formulaire_breve.lien_titre')."</div>";
	}

	//auteurs
	if (($_GET['exec'] == "auteur_infos") && (lire_config('typo_partout/auteurs_signature_typo_partout') == "on"))		
	{
