...
<script language="javascript" type="text/javascript">
	tinyMCE.init({
		...
		elements : "text_area",
		theme : "advanced",
		plugins : "table,advlink,emotions,paste",
		theme_advanced_buttons1_add_before : "",
		theme_advanced_buttons1_add : "fontsizeselect",
		theme_advanced_buttons2_add : "separator,forecolor,emotions",
		theme_advanced_buttons2_add_before: "cut,copy,paste,separator",
		theme_advanced_buttons3_add_before : "tablecontrols,separator",
		theme_advanced_buttons3_add : "iespell,separator,ltr,rtl",
...
$_SESSION['id_auteur'] = $connect_id_auteur;
$_SESSION['statut_auteur'] = $connect_statut;
$pos_spip_url = strpos($_SERVER['REQUEST_URI'],'ecrire');
$xinha_url = '#URL_SITE_SPIP'.'/plugins/Xinha/xinha/';
...
// ' onchange="disable_other_forms(this.parentNode);"'.
        ...
        ((($options == "avancees" AND $articles_descriptif) OR strlen($descriptif))?
         ("\n<P><B>" ._T('texte_descriptif_rapide') ."</B>" .
          aide ("artdesc") .
          "</p>" ._T('texte_contenu_article') .
          "<textarea name='descriptif' class='forml' rows='2' cols='200' wrap=soft>" .
          $descriptif .
          "</textarea>") :
         '') .
        ...
        "<br><br><b>" ._T('info_texte') ."</b>" . 
        aide ("arttexte") .
        _T('texte_enrichir_mise_a_jour') .
        aide("raccourcis") ."<br><br>".
        $sup.
       // ($spip_display==4 ? '' : afficher_barre('document.formulaire.texte')) .
        "<span><textarea id=\"text_area\" name='texte'$att_text>$texte</textarea></span>\n" .
