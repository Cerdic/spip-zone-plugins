...
// La requete SQL à passer dans la base
	if ($auteur){
		$query = spip_query("UPDATE spip_asso_adherents SET id_asso="._q($id_asso).", nom="._q($nom).", prenom="._q($prenom).", naissance="._q($naissance).", sexe="._q($sexe).", rue="._q($rue).",  ville="._q($ville).", cp="._q($cp).", telephone="._q($telephone).", portable="._q($portable).", profession="._q($profession).", societe="._q($societe).", secteur="._q($secteur).", categorie="._q($categorie).", fonction="._q($fonction).", publication="._q($publication).", utilisateur1="._q($utilisateur1).", utilisateur2="._q($utilisateur2).", utilisateur3="._q($utilisateur3).", utilisateur4="._q($utilisateur4).", remarques="._q($remarques)." WHERE id_auteur=".$id_auteur);
		if (!$query) die('UPDATE');
	}
	else {
		$query= spip_query("INSERT INTO spip_asso_adherents (id_auteur, id_asso, nom, prenom, naissance, sexe, rue,  ville, cp, telephone, portable, profession, societe, secteur, categorie, fonction, publication, utilisateur1, utilisateur2, utilisateur3, utilisateur4, statut, remarques, creation) VALUES ( ".$id_auteur.", "._q($id_asso).", "._q($nom).", "._q($prenom).", "._q($naissance).", "._q($sexe).", "._q($rue).", "._q($ville).", "._q($cp).", "._q($telephone).", "._q($portable).", "._q($profession).", "._q($societe).", "._q($secteur).", "._q($categorie).", "._q($fonction).", "._q($publication).", "._q($utilisateur1).", "._q($utilisateur2).", "._q($utilisateur3).", "._q($utilisateur4).", 'prospect', "._q($remarques).", NOW() ) ");
		if (!$query) die('INSERT');
