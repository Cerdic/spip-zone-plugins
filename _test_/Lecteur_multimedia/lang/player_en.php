...
$
	// $LastChangedDate: 2009-03-16 17:31:40 
+0100 (Mon, 16 Mar 2009) $

	// might be perfectible. Thanks in advance 
for future enhencments. (Etienne "Loiseau2nuit" 
Brackers)

$GLOBALS['i18n_'._PLAYER_PREFIX.'_en'] = array(

  'player_nom' => "Multimedia Player"
, 'configuration_player' => "Configure Multimedia 
Player"
, 'mini' => "Mini"
, 'normal' => "Normal"
, 'maxi' => "Maxi"
...
: "   
, 'label_configxml' => "URL of Configuration XML 
file : "   
...
, 'label_autoload' => "Load and show the starting 
picture" 
...
, 'label_showopen' => "Show OPEN button (2 for the 
list) : " 
, 'label_showplayer' => "Show buttons bar : " 
, 'label_showfullscreen' => "Show FULLSCREEN 
button" 
, 'label_showswitchsubtitles' => "Display HIDE/SHOW 
SUBTITLES button" 
, 'label_loop' => "Loop" 
, 'label_width' => "Force player width : " 
, 'label_height' => "Force player height : " 
, 'label_startimage' => "Title image(s) :" 
, 'label_skin' => "URL of jpeg (non-progressive) 
file to load : " 
...
" 
, 'label_slidercolor1' => "First gradient color on 
the bar : " 
, 'label_slidercolor2' => "Second gradient color on 
the bar : " 
, 'label_sliderovercolor' => "Bar-hover color : "
, 'label_scrollbarcolor' => "Scrollbar color : " 
, 'label_scrollbarovercolor' => "Scrollbar-hover 
color : " 
, 'label_currentflvcolor' => "Selected video color 
: " 
, 'label_onclick' => "Action-click on the video 
('none', 'playpause', or destination URL) : " 
, 'label_onclicktarget' => "URL's target on click : 
" 
, 'label_ondoubleclick' => "Double-click action on 
video ('none', 'fullscreen', 'playpause', or URL to 
open) : " 
, 'label_ondoubleclicktarget' => "URL's target on 
double-click : " 
, 'label_playertimeout' => "Time (in seconds) 
before player hides : " 
, 'label_videodelay' => "Title display time on 
video change : " 
, 'label_shortcut' => "Activate keyborad shortcuts" 
, 'label_volume' => "Initial volume level : " 
, 'label_videobgcolor' => "Background color when no 
video : " 
...
" 
, 'label_showtitlebackground' => "Show title 
background : " 
, 'label_playeralpha' => "Player background 
transparency : " 
...
, 'label_iconplaybgcolor' => "PLAY icon background 
color : " 
, 'label_iconplaybgalpha' => "PLAY icon background 
transparency : " 
, 'label_showtitleandstartimage' => "Display title 
and starting picture in the same time" 
