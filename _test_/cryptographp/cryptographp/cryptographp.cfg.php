...
$cryptwidth  = 70;  // Largeur du cryptogramme (en pixels)
...
$charspace = 12;        // Espace entre les caracteres (en pixels)
$charsizemin = 13;      // Taille minimum des caractères
$charsizemax = 13;      // Taille maximum des caractères
...
$cryptsecure = "sha1";    // Méthode de crytpage utilisée: "md5", "sha1" ou "" (aucune)
                         // "sha1" seulement si PHP>=4.2.0
                         // Si aucune méthode n'est indiquée, le code du cyptogramme est stocké 
                         // en clair dans la session.
                       
$cryptusetimer = 3;        // Temps (en seconde) avant d'avoir le droit de regénérer un cryptogramme
