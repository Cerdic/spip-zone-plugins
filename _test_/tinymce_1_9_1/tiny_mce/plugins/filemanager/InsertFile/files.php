...
<form action="files.php?dialogname=<?php echo $MY_NAME; ?>&refresh=1<?php echo '&base_url='.$_GET['base_url'].'&base_path='.$_GET['base_path'].'&docs='.$_GET['docs'].'&lang='.$_GET['lang']; ?>" id="form2" name="form2" method="post" enctype="multipart/form-data">
...
';
        ...
        while (false !== ($entry = $d->read())) {
                ...
                $folderNb++;
								...
								$parsed_icon = $MY_ICON_FOLDER.'/'.parse_icon($ext);
