...
tinyMCE.importPluginLanguagePack('ibrowser','fr,en');
	...
	function iBrowser_click(editor) {
        ...
        ib.baseURL += '?library=' + ((tinyMCE.getParam('ibrowser_library',undefined)!=undefined)?tinyMCE.getParam('ibrowser_library'):'/images/librairie/');
        ib.baseURL += '&lang=' + ((tinyMCE.getParam('language',undefined)!=undefined)?tinyMCE.getParam('language'):'en');
        //ACTi : fin de ajout
