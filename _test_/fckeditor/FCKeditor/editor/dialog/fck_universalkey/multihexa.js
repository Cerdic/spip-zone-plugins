...
if (ns6){posUniKeyLeft=0;posUniKeyTop=80}
else if (ie){posUniKeyLeft=0;posUniKeyTop=80}
...
/*touches*/
var posX=new Array(0,28,56,84,112,140,168,196,224,252,280,308,336,42,70,98,126,154,182,210,238,266,294,322,350,50,78,106,134,162,190,218,246,274,302,330,64,92,120,148,176,204,232,260,288,316,28,56,84,295,322,350)
...
for (i=0;i<nbTouches;i++){
	...
	if (CarMaj[i]==CarMin[i].toUpperCase()){
		...
		tracer("majus"+i,posUniKeyLeft+5+posX[i],posUniKeyTop+1+posY[i],"&nbsp;","double")
...
var actC1=new Array(-1,369,369,0,378,0,366,15,364,0,182,378)
var actC2=new Array(-2,-2,18,42,42,75,75,103,103,129,129,129)
...
var act  =new Array("< Lang","Lang>","Suppr","Effacer <br> tout","Ret.<br>Arr","Verr.Maj","Entrer","Maj","Maj","<|<","Espace",">|>")
var effet=new Array("keyscroll(-3)","keyscroll(3)","faire(\"del\")","RAZ()","faire(\"bck\")","bloq()","faire(\"\\n\")","haut()","haut()","faire(\"ar\")","faire(\" \")","faire(\"av\")")
var nbActions=12
for (i=0;i<nbActions;i++){
	tracer("act"+i,posUniKeyLeft+5+actC1[i],posUniKeyTop+2+actC2[i],act[i],"action")
}
/*navigation*/
var keyC1=new Array(35,119,203,287)
var keyC2=new Array(2,2,2,2)
var keyC3=new Array(116,200,284,368)
var keyC4=new Array(11,11,11,11)
for (i=0;i<4;i++){
	tracer("key"+i,posUniKeyLeft+15+keyC1[i],posUniKeyTop-1+keyC2[i],key[i],"unikey")
}
/*zones reactives*/
