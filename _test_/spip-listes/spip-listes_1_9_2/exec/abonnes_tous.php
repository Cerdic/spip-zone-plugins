...
global $table_prefix;
$query_message = "SELECT * FROM ".$table_prefix."_listes AS listes LEFT JOIN ".$table_prefix."_abonnes_listes AS abonnements USING (id_liste) WHERE listes.statut='liste'";
$result_pile = spip_query($query_message);
$nb_abonnes = spip_num_rows($result_pile);

$query_message = "SELECT * FROM ".$table_prefix."_listes AS listes LEFT JOIN ".$table_prefix."_abonnes_listes AS abonnements USING (id_liste) WHERE listes.statut='inact'";
$result_pile = spip_query($query_message);
