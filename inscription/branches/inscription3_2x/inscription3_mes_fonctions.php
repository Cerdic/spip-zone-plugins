...
if(!defined('_DIR_PLUGIN_NOTIFICATIONS')){
/**
...
/**
 * Surcharge de la fonction de traitement du formulaire d'insciption sinon les surcharges de fonctions 
...
function inscription3_recuperer_champs($champs,$id_auteur){
	...
	if($champs == 'pays_pro'){
		$resultat = sql_getfetsel("b.nom","spip_auteurs a LEFT JOIN spip_geo_pays b on a.pays_pro = b.id_pays","a.id_auteur=$id_auteur");
		return typo($resultat);
	}
