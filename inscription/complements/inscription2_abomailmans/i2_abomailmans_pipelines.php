...
function i2_abomailmans_i2_form_fin($flux) {
	...
	if ((lire_config('inscription2/liste') == 'on') and (count(lire_config('inscription2/listes')) > 0)) {
...
function i2_abomailmans_i2_charger_formulaire($flux) {
	...
	if ((is_numeric($flux['data']['id_auteur'])) and (lire_config('inscription2/liste') == 'on')) {
