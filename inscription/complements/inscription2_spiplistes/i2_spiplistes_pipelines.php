...
function i2_spiplistes_i2_form_fin($flux) {
	...
	if ((lire_config('inscription2/newsletter') == 'on') and (count(lire_config('inscription2/newsletters'))>0)) {
...
function i2_spiplistes_i2_charger_formulaire($flux) {
	...
	if ((is_numeric($flux['data']['id_auteur'])) and (lire_config('inscription2/newsletter') == 'on')) {
