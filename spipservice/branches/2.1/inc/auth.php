...
* PHP_AUTH_PW depuis REMOTE_USER, dans ce cas l'authentification LDAP est *
* desactivee                                                              *
...
function auth_mode()
{
	...
	if (!$ignore_auth_http) {
		...
		if (_request('action')=='spipservice'){
			// ce bout de code permet de recuperer $_SERVER['PHP_AUTH_USER'] et $_SERVER['PHP_AUTH_PW']
			// depuis $_SERVER['REMOTE_USER']
