<?php
	$openinviter_settings=array(
		...
		"private_key"=>"key",
		"cookie_path"=>'/tmp',
		"message_body"=>"You are invited to http://site.tld", // http://rastapopoulos.artizanal.info is the website on your account. If wrong, please update your account at OpenInviter.com
		"message_subject"=>" is inviting you to http://site.tld", // http://rastapopoulos.artizanal.info is the website on your account. If wrong, please update your account at OpenInviter.com
