...
// Vert de gris
1 => array (
		"couleur_foncee" => "#02ca02",
		"couleur_claire" => "#00FF00",
		"couleur_lien" => "#868734",
		"couleur_lien_off" => "#0D2E47"
		),
// Rose vieux
2 => array (
		"couleur_foncee" => "#bcbc26",
		"couleur_claire" => "#FFFF00",
		"couleur_lien" => "#8E9F5C",
		"couleur_lien_off" => "#333921"
		),
// Orange
3 => array (
		"couleur_foncee" => "#d87403",
		"couleur_claire" => "#fc9015",
		"couleur_lien" => "#9F8E62",
		"couleur_lien_off" => "#393323"
		),
//  Bleu truquoise
4 => array (
		"couleur_foncee" => "#ca0909",
		"couleur_claire" => "#fd2020",
		"couleur_lien" => "#9F765E",
		"couleur_lien_off" => "#392A22"
		),
// Violet
5 => array (
		"couleur_foncee" => "#b604b6",
		"couleur_claire" => "#FF00FF",
		"couleur_lien" => "#9F5B81",
		"couleur_lien_off" => "#39212E"
		),
//  Gris
6 => array (
		"couleur_foncee" => "#5409b6",
		"couleur_claire" => "#852bfb",
		"couleur_lien" => "#6C629F",
		"couleur_lien_off" => "#272339"
		),
7 => array (
		"couleur_foncee" => "#1111d0",
		"couleur_claire" => "#3a3afc",
		"couleur_lien" => "#6C629F",
		"couleur_lien_off" => "#272339"
		),
//  Gris
8 => array (
		"couleur_foncee" => "#00ABAB",
		"couleur_claire" => "#00FFFF",
		"couleur_lien" => "#6C629F",
		"couleur_lien_off" => "#272339"
		)
//  Gris
