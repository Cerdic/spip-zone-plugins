...
// $Id: Site.class.php,v 1.52 2006/01/13 19:14:04 matthieu_ Exp $
...
class Site
{
	...
	*/
	...
	{				
		...
		$fileAdress = _PHPMV_DIR_CONFIG."/site_first_date.php";
	...
	*/
	...
	{		
		...
		$fileAdress = _PHPMV_DIR_CONFIG."/site_urls.php";
		if(is_file($fileAdress))
		{
			require $fileAdress;
			return $siteUrls;
	...
	function getAllowedSites( $type )
	{
		...
		if($request->getModuleNameFromUrl() == 'view_rss')
		{
			$user->setRssHash( $request->getRssHash()  );
		}
	...
	function loadInfo()
	{
		...
		$fileAdress = _PHPMV_DIR_CONFIG."/site_info.php";
		if(is_file($fileAdress))
		{
			require $fileAdress;
			return $siteInfo;
