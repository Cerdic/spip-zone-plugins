...
// $Id: TemplateEngine.php,v 1.35 2005/12/24 02:59:43 matthieu_ Exp $
 ...
 * @version $Id: TemplateEngine.php,v 1.35 2005/12/24 02:59:43 matthieu_ Exp $
 * @package 
 *
 */
...
class TemplateEngine extends Smarty
{
    ...
    function TemplateEngine($template)
    {
        ...
        $this->compile_dir = _PHPMV_DIR_DATA .'/tpl_compiled/';
        $this->cache_dir = _PHPMV_DIR_DATA .'/cache_smarty/';
    ...
    function processDatas( &$o_site, &$o_data, $request = null)
	{
    	...
    	else
    	{
			...
			if(is_a( $o_site, 'Site'))
			{
				...
				$this->assign("day_first_letter", $GLOBALS['lang']['calendrier_jours']);
				
				// litteral date for display below the menu
				$this->assign("date_litteral", getLiteralDate($o_request->getPeriod(), $s_dateAsked, $a_calendar));
		...
		$this->assign('a_link_phpmv', array('<a class="bleu" link="phpmyvisites : web stats web statistics analytics" href="http://www.phpmyvisites.net/">','</a>'));
