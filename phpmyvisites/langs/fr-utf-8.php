...
$lang['admin_ip_ranges'] = "Exclude des IP/plages d'ips des statistiques";
...
$lang['install_problemedroitrepertoire'] = "Cannot write in the repertory %s : please verify that you have the rights necessary to create files on the server (try to CHMOD 777 the repertory with your FTP software (right click on the directory -> Permissions (or CHMOD))."; // Cannot access the file config.php... 
